...
class LoginFlow(data_entry_flow.FlowHandler):
    ...
    async def async_step_select_mfa_module(self, user_input: dict[str, str] | None = None) -> FlowResult: ...
    async def async_step_mfa(self, user_input: dict[str, str] | None = None) -> FlowResult: ...
