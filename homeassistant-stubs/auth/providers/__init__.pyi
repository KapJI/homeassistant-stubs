...
class LoginFlow(data_entry_flow.FlowHandler):
    ...
    async def async_step_select_mfa_module(self, user_input: Union[dict[str, str], None]=...) -> dict[str, Any]: ...
    async def async_step_mfa(self, user_input: Union[dict[str, str], None]=...) -> dict[str, Any]: ...
