...
STAGE_0_INTEGRATIONS: Incomplete
...
async def _async_setup_multi_components(hass: core.HomeAssistant, domains: set[str], config: dict[str, Any]) -> None: ...
