...
class AccuWeatherEntity(CoordinatorEntity, WeatherEntity):
    ...
    @property
    def forecast(self) -> Union[list[dict[str, Any]], None]: ...
    @staticmethod
