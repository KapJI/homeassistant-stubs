...
class AITaskEntity(RestoreEntity):
    ...
    async def _async_get_ai_task_chat_log(self, session: ChatSession, task: GenDataTask | GenImageTask, context: Context | None) -> AsyncGenerator[ChatLog]: ...
    @final
    async def internal_async_generate_data(self, session: ChatSession, task: GenDataTask, context: Context | None = None) -> GenDataTaskResult: ...
    async def _async_generate_data(self, task: GenDataTask, chat_log: ChatLog) -> GenDataTaskResult: ...
    @final
    async def internal_async_generate_image(self, session: ChatSession, task: GenImageTask, context: Context | None = None) -> GenImageTaskResult: ...
