import asyncio
from .const import CONF_LEGACY_SSL as CONF_LEGACY_SSL, DEFAULT_SSL as DEFAULT_SSL, DEFAULT_USERNAME as DEFAULT_USERNAME, DEFAULT_VERIFY_SSL as DEFAULT_VERIFY_SSL, DEVICE_NAME as DEVICE_NAME, DOMAIN as DOMAIN, HOSTNAME as HOSTNAME, IP_ADDRESS as IP_ADDRESS, MAC_ADDRESS as MAC_ADDRESS, SECTION_ADDITIONAL_SETTINGS as SECTION_ADDITIONAL_SETTINGS
...
class AirOSConfigFlow(ConfigFlow, domain=DOMAIN):
    ...
    async def _validate_and_get_device_info(self, config_data: dict[str, Any], legacy: bool = False) -> dict[str, Any] | None: ...
