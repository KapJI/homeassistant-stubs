...
def async_get_pro_config_entry_by_ip_address(hass: HomeAssistant, ip_address: str) -> ConfigEntry: ...
def async_get_pro_device_by_config_entry(hass: HomeAssistant, config_entry: ConfigEntry) -> dr.DeviceEntry: ...
