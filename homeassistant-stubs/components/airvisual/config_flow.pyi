...
class AirVisualFlowHandler(config_entries.ConfigFlow, domain=DOMAIN):
    ...
    async def async_step_geography_by_coords(self, user_input: dict[str, str] | None = None) -> FlowResult: ...
    async def async_step_geography_by_name(self, user_input: dict[str, str] | None = None) -> FlowResult: ...
