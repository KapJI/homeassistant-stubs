...
class AlexaModeResource(AlexaCapabilityResource):
    ...
    def __init__(self, labels: list[str], ordered: bool = ...) -> None: ...
...
class AlexaPresetResource(AlexaCapabilityResource):
    ...
    def __init__(self, labels: list[str], min_value: int | float, max_value: int | float, precision: int | float, unit: str | None = ...) -> None: ...
