...
from homeassistant.const import ATTR_NAME as ATTR_NAME, DEGREE as DEGREE, LIGHT_LUX as LIGHT_LUX, UnitOfDensity as UnitOfDensity, UnitOfIrradiance as UnitOfIrradiance, UnitOfLength as UnitOfLength, UnitOfPrecipitationDepth as UnitOfPrecipitationDepth, UnitOfPressure as UnitOfPressure, UnitOfRatio as UnitOfRatio, UnitOfSpeed as UnitOfSpeed, UnitOfTemperature as UnitOfTemperature, UnitOfVolumetricFlux as UnitOfVolumetricFlux
from homeassistant.core import HomeAssistant as HomeAssistant, callback as callback
from homeassistant.helpers.entity_platform import AddConfigEntryEntitiesCallback as AddConfigEntryEntitiesCallback
from typing import override

TYPE_24HOURRAININ: str
TYPE_AQI_PM10_24H_AQIN: str
TYPE_AQI_PM10_AQIN: str
TYPE_AQI_PM25: str
TYPE_AQI_PM25_24H: str
TYPE_AQI_PM25_24H_AQIN: str
TYPE_AQI_PM25_AQIN: str
TYPE_AQI_PM25_IN: str
TYPE_AQI_PM25_IN_24H: str
TYPE_BAROMABSIN: str
TYPE_BAROMRELIN: str
TYPE_CO2: str
TYPE_CO2_IN_24H_AQIN: str
TYPE_CO2_IN_AQIN: str
...
TYPE_PM_IN_HUMIDITY_AQIN: str
TYPE_PM_IN_TEMP_AQIN: str
TYPE_PM10_IN_24H_AQIN: str
TYPE_PM10_IN_AQIN: str
TYPE_PM25: str
TYPE_PM25_24H: str
TYPE_PM25_IN: str
TYPE_PM25_IN_24H: str
TYPE_PM25_IN_24H_AQIN: str
TYPE_PM25_IN_AQIN: str
TYPE_SOILHUM1: str
TYPE_SOILHUM10: str
TYPE_SOILHUM2: str
TYPE_SOILHUM3: str
