...
from anthropic.types.web_fetch_tool_result_block import Content as WebFetchToolResultBlockContent
...
class AnthropicDeltaStream:
    ...
    def on_server_tool_result_block(self, tool_use_id: str, tool_name: Literal['web_fetch_tool_result', 'web_search_tool_result', 'code_execution_tool_result', 'bash_code_execution_tool_result', 'text_editor_code_execution_tool_result', 'tool_search_tool_result'], content: WebFetchToolResultBlockContent | WebSearchToolResultBlockContent | CodeExecutionToolResultBlockContent | BashCodeExecutionToolResultBlockContent | TextEditorCodeExecutionToolResultBlockContent | ToolSearchToolResultBlockContent, caller: Caller | None) -> None: ...
