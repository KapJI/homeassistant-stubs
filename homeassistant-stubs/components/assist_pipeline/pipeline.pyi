...
class PipelineRun:
    ...
    def __mypy-replace(*, hass, context, pipeline, start_stage, end_stage, event_callback, language, runner_data, intent_agent, tts_audio_output, id, stt_provider, tts_engine, tts_options) -> None: ...
