...
async def _async_resolve_default_pipeline_settings(hass: HomeAssistant, stt_engine_id: str | None, tts_engine_id: str | None, pipeline_name: str) -> dict[str, str | None]: ...
...
class PipelineRun:
    ...
    async def _speech_to_text_stream(self, audio_stream: AsyncIterable[ProcessedAudioChunk], stt_vad: VoiceCommandSegmenter | None, sample_rate: int = 16000, sample_width: int = 2) -> AsyncGenerator[bytes, None]: ...
    ...
    async def process_volume_only(self, audio_stream: AsyncIterable[bytes], sample_rate: int = 16000, sample_width: int = 2) -> AsyncGenerator[ProcessedAudioChunk, None]: ...
    async def process_enhance_audio(self, audio_stream: AsyncIterable[bytes], sample_rate: int = 16000, sample_width: int = 2) -> AsyncGenerator[ProcessedAudioChunk, None]: ...
...
class PipelineStorageCollectionWebsocket(StorageCollectionWebsocket[PipelineStorageCollection]):
    def async_setup(self, hass: HomeAssistant, *, create_list: bool = True, create_create: bool = True) -> None: ...
...
class DeviceAudioQueue:
    ...
    id: str = ...
    overflow: bool = ...
    def __init__(self, queue, id, overflow) -> None: ...

@dataclass(slots=True)
class AssistDevice:
    domain: str
    unique_id_prefix: str
    def __init__(self, domain, unique_id_prefix) -> None: ...
