...
class VoiceCommandSegmenter:
    ...
    def __mypy-replace(*, vad_mode, vad_frames, speech_seconds, silence_seconds, timeout_seconds, reset_seconds, in_command, _speech_seconds_left, _silence_seconds_left, _timeout_seconds_left, _reset_seconds_left, _vad, _audio_buffer, _bytes_per_chunk, _seconds_per_chunk) -> None: ...
