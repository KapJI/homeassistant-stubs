...
class AssistSatelliteEntity(entity.Entity, metaclass=abc.ABCMeta):
    ...
    async def async_accept_pipeline_from_satellite(self, audio_stream: AsyncIterable[bytes], start_stage: PipelineStage = ..., end_stage: PipelineStage = ..., wake_word_phrase: str | None = None, *, context: Context | None = None) -> None: ...
