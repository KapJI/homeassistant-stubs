...
class AssistSatelliteEntity(entity.Entity, metaclass=abc.ABCMeta):
    ...
    async def async_internal_announce(self, message: str | None = None, media_id: str | None = None, preannounce_media_id: str | None = None) -> None: ...
    async def async_announce(self, announcement: AssistSatelliteAnnouncement) -> None: ...
    async def async_internal_start_conversation(self, start_message: str | None = None, start_media_id: str | None = None, extra_system_prompt: str | None = None, preannounce_media_id: str | None = None) -> None: ...
