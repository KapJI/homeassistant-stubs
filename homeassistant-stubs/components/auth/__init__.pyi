...
class TokenView(HomeAssistantView):
    ...
    async def post(self, request: web.Request) -> web.Response: ...
    async def _async_handle_auth_code(self, hass: HomeAssistant, data: MultiDictProxy[str], remote_addr: Union[str, None]) -> web.Response: ...
    async def _async_handle_refresh_token(self, hass: HomeAssistant, data: MultiDictProxy[str], remote_addr: Union[str, None]) -> web.Response: ...
