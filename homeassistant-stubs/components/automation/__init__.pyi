...
class AutomationEntity(ToggleEntity, RestoreEntity):
    ...
    def __init__(self, automation_id: Any, name: Any, trigger_config: Any, cond_func: Any, action_script: Any, initial_state: Any, variables: Any, trigger_variables: Any, raw_config: Any, blueprint_inputs: Any) -> None: ...
    @property
    def name(self): ...
    @property
    def unique_id(self): ...
