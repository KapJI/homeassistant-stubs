...
from homeassistant.helpers.trace import TraceElement as TraceElement, trace_append_element as trace_append_element, trace_get as trace_get, trace_path as trace_path
...
class AutomationEntity(ToggleEntity, RestoreEntity):
    ...
    _raw_config: Any = ...
    def __init__(self, automation_id: Any, name: Any, trigger_config: Any, cond_func: Any, action_script: Any, initial_state: Any, variables: Any, trigger_variables: Any, raw_config: Any) -> None: ...
    @property
    def name(self): ...
    @property
    def unique_id(self): ...
...
async def _async_process_if(hass: Any, name: Any, config: Any, p_config: Any): ...
