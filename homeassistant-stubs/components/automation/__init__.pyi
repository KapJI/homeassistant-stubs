...
async def _async_process_config(hass: HomeAssistant, config: dict[str, Any], component: EntityComponent[AutomationEntity]) -> bool: ...
async def _async_process_if(hass: HomeAssistant, name: str, config: dict[str, Any], p_config: dict[str, Any]) -> Union[IfAction, None]: ...
