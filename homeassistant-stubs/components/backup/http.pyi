...
from .models import AgentBackup as AgentBackup, BackupNotFound as BackupNotFound, InvalidBackupFilename as InvalidBackupFilename
...
class DownloadBackupView(HomeAssistantView):
    ...
    async def _send_backup_with_password(self, hass: HomeAssistant, backup: AgentBackup, request: Request, headers: dict[istr, str], backup_id: str, agent_id: str, password: str, agent: BackupAgent, manager: BackupManager) -> StreamResponse | FileResponse | Response: ...
