...
class BayesianBinarySensor(BinarySensorEntity):
    ...
    def __init__(self, name: str, unique_id: Union[str, None], prior: float, observations: list[ConfigType], probability_threshold: float, device_class: Union[BinarySensorDeviceClass, None]) -> None: ...
    ...
    def _process_numeric_state(self, entity_observation: Observation) -> Union[bool, None]: ...
    def _process_state(self, entity_observation: Observation) -> Union[bool, None]: ...
    def _process_multi_state(self, entity_observation: Observation) -> Union[bool, None]: ...
    @property
