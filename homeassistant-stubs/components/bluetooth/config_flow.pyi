...
class BluetoothConfigFlow(ConfigFlow, domain=DOMAIN):
    ...
    async def async_step_single_adapter(self, user_input: dict[str, Any] | None = None) -> FlowResult: ...
    async def async_step_multiple_adapters(self, user_input: dict[str, Any] | None = None) -> FlowResult: ...
