...
class BluetoothManager:
    ...
    def async_get_scanner_discovered_devices_and_advertisement_data_by_address(self, address: str, connectable: bool) -> list[tuple[BaseHaScanner, BLEDevice, AdvertisementData]]: ...
    ...
    def async_register_scanner(self, scanner: BaseHaScanner, connectable: bool, connection_slots: Union[int, None] = ...) -> CALLBACK_TYPE: ...
