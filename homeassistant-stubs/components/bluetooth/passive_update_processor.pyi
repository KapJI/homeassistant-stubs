...
class PassiveBluetoothDataProcessor:
    ...
    def __init__(self, update_method: Callable[[BluetoothServiceInfoBleak], PassiveBluetoothDataUpdate[_T]]) -> None: ...
    @property
    ...
    def async_handle_bluetooth_event(self, service_info: BluetoothServiceInfoBleak, change: BluetoothChange) -> None: ...
