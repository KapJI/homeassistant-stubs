import logging
from . import BluetoothChange as BluetoothChange
...
class PassiveBluetoothDataProcessor:
    ...
    def __init__(self, update_method: Callable[[BluetoothServiceInfo], PassiveBluetoothDataUpdate[_T]]) -> None: ...
    @property
    ...
    def async_handle_bluetooth_event(self, service_info: BluetoothServiceInfo, change: BluetoothChange) -> None: ...
