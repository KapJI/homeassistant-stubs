...
class HaBleakScannerWrapper(BaseBleakScanner):
    ...
    def __init__(self, *args: Any, detection_callback: AdvertisementDataCallback | None = None, service_uuids: list[str] | None = None, **kwargs: Any) -> None: ...
    @classmethod
...
class HaBleakClientWrapper(BleakClient):
    ...
    _backend: Incomplete
    def __init__(self, address_or_ble_device: str | BLEDevice, disconnected_callback: Callable[[BleakClient], None] | None = None, *args: Any, timeout: float = 10.0, **kwargs: Any) -> None: ...
    @property
