...
class BMWRequiredKeysMixin:
    ...
    def __mypy-replace(*, value_fn, remote_service_on, remote_service_off) -> None: ...
...
class BMWSwitchEntityDescription(SwitchEntityDescription, BMWRequiredKeysMixin):
    ...
    def __mypy-replace(*, value_fn, remote_service_on, remote_service_off, key, device_class, entity_category, entity_registry_enabled_default, entity_registry_visible_default, force_update, icon, has_entity_name, name, translation_key, unit_of_measurement, is_available, dynamic_options) -> None: ...
