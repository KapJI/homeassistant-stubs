...
class BoschAreaSensor(BoschAlarmAreaEntity, SensorEntity):
    ...
    def __init__(self, hass: HomeAssistant, panel: Panel, area_id: int, unique_id: str, config_entry_id: str, entity_description: BoschAlarmSensorEntityDescription) -> None: ...
    @property
    @override
