...
class PanelDoorEntity(BoschAlarmDoorEntity, SwitchEntity):
    ...
    def __init__(self, hass: HomeAssistant, panel: Panel, door_id: int, unique_id: str, config_entry_id: str, entity_description: BoschAlarmSwitchEntityDescription) -> None: ...
    @property
    @override
    def is_on(self) -> bool: ...
    @override
