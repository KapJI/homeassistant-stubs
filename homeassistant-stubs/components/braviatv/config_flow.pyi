from .const import ATTR_CID as ATTR_CID, ATTR_MAC as ATTR_MAC, ATTR_MODEL as ATTR_MODEL, CONF_NICKNAME as CONF_NICKNAME, CONF_USE_PSK as CONF_USE_PSK, CONF_USE_SSL as CONF_USE_SSL, DOMAIN as DOMAIN, NICKNAME_PREFIX as NICKNAME_PREFIX
