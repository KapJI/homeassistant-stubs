...
class BraviaTVConfigFlow(config_entries.ConfigFlow):
    ...
    async def async_step_pin(self, user_input: Union[dict[str, Any], None] = ...) -> FlowResult: ...
    async def async_step_psk(self, user_input: Union[dict[str, Any], None] = ...) -> FlowResult: ...
