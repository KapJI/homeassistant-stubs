...
class BraviaTVCoordinator(DataUpdateCoordinator[None]):
    ...
    def _sources_extend(self, sources: list[dict], source_type: SourceType, add_to_list: bool = ..., sort_by: Union[str, None] = ...) -> None: ...
    ...
    async def async_source_start(self, uri: str, source_type: Union[SourceType, str]) -> None: ...
    async def async_source_find(self, query: str, source_type: Union[SourceType, str]) -> None: ...
