...
ISSUE_OUTDATED_FIRMWARE: str
MINIMUM_FULL_API_VERSION: Incomplete
...
def _async_manage_outdated_firmware_issue(hass: HomeAssistant, entry: BSBLanConfigEntry, firmware_version: str, json_api_version: str | None) -> None: ...
