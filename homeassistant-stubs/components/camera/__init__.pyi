...
async def _async_get_image(camera: Camera, timeout: int = ..., width: int | None = ..., height: int | None = ...) -> Image: ...
async def async_get_image(hass: HomeAssistant, entity_id: str, timeout: int = ..., width: int | None = ..., height: int | None = ...) -> Image: ...
async def _async_get_stream_image(camera: Camera, width: int | None = ..., height: int | None = ..., wait_for_next_keyframe: bool = ...) -> bytes | None: ...
