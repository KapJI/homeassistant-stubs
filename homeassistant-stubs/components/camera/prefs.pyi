...
class CameraPreferences:
    ...
    async def async_update(self, entity_id: str, *, preload_stream: Union[bool, UndefinedType] = ..., orientation: Union[Orientation, UndefinedType] = ...) -> dict[str, Union[bool, Orientation]]: ...
