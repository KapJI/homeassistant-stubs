...
class CloudPreferences:
    ...
    async def async_update(self, *, alexa_enabled: bool | UndefinedType = ..., alexa_report_state: bool | UndefinedType = ..., alexa_settings_version: int | UndefinedType = ..., cloud_ice_servers_enabled: bool | UndefinedType = ..., cloud_user: str | UndefinedType = ..., cloudhooks: dict[str, dict[str, str | bool]] | UndefinedType = ..., google_connected: bool | UndefinedType = ..., google_enabled: bool | UndefinedType = ..., google_report_state: bool | UndefinedType = ..., google_secure_devices_pin: str | UndefinedType | None = ..., google_settings_version: int | UndefinedType = ..., remote_allow_remote_enable: bool | UndefinedType = ..., remote_domain: str | UndefinedType | None = ..., onboarded_items: list[str] | UndefinedType = ..., onboarding_postponed_until: str | UndefinedType | None = ..., remote_enabled: bool | UndefinedType = ..., tts_default_voice: tuple[str, str] | UndefinedType = ...) -> None: ...
