...
def load_api_data(device: ComelitSerialBridgeObject, domain: Literal['climate', 'humidifier']) -> list[Any]: ...
...
def _async_remove_stale_devices(hass: HomeAssistant, identifiers: list[str], config_entry: ConfigEntry) -> None: ...
...
def new_device_listener(coordinator: ComelitBaseCoordinator, new_devices_callback: Callable[[list[ObjectClassType], str], None], data_type: str) -> Callable[[], None]: ...
