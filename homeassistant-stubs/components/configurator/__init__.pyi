...
def async_request_config(hass: HomeAssistant, name: str, callback: Union[ConfiguratorCallback, None] = ..., description: Union[str, None] = ..., description_image: Union[str, None] = ..., submit_caption: Union[str, None] = ..., fields: Union[list[dict[str, str]], None] = ..., link_name: Union[str, None] = ..., link_url: Union[str, None] = ..., entity_picture: Union[str, None] = ...) -> str: ...
...
class Configurator:
    ...
    def async_request_config(self, name: str, callback: Union[ConfiguratorCallback, None], description: Union[str, None], submit_caption: Union[str, None], fields: Union[list[dict[str, str]], None], entity_picture: Union[str, None]) -> str: ...
