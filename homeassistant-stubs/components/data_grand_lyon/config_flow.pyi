...
class StopSubentryFlowHandler(ConfigSubentryFlow):
    _stops: list[TclStop]
    _selected_stop: TclStop | None
    _selected_stop_id: int | None
    def __init__(self) -> None: ...
    async def async_step_user(self, user_input: dict[str, Any] | None = None) -> SubentryFlowResult: ...
    async def async_step_pick_line(self, user_input: dict[str, Any] | None = None) -> SubentryFlowResult: ...
