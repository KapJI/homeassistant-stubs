from .const import CONF_LINE as CONF_LINE, CONF_PARK_ID as CONF_PARK_ID, CONF_STATION_ID as CONF_STATION_ID, CONF_STOP_ID as CONF_STOP_ID, DOMAIN as DOMAIN, LOGGER as LOGGER, SUBENTRY_TYPE_PARK_AND_RIDE as SUBENTRY_TYPE_PARK_AND_RIDE, SUBENTRY_TYPE_STOP as SUBENTRY_TYPE_STOP, SUBENTRY_TYPE_VELOV_STATION as SUBENTRY_TYPE_VELOV_STATION
from _typeshed import Incomplete
from data_grand_lyon_ha import DataGrandLyonClient as DataGrandLyonClient, TclParkAndRide, TclPassage, VelovStation
...
class DataGrandLyonParkAndRideCoordinator(DataUpdateCoordinator[dict[str, TclParkAndRide]]):
    config_entry: DataGrandLyonConfigEntry
    client: Incomplete
    def __init__(self, hass: HomeAssistant, entry: DataGrandLyonConfigEntry, client: DataGrandLyonClient) -> None: ...
    @override
