...
async def async_setup_entry(hass: HomeAssistant, config_entry: DeconzConfigEntry) -> bool: ...
async def async_unload_entry(hass: HomeAssistant, config_entry: DeconzConfigEntry) -> bool: ...
async def async_update_master_hub(hass: HomeAssistant, config_entry: DeconzConfigEntry, *, master: bool | None = None) -> None: ...
