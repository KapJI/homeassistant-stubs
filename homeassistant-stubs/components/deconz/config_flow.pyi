...
class DeconzFlowHandler(ConfigFlow, domain=DOMAIN):
    ...
    async def async_step_manual_input(self, user_input: dict[str, Any] | None = None) -> FlowResult: ...
...
class DeconzOptionsFlowHandler(OptionsFlow):
    ...
    async def async_step_deconz_devices(self, user_input: dict[str, Any] | None = None) -> FlowResult: ...
