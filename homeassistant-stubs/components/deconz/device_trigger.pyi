...
def _get_deconz_event_from_device(hass: HomeAssistant, device: dr.DeviceEntry) -> Union[DeconzAlarmEvent, DeconzEvent, DeconzPresenceEvent, DeconzRelativeRotaryEvent]: ...
