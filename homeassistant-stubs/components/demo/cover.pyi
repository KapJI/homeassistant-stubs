...
class DemoCover(CoverEntity):
    ...
    _is_closing: bool
    _closed: bool
    def __init__(self, hass: HomeAssistant, unique_id: str, name: str, position: Union[int, None] = ..., tilt_position: Union[int, None] = ..., device_class: Union[CoverDeviceClass, None] = ..., supported_features: Union[CoverEntityFeature, None] = ...) -> None: ...
    @property
