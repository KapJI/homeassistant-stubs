...
class DemoHumidifier(HumidifierEntity):
    ...
    def __init__(self, name: str, mode: str | None, target_humidity: int, current_humidity: int | None = None, available_modes: list[str] | None = None, is_on: bool = True, action: HumidifierAction | None = None, device_class: HumidifierDeviceClass | None = None) -> None: ...
