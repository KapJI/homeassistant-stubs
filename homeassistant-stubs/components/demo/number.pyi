...
class DemoNumber(NumberEntity):
    ...
    def __init__(self, unique_id: str, name: str, state: float, icon: str, assumed_state: bool, *, device_class: NumberDeviceClass | None = ..., mode: NumberMode = ..., native_min_value: float | None = ..., native_max_value: float | None = ..., native_step: float | None = ..., unit_of_measurement: str | None = ...) -> None: ...
