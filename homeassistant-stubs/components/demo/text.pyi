...
class DemoText(TextEntity):
    ...
    def __init__(self, unique_id: str, device_name: str, icon: str | None, native_value: str | None, mode: TextMode = ..., native_max: int | None = None, native_min: int | None = None, pattern: str | None = None) -> None: ...
