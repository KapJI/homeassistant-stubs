...
class DemoText(TextEntity):
    ...
    def __init__(self, unique_id: str, name: str, icon: str | None, native_value: str | None, mode: TextMode = ..., native_max: int | None = ..., native_min: int | None = ..., pattern: str | None = ...) -> None: ...
