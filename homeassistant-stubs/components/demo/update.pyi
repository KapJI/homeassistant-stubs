...
class DemoUpdate(UpdateEntity):
    ...
    def __init__(self, *, unique_id: str, name: str, title: str | None, installed_version: str | None, latest_version: str | None, release_summary: str | None = ..., release_url: str | None = ..., support_progress: bool = ..., support_install: bool = ..., support_release_notes: bool = ..., device_class: UpdateDeviceClass | None = ...) -> None: ...
