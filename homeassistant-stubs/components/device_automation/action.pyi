...
class DeviceAutomationActionProtocol(metaclass=abc.ABCMeta):
    ...
    def async_get_action_capabilities(self, hass: HomeAssistant, config: ConfigType) -> Union[dict[str, vol.Schema], Awaitable[dict[str, vol.Schema]]]: ...
    def async_get_actions(self, hass: HomeAssistant, device_id: str) -> Union[list[dict[str, Any]], Awaitable[list[dict[str, Any]]]]: ...
