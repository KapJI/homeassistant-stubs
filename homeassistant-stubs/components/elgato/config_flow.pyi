...
class ElgatoFlowHandler(ConfigFlow, domain=DOMAIN):
    ...
    async def async_step_zeroconf_confirm(self, _: dict[str, Any] | None = None) -> FlowResult: ...
    def _async_show_setup_form(self, errors: dict[str, str] | None = None) -> FlowResult: ...
