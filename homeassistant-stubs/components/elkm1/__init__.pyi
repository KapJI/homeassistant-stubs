...
class ElkSyncWaiter:
    _elk: Incomplete
    _login_timeout: Incomplete
    _sync_timeout: Incomplete
    _loop: Incomplete
    _sync_future: asyncio.Future[None]
    _login_future: asyncio.Future[None]
    ...
    @callback
    def _async_set_exception_if_not_done(self, future: asyncio.Future[None], exception: type[Exception]) -> None: ...
    @callback
