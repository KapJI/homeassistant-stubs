...
class ElkArea(ElkAttachedEntity, AlarmControlPanelEntity, RestoreEntity):
    ...
    async def async_alarm_arm_home_instant(self, code: str | None = ...) -> None: ...
    async def async_alarm_arm_night_instant(self, code: str | None = ...) -> None: ...
    ...
    async def async_bypass(self, code: str | None = ...) -> None: ...
    async def async_clear_bypass(self, code: str | None = ...) -> None: ...
