...
async def async_discover_devices(hass: HomeAssistant, timeout: int, address: Union[str, None] = ...) -> list[ElkSystem]: ...
async def async_discover_device(hass: HomeAssistant, host: str) -> Union[ElkSystem, None]: ...
