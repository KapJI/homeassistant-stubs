...
class ValidationIssue:
    ...
    def __mypy-replace(*, type, affected_entities, translation_placeholders) -> None: ...
...
class ValidationIssues:
    ...
    def __mypy-replace(*, issues) -> None: ...
...
class EnergyPreferencesValidation:
    ...
    def __mypy-replace(*, energy_sources, device_consumption) -> None: ...
