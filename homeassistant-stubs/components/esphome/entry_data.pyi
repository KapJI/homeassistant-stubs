...
class RuntimeEntryData:
    ...
    def __init__(self, entry_id, client, store, state, info, old_info, services, available, device_info, api_version, cleanup_callbacks, disconnect_callbacks, loaded_platforms, platform_load_lock, _storage_contents) -> None: ...
