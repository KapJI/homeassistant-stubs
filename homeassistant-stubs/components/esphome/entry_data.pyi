...
class RuntimeEntryData:
    ...
    def __init__(self, entry_id, client, store, state, info, old_info, services, available, device_info, api_version, cleanup_callbacks, disconnect_callbacks, state_subscriptions, loaded_platforms, platform_load_lock, _storage_contents, ble_connections_free, ble_connections_limit, _ble_connection_free_futures, _gatt_services_cache, _gatt_mtu_cache) -> None: ...
