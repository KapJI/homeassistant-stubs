...
class DeviceConflictRepair(ESPHomeRepair):
    ...
    async def async_step_migrate(self, user_input: dict[str, str] | None = None) -> RepairsFlowResult: ...
    async def async_step_manual(self, user_input: dict[str, str] | None = None) -> RepairsFlowResult: ...
