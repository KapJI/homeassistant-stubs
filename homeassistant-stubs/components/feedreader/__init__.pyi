...
class FeedManager:
    ...
    _feed_id: Incomplete
    def __init__(self, url: str, scan_interval: timedelta, max_entries: int, hass: HomeAssistant, storage: StoredData): ...
...
class StoredData:
    ...
    def get_timestamp(self, feed_id: str) -> Union[struct_time, None]: ...
