...
async def _async_migrate_unique_ids(hass: HomeAssistant, entry: FluxLedConfigEntry) -> None: ...
async def _async_update_listener(hass: HomeAssistant, entry: FluxLedConfigEntry) -> None: ...
