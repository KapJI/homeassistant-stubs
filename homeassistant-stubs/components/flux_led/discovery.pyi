...
def async_name_from_discovery(device: FluxLEDDiscovery, model_num: int | None = ...) -> str: ...
...
async def async_discover_devices(hass: HomeAssistant, timeout: int, address: str | None = ...) -> list[FluxLEDDiscovery]: ...
