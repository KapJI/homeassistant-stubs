...
def _retrieve_cpu_temperature_state(status: FritzStatus, last_value: float | None) -> float | None: ...
def _is_suitable_cpu_temperature(status: FritzStatus) -> bool: ...

@dataclass(frozen=True, kw_only=True)
class FritzConnectionSensorEntityDescription(SensorEntityDescription, FritzEntityDescription):
    is_suitable: Callable[[ConnectionInfo], bool] = ...

@dataclass(frozen=True, kw_only=True)
class FritzDeviceSensorEntityDescription(SensorEntityDescription, FritzEntityDescription):
    is_suitable: Callable[[FritzStatus], bool] = ...
