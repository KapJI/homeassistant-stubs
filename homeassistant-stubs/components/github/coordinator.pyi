...
from aiogithubapi import GitHubAPI as GitHubAPI, GitHubAuthenticatedUserModel, GitHubEventModel as GitHubEventModel, GitHubException, GitHubResponseModel as GitHubResponseModel
...
class GitHubUserDataUpdateCoordinator(DataUpdateCoordinator[GitHubAuthenticatedUserModel]):
    config_entry: GithubConfigEntry
    _client: Incomplete
    def __init__(self, hass: HomeAssistant, config_entry: GithubConfigEntry, client: GitHubAPI) -> None: ...
    @override
