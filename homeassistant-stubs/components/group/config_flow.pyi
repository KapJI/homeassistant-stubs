...
from homeassistant.helpers.helper_config_entry_flow import HelperConfigFlowHandler as HelperConfigFlowHandler, HelperFlowFormStep as HelperFlowFormStep, HelperFlowMenuStep as HelperFlowMenuStep, HelperOptionsFlowHandler as HelperOptionsFlowHandler, entity_selector_without_own_entities as entity_selector_without_own_entities
from typing import Any

def basic_group_options_schema(domain: str, handler: Union[HelperConfigFlowHandler, HelperOptionsFlowHandler], options: dict[str, Any]) -> vol.Schema: ...
def basic_group_config_schema(domain: str) -> vol.Schema: ...
def binary_sensor_options_schema(handler: Union[HelperConfigFlowHandler, HelperOptionsFlowHandler], options: dict[str, Any]) -> vol.Schema: ...

BINARY_SENSOR_CONFIG_SCHEMA: Any

def light_switch_options_schema(domain: str, handler: Union[HelperConfigFlowHandler, HelperOptionsFlowHandler], options: dict[str, Any]) -> vol.Schema: ...
