...
def calc_min(sensor_values: list[tuple[str, float, State]]) -> tuple[dict[str, Union[str, None]], Union[float, None]]: ...
def calc_max(sensor_values: list[tuple[str, float, State]]) -> tuple[dict[str, Union[str, None]], Union[float, None]]: ...
def calc_mean(sensor_values: list[tuple[str, float, State]]) -> tuple[dict[str, Union[str, None]], Union[float, None]]: ...
def calc_median(sensor_values: list[tuple[str, float, State]]) -> tuple[dict[str, Union[str, None]], Union[float, None]]: ...
