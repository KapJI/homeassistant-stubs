...
def calc_min(sensor_values: list[tuple[str, float, State]]) -> tuple[dict[str, Union[str, None]], float]: ...
def calc_max(sensor_values: list[tuple[str, float, State]]) -> tuple[dict[str, Union[str, None]], float]: ...
def calc_mean(sensor_values: list[tuple[str, float, State]]) -> tuple[dict[str, Union[str, None]], float]: ...
def calc_median(sensor_values: list[tuple[str, float, State]]) -> tuple[dict[str, Union[str, None]], float]: ...
def calc_last(sensor_values: list[tuple[str, float, State]]) -> tuple[dict[str, Union[str, None]], float]: ...
...
CALC_TYPES: dict[str, Callable[[list[tuple[str, float, State]]], tuple[dict[str, Union[str, None]], float]]]
...
class SensorGroup(GroupEntity, SensorEntity):
    ...
    def __init__(self, unique_id: Union[str, None], name: str, entity_ids: list[str], mode: bool, sensor_type: str, unit_of_measurement: Union[str, None], state_class: Union[SensorStateClass, None], device_class: Union[SensorDeviceClass, None]) -> None: ...
