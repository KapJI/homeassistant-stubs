...
class HERETravelTimeConfigFlow(config_entries.ConfigFlow, domain=DOMAIN):
    ...
    async def async_step_origin_coordinates(self, user_input: dict[str, Any] | None = None) -> FlowResult: ...
    async def async_step_destination_menu(self, _: None = None) -> FlowResult: ...
    async def async_step_origin_entity(self, user_input: dict[str, Any] | None = None) -> FlowResult: ...
    async def async_step_destination_coordinates(self, user_input: dict[str, Any] | None = None) -> FlowResult: ...
    async def async_step_destination_entity(self, user_input: dict[str, Any] | None = None) -> FlowResult: ...
...
class HERETravelTimeOptionsFlow(config_entries.OptionsFlow):
    ...
    async def async_step_no_time(self, user_input: dict[str, Any] | None = None) -> FlowResult: ...
    async def async_step_arrival_time(self, user_input: dict[str, Any] | None = None) -> FlowResult: ...
    async def async_step_departure_time(self, user_input: dict[str, Any] | None = None) -> FlowResult: ...
