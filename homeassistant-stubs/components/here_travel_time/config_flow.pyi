...
class HERETravelTimeConfigFlow(config_entries.ConfigFlow):
    VERSION: int
    _config: Incomplete
    ...
    async def async_step_origin_coordinates(self, user_input: Union[dict[str, Any], None] = ...) -> FlowResult: ...
    async def async_step_origin_entity(self, user_input: Union[dict[str, Any], None] = ...) -> FlowResult: ...
    async def async_step_destination_coordinates(self, user_input: Union[dict[str, Any], None] = ...) -> FlowResult: ...
    async def async_step_destination_entity(self, user_input: Union[dict[str, Any], None] = ...) -> FlowResult: ...
...
class HERETravelTimeOptionsFlow(config_entries.OptionsFlow):
    ...
    async def async_step_no_time(self, user_input: Union[dict[str, Any], None] = ...) -> FlowResult: ...
    async def async_step_arrival_time(self, user_input: Union[dict[str, Any], None] = ...) -> FlowResult: ...
    async def async_step_departure_time(self, user_input: Union[dict[str, Any], None] = ...) -> FlowResult: ...
