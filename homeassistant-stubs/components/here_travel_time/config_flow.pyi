...
class HERETravelTimeConfigFlow(config_entries.ConfigFlow, domain=DOMAIN):
    ...
    @staticmethod
    def async_get_options_flow(config_entry: config_entries.ConfigEntry) -> HERETravelTimeOptionsFlow: ...
    async def async_step_user(self, user_input: dict[str, Any] | None = ...) -> FlowResult: ...
    async def async_step_origin_menu(self, _: None = ...) -> FlowResult: ...
    async def async_step_origin_coordinates(self, user_input: dict[str, Any] | None = ...) -> FlowResult: ...
    async def async_step_destination_menu(self, _: None = ...) -> FlowResult: ...
    async def async_step_origin_entity(self, user_input: dict[str, Any] | None = ...) -> FlowResult: ...
    async def async_step_destination_coordinates(self, user_input: dict[str, Any] | None = ...) -> FlowResult: ...
    async def async_step_destination_entity(self, user_input: dict[str, Any] | None = ...) -> FlowResult: ...
...
class HERETravelTimeOptionsFlow(config_entries.OptionsFlow):
    ...
    async def async_step_time_menu(self, _: None = ...) -> FlowResult: ...
    async def async_step_no_time(self, user_input: dict[str, Any] | None = ...) -> FlowResult: ...
    async def async_step_arrival_time(self, user_input: dict[str, Any] | None = ...) -> FlowResult: ...
    async def async_step_departure_time(self, user_input: dict[str, Any] | None = ...) -> FlowResult: ...
