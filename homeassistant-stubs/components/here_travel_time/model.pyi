...
class HERETravelTimeConfig:
    ...
    def __mypy-replace(*, destination_latitude, destination_longitude, destination_entity_id, origin_latitude, origin_longitude, origin_entity_id, travel_mode, route_mode, arrival, departure) -> None: ...
