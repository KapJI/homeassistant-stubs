...
def _ws_get_significant_states(hass: HomeAssistant, msg_id: int, start_time: dt, end_time: Union[dt, None], entity_ids: Union[list[str], None], filters: Union[Filters, None], include_start_time_state: bool, significant_changes_only: bool, minimal_response: bool, no_attributes: bool) -> str: ...
...
def _async_send_response(connection: ActiveConnection, msg_id: int, start_time: dt, end_time: dt, states: MutableMapping[str, list[dict[str, Any]]]) -> None: ...
...
def _async_subscribe_events(hass: HomeAssistant, subscriptions: list[CALLBACK_TYPE], target: Callable[[Event], None], entities_filter: Union[EntityFilter, None], entity_ids: Union[list[str], None], significant_changes_only: bool, minimal_response: bool) -> None: ...
