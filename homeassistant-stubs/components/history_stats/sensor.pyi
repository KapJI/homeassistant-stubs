...
class HistoryStatsSensor(HistoryStatsSensorBase):
    ...
    def __init__(self, *, coordinator: HistoryStatsUpdateCoordinator, sensor_type: str, name: str, unique_id: str | None, state_class: SensorStateClass | None, device: AnyDeviceEntry | None = None) -> None: ...
