...
from aiohomeconnect.model import CommandKey, Event, EventKey, EventMessage as EventMessage, GetSetting, HomeAppliance as HomeAppliance, OptionKey, ProgramKey, SettingKey, Status, StatusKey
from aiohomeconnect.model.image import Image as Image
...
class HomeConnectApplianceCoordinator(DataUpdateCoordinator[HomeConnectApplianceData]):
    ...
    should_fetch_images: Incomplete
    _image_listeners: dict[str, list[CALLBACK_TYPE]]
    ...
    def add_image_listener(self, image_key: str, update_callback: CALLBACK_TYPE) -> Callable[[], None]: ...
