...
def _get_option_entities_for_appliance(appliance_coordinator: HomeConnectApplianceCoordinator, entity_registry: er.EntityRegistry) -> list[HomeConnectEntity]: ...
...
class HomeConnectProgramSelectEntity(HomeConnectEntity, SelectEntity):
    ...
    def __init__(self, appliance_coordinator: HomeConnectApplianceCoordinator, desc: HomeConnectProgramSelectEntityDescription) -> None: ...
