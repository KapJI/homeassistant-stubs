...
async def add_alarm_control_panel_entities(hass: HomeAssistant, config_entry: HomeeConfigEntry, async_add_entities: AddConfigEntryEntitiesCallback, nodes: list[HomeeNode]) -> None: ...
...
class HomeeAlarmPanel(HomeeEntity, AlarmControlPanelEntity):
    ...
    def __init__(self, hass: HomeAssistant, attribute: HomeeAttribute, entry: HomeeConfigEntry, description: HomeeAlarmControlPanelEntityDescription) -> None: ...
    @property
    @override
