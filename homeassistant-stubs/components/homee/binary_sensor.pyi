...
async def add_binary_sensor_entities(hass: HomeAssistant, config_entry: HomeeConfigEntry, async_add_entities: AddConfigEntryEntitiesCallback, nodes: list[HomeeNode]) -> None: ...
...
class HomeeBinarySensor(HomeeEntity, BinarySensorEntity):
    ...
    def __init__(self, hass: HomeAssistant, attribute: HomeeAttribute, entry: HomeeConfigEntry, description: BinarySensorEntityDescription) -> None: ...
    @property
    @override
    def is_on(self) -> bool: ...
