...
async def add_event_entities(hass: HomeAssistant, config_entry: HomeeConfigEntry, async_add_entities: AddConfigEntryEntitiesCallback, nodes: list[HomeeNode]) -> None: ...
...
class HomeeEvent(HomeeEntity, EventEntity):
    ...
    def __init__(self, hass: HomeAssistant, attribute: HomeeAttribute, entry: HomeeConfigEntry, description: EventEntityDescription) -> None: ...
    @override
