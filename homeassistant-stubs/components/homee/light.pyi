...
async def add_light_entities(hass: HomeAssistant, config_entry: HomeeConfigEntry, async_add_entities: AddConfigEntryEntitiesCallback, nodes: list[HomeeNode]) -> None: ...
...
class HomeeLight(HomeeNodeEntity, LightEntity):
    ...
    def __init__(self, hass: HomeAssistant, node: HomeeNode, light: dict[AttributeType, HomeeAttribute], entry: HomeeConfigEntry) -> None: ...
    @property
    @override
