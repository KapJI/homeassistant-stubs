...
async def add_number_entities(hass: HomeAssistant, config_entry: HomeeConfigEntry, async_add_entities: AddConfigEntryEntitiesCallback, nodes: list[HomeeNode]) -> None: ...
...
class HomeeNumber(HomeeEntity, NumberEntity):
    ...
    def __init__(self, hass: HomeAssistant, attribute: HomeeAttribute, entry: HomeeConfigEntry, description: HomeeNumberEntityDescription) -> None: ...
    @property
    @override
