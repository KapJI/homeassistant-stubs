...
class HomeeSensor(HomeeEntity, SensorEntity):
    ...
    def __init__(self, hass: HomeAssistant, attribute: HomeeAttribute, entry: HomeeConfigEntry, description: HomeeSensorEntityDescription) -> None: ...
    @property
    @override
...
class HomeeNodeSensor(HomeeNodeEntity, SensorEntity):
    ...
    def __init__(self, hass: HomeAssistant, node: HomeeNode, entry: HomeeConfigEntry, description: HomeeNodeSensorEntityDescription) -> None: ...
    @property
    @override
