...
async def add_valve_entities(hass: HomeAssistant, config_entry: HomeeConfigEntry, async_add_entities: AddConfigEntryEntitiesCallback, nodes: list[HomeeNode]) -> None: ...
...
class HomeeValve(HomeeEntity, ValveEntity):
    ...
    def __init__(self, hass: HomeAssistant, attribute: HomeeAttribute, entry: HomeeConfigEntry, description: ValveEntityDescription) -> None: ...
    @property
    @override
