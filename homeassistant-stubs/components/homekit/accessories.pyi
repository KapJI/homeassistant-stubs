...
class HomeAccessory(Accessory):
    ...
    def __init__(self, hass: HomeAssistant, driver: HomeDriver, name: str, entity_id: str, aid: int, config: dict, *args: Any, category: str = ..., device_id: str | None = ..., **kwargs: Any) -> None: ...
    @property
