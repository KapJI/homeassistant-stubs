...
class OptionsFlowHandler(config_entries.OptionsFlow):
    ...
    async def async_step_cameras(self, user_input: Union[dict[str, Any], None] = ...) -> FlowResult: ...
    async def async_step_accessory(self, user_input: Union[dict[str, Any], None] = ...) -> FlowResult: ...
    async def async_step_include(self, user_input: Union[dict[str, Any], None] = ...) -> FlowResult: ...
    async def async_step_exclude(self, user_input: Union[dict[str, Any], None] = ...) -> FlowResult: ...
    async def async_step_init(self, user_input: Union[dict[str, Any], None] = ...) -> FlowResult: ...

async def _async_get_supported_devices(hass: HomeAssistant) -> dict[str, str]: ...
def _exclude_by_entity_registry(ent_reg: entity_registry.EntityRegistry, entity_id: str, include_entity_category: bool) -> bool: ...
def _async_get_matching_entities(hass: HomeAssistant, domains: Union[list[str], None] = ..., include_entity_category: bool = ...) -> dict[str, str]: ...
