...
CONF_LINKED_FILTER_CHANGE_INDICATION: str
CONF_LINKED_FILTER_LIFE_LEVEL: str
CONF_LINKED_MOTION_SENSOR: str
CONF_LINKED_HUMIDITY_SENSOR: str
CONF_LINKED_OBSTRUCTION_SENSOR: str
CONF_LINKED_PM25_SENSOR: str
CONF_LINKED_TEMPERATURE_SENSOR: str
CONF_LINKED_VALVE_DURATION: str
CONF_LINKED_VALVE_END_TIME: str
...
TYPE_VALVE: str
TYPE_FAN: str
TYPE_AIR_PURIFIER: str
TYPE_HEATER_COOLER: str
TYPE_THERMOSTAT: str
CATEGORY_RECEIVER: int
SERV_ACCESSORY_INFO: str
SERV_AIR_PURIFIER: str
...
SERV_DOORBELL: str
SERV_FANV2: str
SERV_FILTER_MAINTENANCE: str
SERV_GARAGE_DOOR_OPENER: str
SERV_HEATER_COOLER: str
...
CHAR_CURRENT_AIR_PURIFIER_STATE: str
CHAR_CURRENT_DOOR_STATE: str
CHAR_CURRENT_FAN_STATE: str
CHAR_CURRENT_HEATER_COOLER_STATE: str
...
CHAR_FILTER_CHANGE_INDICATION: str
CHAR_FILTER_LIFE_LEVEL: str
...
CHAR_SWING_MODE: str
CHAR_TARGET_AIR_PURIFIER_STATE: str
CHAR_TARGET_DOOR_STATE: str
CHAR_TARGET_HEATER_COOLER_STATE: str
...
THRESHOLD_CO: int
THRESHOLD_CO2: int
THRESHOLD_FILTER_CHANGE_NEEDED: int
