...
from .const import CHAR_ACTIVE as CHAR_ACTIVE, CHAR_CONFIGURED_NAME as CHAR_CONFIGURED_NAME, CHAR_NAME as CHAR_NAME, CHAR_ON as CHAR_ON, CHAR_ROTATION_DIRECTION as CHAR_ROTATION_DIRECTION, CHAR_ROTATION_SPEED as CHAR_ROTATION_SPEED, CHAR_SWING_MODE as CHAR_SWING_MODE, CHAR_TARGET_FAN_STATE as CHAR_TARGET_FAN_STATE, PROP_MIN_STEP as PROP_MIN_STEP, SERV_FANV2 as SERV_FANV2, SERV_SWITCH as SERV_SWITCH
from .util import cleanup_name_for_homekit as cleanup_name_for_homekit
from _typeshed import Incomplete
from homeassistant.components.fan import ATTR_DIRECTION as ATTR_DIRECTION, ATTR_OSCILLATING as ATTR_OSCILLATING, ATTR_PERCENTAGE as ATTR_PERCENTAGE, ATTR_PRESET_MODE as ATTR_PRESET_MODE, DIRECTION_FORWARD as DIRECTION_FORWARD, DIRECTION_REVERSE as DIRECTION_REVERSE, FanEntityCapabilityAttribute as FanEntityCapabilityAttribute, FanEntityFeature as FanEntityFeature, FanEntityStateAttribute as FanEntityStateAttribute, SERVICE_OSCILLATE as SERVICE_OSCILLATE, SERVICE_SET_DIRECTION as SERVICE_SET_DIRECTION, SERVICE_SET_PERCENTAGE as SERVICE_SET_PERCENTAGE, SERVICE_SET_PRESET_MODE as SERVICE_SET_PRESET_MODE
from homeassistant.const import ATTR_ENTITY_ID as ATTR_ENTITY_ID, EntityStateAttribute as EntityStateAttribute, SERVICE_TURN_OFF as SERVICE_TURN_OFF, SERVICE_TURN_ON as SERVICE_TURN_ON, STATE_OFF as STATE_OFF, STATE_ON as STATE_ON
...
class Fan(HomeAccessory):
    ...
    def __init__(self, *args: Any, category: int = ...) -> None: ...
