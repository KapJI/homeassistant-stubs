...
class Router:
    ...
    def __init__(self, config_entry: Any, connection: Any, url: Any, mac: Any, signal_update: Any, data: Any, subscriptions: Any, inflight_gets: Any, suspended: Any, notify_last_attempt: Any) -> None: ...
