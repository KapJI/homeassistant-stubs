...
class ConfigFlowHandler(config_entries.ConfigFlow):
    ...
    async def _async_show_reauth_form(self, user_input: dict[str, Any], errors: Union[dict[str, str], None] = ...) -> FlowResult: ...
    async def _try_connect(self, user_input: dict[str, Any], errors: dict[str, str]) -> Union[Connection, None]: ...
    @staticmethod
