...
class ConfigFlowHandler(config_entries.ConfigFlow, domain=DOMAIN):
    ...
    async def _async_show_user_form(self, user_input: dict[str, Any] | None = None, errors: dict[str, str] | None = None) -> FlowResult: ...
    async def _async_show_reauth_form(self, user_input: dict[str, Any], errors: dict[str, str] | None = None) -> FlowResult: ...
