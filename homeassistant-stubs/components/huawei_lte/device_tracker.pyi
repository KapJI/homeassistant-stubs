...
def async_add_new_entities(hass: HomeAssistant, router_url: str, async_add_entities: Callable[[list[Entity], bool], None], tracked: set[str]) -> None: ...
...
class HuaweiLteScannerEntity(HuaweiLteBaseEntity, ScannerEntity):
    ...
    def __init__(self, router: Any, available: Any, unsub_handlers: Any, mac_address: Any, ip_address: Any, is_connected: Any, hostname: Any, extra_state_attributes: Any) -> None: ...
