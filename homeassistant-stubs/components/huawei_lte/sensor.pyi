...
from homeassistant.const import PERCENTAGE as PERCENTAGE, UnitOfDataRate as UnitOfDataRate, UnitOfFrequency as UnitOfFrequency, UnitOfInformation as UnitOfInformation, UnitOfTime as UnitOfTime
...
def format_last_reset_elapsed_seconds(value: Union[str, None]) -> Union[datetime, None]: ...
...
class HuaweiSensorEntityDescription(SensorEntityDescription):
    format_fn: Callable[[str], tuple[StateType, Union[str, None]]]
    icon_fn: Union[Callable[[StateType], str], None]
    device_class_fn: Union[Callable[[StateType], Union[SensorDeviceClass, None]], None]
    last_reset_item: Union[str, None]
    last_reset_format_fn: Union[Callable[[Union[str, None]], Union[datetime, None]], None]
    def __init__(self, key, device_class, entity_category, entity_registry_enabled_default, entity_registry_visible_default, force_update, icon, has_entity_name, name, translation_key, unit_of_measurement, last_reset, native_precision, native_unit_of_measurement, options, state_class, suggested_unit_of_measurement, format_fn, icon_fn, device_class_fn, last_reset_item, last_reset_format_fn) -> None: ...
...
class HuaweiLteSensor(HuaweiLteBaseEntityWithDevice, SensorEntity):
    ...
    _last_reset: Union[datetime, None]
