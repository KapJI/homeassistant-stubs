...
class HyperionConfigFlow(ConfigFlow):
    ...
    async def _advance_to_auth_step_if_necessary(self, hyperion_client: client.HyperionClient) -> FlowResultDict: ...
    async def async_step_reauth(self, config_data: ConfigType) -> FlowResultDict: ...
    async def async_step_ssdp(self, discovery_info: dict[str, Any]) -> FlowResultDict: ...
    async def async_step_user(self, user_input: Union[ConfigType, None]=...) -> FlowResultDict: ...
    ...
    async def async_step_auth(self, user_input: Union[ConfigType, None]=...) -> FlowResultDict: ...
    async def async_step_create_token(self, user_input: Union[ConfigType, None]=...) -> FlowResultDict: ...
    async def async_step_create_token_external(self, auth_resp: Union[ConfigType, None]=...) -> FlowResultDict: ...
    async def async_step_create_token_success(self, _: Union[ConfigType, None]=...) -> FlowResultDict: ...
    async def async_step_create_token_fail(self, _: Union[ConfigType, None]=...) -> FlowResultDict: ...
    async def async_step_confirm(self, user_input: Union[ConfigType, None]=...) -> FlowResultDict: ...
    @staticmethod
...
class HyperionOptionsFlow(OptionsFlow):
    ...
    async def async_step_init(self, user_input: Union[dict[str, Any], None]=...) -> FlowResultDict: ...
