...
class HyperionConfigFlow(ConfigFlow, domain=DOMAIN):
    ...
    async def async_step_create_token(self, user_input: dict[str, Any] | None = None) -> FlowResult: ...
    async def async_step_create_token_external(self, auth_resp: dict[str, Any] | None = None) -> FlowResult: ...
    async def async_step_create_token_success(self, _: dict[str, Any] | None = None) -> FlowResult: ...
    async def async_step_create_token_fail(self, _: dict[str, Any] | None = None) -> FlowResult: ...
