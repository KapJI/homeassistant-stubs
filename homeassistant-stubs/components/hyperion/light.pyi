...
class HyperionLight(LightEntity):
    ...
    def _set_internal_state(self, brightness: int | None = ..., rgb_color: Sequence[int] | None = ..., effect: str | None = ...) -> None: ...
    def _update_components(self, _: dict[str, Any] | None = ...) -> None: ...
    def _update_adjustment(self, _: dict[str, Any] | None = ...) -> None: ...
    def _update_priorities(self, _: dict[str, Any] | None = ...) -> None: ...
    def _update_effect_list(self, _: dict[str, Any] | None = ...) -> None: ...
    def _update_full_state(self) -> None: ...
    def _update_client(self, _: dict[str, Any] | None = ...) -> None: ...
