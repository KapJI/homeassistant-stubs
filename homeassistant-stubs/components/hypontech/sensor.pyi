from .coordinator import HypontechConfigEntry as HypontechConfigEntry, HypontechDataCoordinator as HypontechDataCoordinator, HypontechPlant as HypontechPlant
...
class HypontechPlantSensorDescription(SensorEntityDescription):
    ...
    unit_fn: Callable[[HypontechPlant], str] | None = ...
