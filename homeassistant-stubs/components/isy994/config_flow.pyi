...
from homeassistant import config_entries as config_entries, core as core, data_entry_flow as data_entry_flow, exceptions as exceptions
...
class ConfigFlow(config_entries.ConfigFlow):
    ...
    async def async_step_reauth(self, user_input: Union[dict[str, Any], None] = ...) -> data_entry_flow.FlowResult: ...
