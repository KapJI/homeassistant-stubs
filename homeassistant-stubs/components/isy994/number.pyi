...
from homeassistant.const import CONF_VARIABLES as CONF_VARIABLES, PERCENTAGE as PERCENTAGE, Platform as Platform, STATE_UNAVAILABLE as STATE_UNAVAILABLE, STATE_UNKNOWN as STATE_UNKNOWN
...
class ISYVariableNumberEntity(NumberEntity):
    ...
    def __init__(self, node: Variable, unique_id: str, description: NumberEntityDescription, device_info: DeviceInfo, init_entity: bool = ...) -> None: ...
...
class ISYBacklightNumberEntity(ISYAuxControlEntity, RestoreNumber):
    ...
    def __init__(self, node: Node, control: str, unique_id: str, description: NumberEntityDescription, device_info: Union[DeviceInfo, None]) -> None: ...
    async def async_added_to_hass(self) -> None: ...
