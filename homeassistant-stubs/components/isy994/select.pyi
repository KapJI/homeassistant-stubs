...
from homeassistant.const import Platform as Platform, STATE_UNAVAILABLE as STATE_UNAVAILABLE, STATE_UNKNOWN as STATE_UNKNOWN, UnitOfTime as UnitOfTime
...
class ISYBacklightSelectEntity(ISYAuxControlEntity, SelectEntity, RestoreEntity):
    ...
    def __init__(self, node: Node, control: str, unique_id: str, description: SelectEntityDescription, device_info: Union[DeviceInfo, None]) -> None: ...
