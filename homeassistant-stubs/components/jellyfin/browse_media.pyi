...
async def build_item_response(hass: HomeAssistant, client: JellyfinClient, user_id: str, media_content_id: str) -> BrowseMedia: ...
...
async def search_items(hass: HomeAssistant, client: JellyfinClient, user_id: str, query: SearchMediaQuery) -> list[BrowseMedia]: ...
async def get_media_info(hass: HomeAssistant, client: JellyfinClient, user_id: str, media_content_id: str) -> tuple[str | None, list[dict[str, Any]] | None, str | None, str | None]: ...
