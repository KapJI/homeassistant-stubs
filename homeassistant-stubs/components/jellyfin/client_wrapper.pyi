...
def create_client(device_id: str, device_name: Union[str, None] = ...) -> JellyfinClient: ...
...
def get_artwork_url(client: JellyfinClient, item: dict[str, Any], max_width: int = ...) -> Union[str, None]: ...
