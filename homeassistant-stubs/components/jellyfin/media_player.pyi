...
from .const import CONTENT_TYPE_MAP as CONTENT_TYPE_MAP, DOMAIN as DOMAIN, USER_APP_NAME as USER_APP_NAME
...
class JellyfinMediaPlayer(JellyfinEntity, MediaPlayerEntity):
    ...
    def play_media(self, media_type: str, media_id: str, **kwargs: dict[str, Any]) -> None: ...
