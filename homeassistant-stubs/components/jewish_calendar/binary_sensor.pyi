...
class JewishCalendarBinarySensorMixIns(BinarySensorEntityDescription):
    is_on: Callable[..., bool]
    def __init__(self, key, device_class, entity_category, entity_registry_enabled_default, entity_registry_visible_default, force_update, icon, has_entity_name, name, unit_of_measurement, is_on) -> None: ...
...
class JewishCalendarBinarySensor(BinarySensorEntity):
    ...
    def __init__(self, data: dict[str, Union[str, bool, int, float]], description: JewishCalendarBinarySensorEntityDescription) -> None: ...
    @property
    def is_on(self) -> bool: ...
