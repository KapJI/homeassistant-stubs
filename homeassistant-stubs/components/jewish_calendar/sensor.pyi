...
from homeassistant.const import DEVICE_CLASS_TIMESTAMP as DEVICE_CLASS_TIMESTAMP, SUN_EVENT_SUNSET as SUN_EVENT_SUNSET
...
class JewishCalendarTimeSensor(JewishCalendarSensor):
    ...
    @property
    def native_value(self) -> Union[StateType, None]: ...
    def get_state(self, daytime_date: HDate, after_shkia_date: HDate, after_tzais_date: HDate) -> Union[Any, None]: ...
