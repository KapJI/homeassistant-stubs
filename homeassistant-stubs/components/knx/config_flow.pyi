from .const import CONF_KNX_AUTOMATIC as CONF_KNX_AUTOMATIC, CONF_KNX_CONNECTION_TYPE as CONF_KNX_CONNECTION_TYPE, CONF_KNX_DEFAULT_RATE_LIMIT as CONF_KNX_DEFAULT_RATE_LIMIT, CONF_KNX_DEFAULT_STATE_UPDATER as CONF_KNX_DEFAULT_STATE_UPDATER, CONF_KNX_INDIVIDUAL_ADDRESS as CONF_KNX_INDIVIDUAL_ADDRESS, CONF_KNX_KNXKEY_PASSWORD as CONF_KNX_KNXKEY_PASSWORD, CONF_KNX_LOCAL_IP as CONF_KNX_LOCAL_IP, CONF_KNX_MCAST_GRP as CONF_KNX_MCAST_GRP, CONF_KNX_MCAST_PORT as CONF_KNX_MCAST_PORT, CONF_KNX_RATE_LIMIT as CONF_KNX_RATE_LIMIT, CONF_KNX_ROUTE_BACK as CONF_KNX_ROUTE_BACK, CONF_KNX_ROUTING as CONF_KNX_ROUTING, CONF_KNX_ROUTING_BACKBONE_KEY as CONF_KNX_ROUTING_BACKBONE_KEY, CONF_KNX_ROUTING_SECURE as CONF_KNX_ROUTING_SECURE, CONF_KNX_ROUTING_SYNC_LATENCY_TOLERANCE as CONF_KNX_ROUTING_SYNC_LATENCY_TOLERANCE, CONF_KNX_SECURE_DEVICE_AUTHENTICATION as CONF_KNX_SECURE_DEVICE_AUTHENTICATION, CONF_KNX_SECURE_USER_ID as CONF_KNX_SECURE_USER_ID, CONF_KNX_SECURE_USER_PASSWORD as CONF_KNX_SECURE_USER_PASSWORD, CONF_KNX_STATE_UPDATER as CONF_KNX_STATE_UPDATER, CONF_KNX_TELEGRAM_DB_BACKEND as CONF_KNX_TELEGRAM_DB_BACKEND, CONF_KNX_TELEGRAM_DB_DATABASE as CONF_KNX_TELEGRAM_DB_DATABASE, CONF_KNX_TELEGRAM_DB_HOST as CONF_KNX_TELEGRAM_DB_HOST, CONF_KNX_TELEGRAM_DB_LOAD_HOURS as CONF_KNX_TELEGRAM_DB_LOAD_HOURS, CONF_KNX_TELEGRAM_DB_PASSWORD as CONF_KNX_TELEGRAM_DB_PASSWORD, CONF_KNX_TELEGRAM_DB_PORT as CONF_KNX_TELEGRAM_DB_PORT, CONF_KNX_TELEGRAM_DB_POSTGRES_DSN as CONF_KNX_TELEGRAM_DB_POSTGRES_DSN, CONF_KNX_TELEGRAM_DB_RETENTION_DAYS as CONF_KNX_TELEGRAM_DB_RETENTION_DAYS, CONF_KNX_TELEGRAM_DB_TLS as CONF_KNX_TELEGRAM_DB_TLS, CONF_KNX_TELEGRAM_DB_USER as CONF_KNX_TELEGRAM_DB_USER, CONF_KNX_TUNNELING as CONF_KNX_TUNNELING, CONF_KNX_TUNNELING_TCP as CONF_KNX_TUNNELING_TCP, CONF_KNX_TUNNELING_TCP_SECURE as CONF_KNX_TUNNELING_TCP_SECURE, CONF_KNX_TUNNEL_ENDPOINT_IA as CONF_KNX_TUNNEL_ENDPOINT_IA, DEFAULT_ROUTING_IA as DEFAULT_ROUTING_IA, DOMAIN as DOMAIN, KNXConfigEntryData as KNXConfigEntryData, KNXConfigEntryOptions as KNXConfigEntryOptions, KNX_MODULE_KEY as KNX_MODULE_KEY, KNX_TELEGRAM_BACKEND_POSTGRES as KNX_TELEGRAM_BACKEND_POSTGRES, KNX_TELEGRAM_BACKEND_SQLITE as KNX_TELEGRAM_BACKEND_SQLITE, KNX_TELEGRAM_DB_RETENTION_DEFAULT as KNX_TELEGRAM_DB_RETENTION_DEFAULT, KNX_TELEGRAM_LOAD_HOURS_DEFAULT as KNX_TELEGRAM_LOAD_HOURS_DEFAULT
...
class KNXOptionsFlow(OptionsFlowWithReload):
    ...
    async def async_step_telegram_store_postgres(self, user_input: dict[str, Any] | None = None) -> ConfigFlowResult: ...
