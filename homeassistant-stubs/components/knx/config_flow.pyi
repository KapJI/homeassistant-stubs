...
class KNXCommonFlow(ABC, FlowHandler, metaclass=abc.ABCMeta):
    ...
    async def async_step_secure_key_source_menu_tunnel(self, user_input: dict | None = ...) -> FlowResult: ...
    async def async_step_secure_key_source_menu_routing(self, user_input: dict | None = ...) -> FlowResult: ...
