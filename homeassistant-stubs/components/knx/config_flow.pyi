...
class KNXCommonFlow(ABC, FlowHandler, metaclass=abc.ABCMeta):
    ...
    async def async_step_connection_type(self, user_input: dict | None = ...) -> FlowResult: ...
    async def async_step_tunnel(self, user_input: dict | None = ...) -> FlowResult: ...
    async def async_step_manual_tunnel(self, user_input: dict | None = ...) -> FlowResult: ...
    async def async_step_secure_tunnel_manual(self, user_input: dict | None = ...) -> FlowResult: ...
    async def async_step_secure_routing_manual(self, user_input: dict | None = ...) -> FlowResult: ...
...
class KNXOptionsFlow(KNXCommonFlow, OptionsFlow):
    ...
    new_entry_data: Incomplete
    async def async_step_communication_settings(self, user_input: dict[str, Any] | None = ...) -> FlowResult: ...
