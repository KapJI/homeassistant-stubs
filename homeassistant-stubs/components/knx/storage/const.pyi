...
CONF_GA_TEMPERATURE: Final[str]
CONF_GA_BRIGHTNESS_SOUTH: Final[str]
CONF_GA_BRIGHTNESS_NORTH: Final[str]
CONF_GA_BRIGHTNESS_WEST: Final[str]
CONF_GA_BRIGHTNESS_EAST: Final[str]
CONF_GA_WIND_SPEED: Final[str]
CONF_GA_WIND_BEARING: Final[str]
CONF_GA_RAIN_ALARM: Final[str]
CONF_GA_FROST_ALARM: Final[str]
CONF_GA_WIND_ALARM: Final[str]
CONF_GA_DAY_NIGHT: Final[str]
CONF_INVERT_DAY_NIGHT: Final[str]
CONF_GA_AIR_PRESSURE: Final[str]
CONF_GA_HUMIDITY: Final[str]
