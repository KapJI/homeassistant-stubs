...
from .coordinator import LEDBLEConfigEntry as LEDBLEConfigEntry, LEDBLECoordinator as LEDBLECoordinator
...
class LEDBLEEntity(CoordinatorEntity[LEDBLECoordinator], LightEntity):
    ...
    def __init__(self, coordinator: LEDBLECoordinator, device: LEDBLE, name: str) -> None: ...
