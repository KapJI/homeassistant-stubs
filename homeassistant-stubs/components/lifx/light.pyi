...
from .const import ATTR_DURATION as ATTR_DURATION, ATTR_INFRARED as ATTR_INFRARED, ATTR_POWER as ATTR_POWER, ATTR_ZONES as ATTR_ZONES, DATA_LIFX_MANAGER as DATA_LIFX_MANAGER, DOMAIN as DOMAIN, INFRARED_BRIGHTNESS as INFRARED_BRIGHTNESS, LIFX_CEILING_PRODUCT_IDS as LIFX_CEILING_PRODUCT_IDS, LOGGER as LOGGER
...
class LIFXLight(LIFXEntity, LightEntity):
    ...
    async def transform(self, hsbk: list[float | int | None], kwargs: dict[str, Any] | None = None, duration: float = 0, rapid: bool = False) -> None: ...
