...
def async_determine_event_types(hass: HomeAssistant, entity_ids: list[str] | None, device_ids: list[str] | None) -> set[EventType[Any] | str]: ...
@callback
def extract_attr(event_type: EventType[Any] | str, source: Mapping[str, Any], attr: str) -> list[str]: ...
@callback
...
@callback
def async_subscribe_events(hass: HomeAssistant, subscriptions: list[CALLBACK_TYPE], target: Callable[[Event[Any]], None], event_types: Collection[EventType[Any] | str], entities_filter: Callable[[str], bool] | None, entity_ids: list[str] | None, device_ids: list[str] | None) -> None: ...
