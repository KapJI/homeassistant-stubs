...
class LogbookConfig:
    ...
    def __mypy-replace(*, external_events, sqlalchemy_filter, entity_filter) -> None: ...
...
class EventAsRow:
    ...
    def __mypy-replace(*, data, context, context_id_bin, time_fired_ts, row_id, event_data, entity_id, icon, context_user_id_bin, context_parent_id_bin, event_type, state, context_only) -> None: ...
