...
class LogbookRun:
    ...
    format_time: Callable[[Union[Row, EventAsRow]], Any]
...
class EventProcessor:
    ...
    def humanify(self, rows: Union[Generator[EventAsRow, None, None], Sequence[Row], Result]) -> list[dict[str, str]]: ...

def _humanify(rows: Union[Generator[EventAsRow, None, None], Sequence[Row], Result], ent_reg: er.EntityRegistry, logbook_run: LogbookRun, context_augmenter: ContextAugmenter) -> Generator[dict[str, Any], None, None]: ...
...
class ContextLookup:
    ...
    def memorize(self, row: Union[Row, EventAsRow]) -> Union[str, None]: ...
    def clear(self) -> None: ...
    def get(self, context_id: str) -> Union[Row, EventAsRow, None]: ...
...
class ContextAugmenter:
    ...
    def _get_context_row(self, context_id: Union[str, None], row: Union[Row, EventAsRow]) -> Union[Row, EventAsRow, None]: ...
