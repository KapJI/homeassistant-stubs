...
def statement_for_request(start_day: dt, end_day: dt, event_types: tuple[str, ...], entity_ids: Union[list[str], None] = ..., device_ids: Union[list[str], None] = ..., filters: Union[Filters, None] = ..., context_id: Union[str, None] = ...) -> StatementLambdaElement: ...
