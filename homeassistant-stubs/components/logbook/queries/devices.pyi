...
def _select_device_id_context_ids_sub_query(start_day: dt, end_day: dt, event_types: tuple[str, ...], json_quoted_device_ids: list[str]) -> CompoundSelect: ...
def _apply_devices_context_union(query: Query, start_day: dt, end_day: dt, event_types: tuple[str, ...], json_quoted_device_ids: list[str]) -> CompoundSelect: ...
def devices_stmt(start_day: dt, end_day: dt, event_types: tuple[str, ...], json_quoted_device_ids: list[str]) -> Select: ...
def apply_event_device_id_matchers(json_quoted_device_ids: Iterable[str]) -> ClauseList: ...
