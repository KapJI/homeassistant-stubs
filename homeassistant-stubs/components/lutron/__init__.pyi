...
def _setup_output(hass: HomeAssistant, entry_data: LutronData, output: Output, area_name: str, entity_registry: er.EntityRegistry, device_registry: dr.DeviceRegistry, config_entry_id: str) -> None: ...
def _setup_keypad(hass: HomeAssistant, entry_data: LutronData, keypad: Keypad, area_name: str, entity_registry: er.EntityRegistry, device_registry: dr.DeviceRegistry, config_entry_id: str) -> None: ...
...
def _async_check_device_identifiers(hass: HomeAssistant, device_registry: dr.DeviceRegistry, uuid: str, legacy_uuid: str, controller_guid: str, config_entry_id: str) -> None: ...
def _async_check_keypad_identifiers(hass: HomeAssistant, device_registry: dr.DeviceRegistry, keypad_id: int, uuid: str, legacy_uuid: str, controller_guid: str, config_entry_id: str) -> None: ...
