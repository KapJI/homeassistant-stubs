from .const import ATTR_ACCOUNT_NAME as ATTR_ACCOUNT_NAME, ATTR_ATTRIBUTION_DOMAINS as ATTR_ATTRIBUTION_DOMAINS, ATTR_AVATAR as ATTR_AVATAR, ATTR_AVATAR_MIME_TYPE as ATTR_AVATAR_MIME_TYPE, ATTR_BOT as ATTR_BOT, ATTR_CONTENT_WARNING as ATTR_CONTENT_WARNING, ATTR_DELETE_AVATAR as ATTR_DELETE_AVATAR, ATTR_DELETE_HEADER as ATTR_DELETE_HEADER, ATTR_DISCOVERABLE as ATTR_DISCOVERABLE, ATTR_DISPLAY_NAME as ATTR_DISPLAY_NAME, ATTR_DURATION as ATTR_DURATION, ATTR_FIELDS as ATTR_FIELDS, ATTR_HEADER as ATTR_HEADER, ATTR_HEADER_MIME_TYPE as ATTR_HEADER_MIME_TYPE, ATTR_HIDE_NOTIFICATIONS as ATTR_HIDE_NOTIFICATIONS, ATTR_IDEMPOTENCY_KEY as ATTR_IDEMPOTENCY_KEY, ATTR_IN_REPLY_TO as ATTR_IN_REPLY_TO, ATTR_LANGUAGE as ATTR_LANGUAGE, ATTR_MEDIA as ATTR_MEDIA, ATTR_MEDIA_DESCRIPTION as ATTR_MEDIA_DESCRIPTION, ATTR_MEDIA_WARNING as ATTR_MEDIA_WARNING, ATTR_NOTE as ATTR_NOTE, ATTR_QUOTED_STATUS as ATTR_QUOTED_STATUS, ATTR_QUOTE_APPROVAL_POLICY as ATTR_QUOTE_APPROVAL_POLICY, ATTR_STATUS as ATTR_STATUS, ATTR_VALUE as ATTR_VALUE, ATTR_VISIBILITY as ATTR_VISIBILITY, DOMAIN as DOMAIN, LOGGER as LOGGER
...
from homeassistant.const import ATTR_CONFIG_ENTRY_ID as ATTR_CONFIG_ENTRY_ID, ATTR_LOCKED as ATTR_LOCKED, ATTR_NAME as ATTR_NAME
...
from mastodon.Mastodon import Account as Account, MediaAttachment as MediaAttachment, ScheduledStatus as ScheduledStatus, Status as Status
...
def _post(hass: HomeAssistant, client: Mastodon, **kwargs: Any) -> Status | ScheduledStatus: ...
