...
class MatterEntityInfo:
    ...
    def __mypy-replace(*, endpoint, platform, attributes_to_watch, entity_description, entity_class) -> None: ...
...
class MatterDiscoverySchema:
    ...
    def __mypy-replace(*, platform, entity_description, entity_class, required_attributes, device_type, not_device_type, vendor_id, product_name, endpoint_id, absent_attributes, optional_attributes, allow_multi) -> None: ...
