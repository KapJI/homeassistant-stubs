...
class MediaPlayerEntity(Entity):
    ...
    async def async_get_media_image(self) -> tuple[Union[bytes, None], Union[str, None]]: ...
    ...
    async def _async_fetch_image_from_cache(self, url: str) -> tuple[Union[bytes, None], Union[str, None]]: ...
    async def _async_fetch_image(self, url: str) -> tuple[Union[bytes, None], Union[str, None]]: ...
