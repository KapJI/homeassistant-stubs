...
class BrowseMedia:
    ...
    def __init__(self, *, media_class: str, media_content_id: str, media_content_type: str, title: str, can_play: bool, can_expand: bool, children: Union[Sequence[BrowseMedia], None] = ..., children_media_class: Union[str, None] = ..., thumbnail: Union[str, None] = ..., not_shown: int = ...) -> None: ...
