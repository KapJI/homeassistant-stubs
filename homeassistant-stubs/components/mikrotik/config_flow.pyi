...
from .coordinator import MikrotikConfigEntry as MikrotikConfigEntry, get_api as get_api
...
class MikrotikFlowHandler(ConfigFlow, domain=DOMAIN):
    ...
    @callback
    @override
    def async_get_options_flow(config_entry: MikrotikConfigEntry) -> MikrotikOptionsFlowHandler: ...
    @override
