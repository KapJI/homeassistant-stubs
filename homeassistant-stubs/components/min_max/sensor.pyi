...
def calc_min(sensor_values: list[tuple[str, Any]]) -> tuple[Union[str, None], Union[float, None]]: ...
def calc_max(sensor_values: list[tuple[str, Any]]) -> tuple[Union[str, None], Union[float, None]]: ...
def calc_mean(sensor_values: list[tuple[str, Any]], round_digits: int) -> Union[float, None]: ...
def calc_median(sensor_values: list[tuple[str, Any]], round_digits: int) -> Union[float, None]: ...
def calc_range(sensor_values: list[tuple[str, Any]], round_digits: int) -> Union[float, None]: ...
def calc_sum(sensor_values: list[tuple[str, Any]], round_digits: int) -> Union[float, None]: ...
...
class MinMaxSensor(SensorEntity):
    ...
    states: Incomplete
    def __init__(self, entity_ids: list[str], name: Union[str, None], sensor_type: str, round_digits: int, unique_id: Union[str, None]) -> None: ...
