...
class ModbusThermostat(ModbusStructEntity, RestoreEntity, ClimateEntity):
    ...
    _current_temp_scale: Incomplete
    _current_temp_offset: Incomplete
    _target_temp_scale: Incomplete
    _target_temp_offset: Incomplete
