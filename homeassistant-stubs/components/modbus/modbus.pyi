...
from homeassistant.helpers.event import Event as Event, async_call_later as async_call_later
...
async def async_modbus_setup(hass: HomeAssistant, config: ConfigType, service_write_register_schema: vol.Schema, service_write_coil_schema: vol.Schema, service_stop_start_schema: vol.Schema) -> bool: ...
...
class ModbusHub:
    ...
    def _pymodbus_call(self, unit: int, address: int, value: Union[int, list[int]], use_call: str) -> ModbusResponse: ...
