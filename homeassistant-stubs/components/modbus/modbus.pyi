...
class ModbusHub:
    ...
    async def low_level_pb_call(self, slave: int | None, address: int, value: int | list[int], use_call: str) -> ModbusResponse | None: ...
