from .const import CONF_CURRENT_TEMP_OFFSET as CONF_CURRENT_TEMP_OFFSET, CONF_CURRENT_TEMP_SCALE as CONF_CURRENT_TEMP_SCALE, CONF_DATA_TYPE as CONF_DATA_TYPE, CONF_FAN_MODE_VALUES as CONF_FAN_MODE_VALUES, CONF_SCALE as CONF_SCALE, CONF_SLAVE_COUNT as CONF_SLAVE_COUNT, CONF_SWAP as CONF_SWAP, CONF_SWAP_BYTE as CONF_SWAP_BYTE, CONF_SWAP_WORD as CONF_SWAP_WORD, CONF_SWAP_WORD_BYTE as CONF_SWAP_WORD_BYTE, CONF_SWING_MODE_VALUES as CONF_SWING_MODE_VALUES, CONF_TARGET_TEMP_OFFSET as CONF_TARGET_TEMP_OFFSET, CONF_TARGET_TEMP_SCALE as CONF_TARGET_TEMP_SCALE, CONF_VIRTUAL_COUNT as CONF_VIRTUAL_COUNT, DEFAULT_HUB as DEFAULT_HUB, DEFAULT_OFFSET as DEFAULT_OFFSET, DEFAULT_SCALE as DEFAULT_SCALE, DEFAULT_SCAN_INTERVAL as DEFAULT_SCAN_INTERVAL, DOMAIN as DOMAIN, DataType as DataType, PLATFORMS as PLATFORMS, SERIAL as SERIAL
from _typeshed import Incomplete
from homeassistant.components.climate import HVACMode as HVACMode
from homeassistant.const import CONF_ADDRESS as CONF_ADDRESS, CONF_COUNT as CONF_COUNT, CONF_HOST as CONF_HOST, CONF_NAME as CONF_NAME, CONF_OFFSET as CONF_OFFSET, CONF_PORT as CONF_PORT, CONF_SCAN_INTERVAL as CONF_SCAN_INTERVAL, CONF_STRUCTURE as CONF_STRUCTURE, CONF_TIMEOUT as CONF_TIMEOUT, CONF_TYPE as CONF_TYPE
