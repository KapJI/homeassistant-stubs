...
def publish(hass: HomeAssistant, topic: str, payload: PublishPayloadType, qos: int = 0, retain: bool = False, encoding: str | None = ..., *, message_expiry_interval: int | None = None) -> None: ...
async def async_publish(hass: HomeAssistant, topic: str, payload: PublishPayloadType, qos: int = 0, retain: bool = False, encoding: str | None = ..., *, message_expiry_interval: int | None = None) -> None: ...
@callback
...
class MQTT:
    ...
    _mqtt_data: MqttData
    _supports_subscription_identifiers: bool
    hass: Incomplete
    loop: Incomplete
    ...
    async def async_publish(self, topic: str, payload: PublishPayloadType, qos: int, retain: bool, *, message_expiry_interval: int | None = None) -> None: ...
    ...
    @callback
    def _async_mqtt_on_connect(self, _mqttc: mqtt.Client, _userdata: None, _connect_flags: mqtt.ConnectFlags, reason_code: mqtt.ReasonCode, properties: mqtt.Properties | None = None) -> None: ...
    @callback
    def _async_queue_resubscribe(self) -> None: ...
    def _matching_subscriptions(self, topic: str, identifiers: tuple[int, ...] | None) -> list[Subscription]: ...
    @callback
