...
from .const import CONF_ENCODING as CONF_ENCODING, CONF_QOS as CONF_QOS, CONF_RETAIN as CONF_RETAIN, PAYLOAD_NONE as PAYLOAD_NONE
...
class MqttClimate(MqttEntity, ClimateEntity):
    ...
    async def _set_temperature(self, temp: Union[float, None], cmnd_topic: str, cmnd_template: str, state_topic: str, attr: str) -> None: ...
