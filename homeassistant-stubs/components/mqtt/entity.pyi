...
from .util import async_cleanup_device_registry as async_cleanup_device_registry, learn_more_url as learn_more_url, mqtt_config_entry_enabled as mqtt_config_entry_enabled
from _typeshed import Incomplete
from abc import ABC, abstractmethod
from collections.abc import Callable as Callable, Coroutine
from homeassistant.config_entries import ConfigEntry as ConfigEntry
from homeassistant.const import ATTR_CONFIGURATION_URL as ATTR_CONFIGURATION_URL, ATTR_HW_VERSION as ATTR_HW_VERSION, ATTR_MANUFACTURER as ATTR_MANUFACTURER, ATTR_MODEL as ATTR_MODEL, ATTR_MODEL_ID as ATTR_MODEL_ID, ATTR_NAME as ATTR_NAME, ATTR_SERIAL_NUMBER as ATTR_SERIAL_NUMBER, ATTR_SUGGESTED_AREA as ATTR_SUGGESTED_AREA, ATTR_SW_VERSION as ATTR_SW_VERSION, CONF_DEVICE as CONF_DEVICE, CONF_ENTITY_CATEGORY as CONF_ENTITY_CATEGORY, CONF_ICON as CONF_ICON, CONF_MODEL as CONF_MODEL, CONF_MODEL_ID as CONF_MODEL_ID, CONF_NAME as CONF_NAME, CONF_UNIQUE_ID as CONF_UNIQUE_ID, CONF_UNIT_OF_MEASUREMENT as CONF_UNIT_OF_MEASUREMENT, CONF_VALUE_TEMPLATE as CONF_VALUE_TEMPLATE, EntityCapabilityAttribute as EntityCapabilityAttribute, EntityStateAttribute as EntityStateAttribute
...
def _via_device_identifier(specifications: dict[str, Any] | None) -> tuple[str, str] | None: ...
@callback
def ensure_via_device_exists(hass: HomeAssistant, specifications: dict[str, Any] | None, config_entry: ConfigEntry) -> None: ...
@callback
def _resolve_via_device_id(hass: HomeAssistant, specifications: dict[str, Any] | None, config_entry: ConfigEntry) -> str | None: ...
...
class MqttEntity(MqttAttributesMixin, MqttAvailabilityMixin, MqttDiscoveryUpdateMixin, MqttEntityDeviceInfo, metaclass=abc.ABCMeta):
    ...
    _attr_entity_registry_visible_default: Incomplete
...
@callback
def async_removed_from_device(event: Event[EventDeviceRegistryUpdatedData]) -> bool: ...
