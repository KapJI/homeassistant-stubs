...
async def async_setup_entity_json(hass: HomeAssistant, config: ConfigType, async_add_entities: AddEntitiesCallback, config_entry: ConfigEntry, discovery_data: Union[DiscoveryInfoType, None]) -> None: ...

class MqttLightJson(MqttEntity, LightEntity, RestoreEntity):
    _entity_id_format: Incomplete
    _attributes_extra_blocked: Incomplete
    _flash_times: dict[str, Union[int, None]]
    _topic: dict[str, Union[str, None]]
    _optimistic: bool
    _fixed_color_mode: Incomplete
    ...
    def _supports_color_mode(self, color_mode: Union[ColorMode, str]) -> bool: ...
