...
async def _async_setup_tag(hass: HomeAssistant, config: ConfigType, config_entry: ConfigEntry, discovery_data: dict) -> None: ...
...
class MQTTTagScanner(MqttDiscoveryDeviceUpdate):
    ...
    def __init__(self, hass: HomeAssistant, config: ConfigType, device_id: Union[str, None], discovery_data: DiscoveryInfoType, config_entry: ConfigEntry) -> None: ...
