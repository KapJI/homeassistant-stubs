...
LIBRARY_MASS_MEDIA_TYPE_MAP: Incomplete
MUSIC_MASS_MEDIA_TYPES: Incomplete
MEDIA_CLASS_MASS_MEDIA_TYPE_MAP: Incomplete
SEARCHABLE_MASS_MEDIA_TYPES: Incomplete
ARTIST_MASS_MEDIA_TYPES: Incomplete
...
async def _search_within_playlist(mass: MusicAssistantClient, playlist_uri: str, search_query: str, limit: int) -> SearchMedia: ...
async def _search_within_artist(mass: MusicAssistantClient, artist_uri: str, search_query: str, limit: int, media_types: list[MASSMediaType]) -> SearchResults: ...
