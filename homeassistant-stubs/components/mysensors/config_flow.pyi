...
class MySensorsConfigFlowHandler(ConfigFlow, domain=DOMAIN):
    ...
    async def async_step_gw_tcp(self, user_input: dict[str, Any] | None = None) -> ConfigFlowResult: ...
    def _check_topic_exists(self, topic: str) -> bool: ...
    async def async_step_gw_mqtt(self, user_input: dict[str, Any] | None = None) -> ConfigFlowResult: ...
