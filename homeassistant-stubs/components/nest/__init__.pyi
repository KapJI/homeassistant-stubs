...
from homeassistant.exceptions import ConfigEntryAuthFailed as ConfigEntryAuthFailed, ConfigEntryNotReady as ConfigEntryNotReady, HomeAssistantError as HomeAssistantError, OAuth2TokenRequestError as OAuth2TokenRequestError, OAuth2TokenRequestReauthError as OAuth2TokenRequestReauthError, Unauthorized as Unauthorized
...
class SignalUpdateCallback:
    ...
    _device_listeners: list[DevicesAddedListener]
    _known_devices: dict[str, Device]
