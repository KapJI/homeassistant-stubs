...
class NetatmoSource(MediaSource):
    ...
    def _build_item_response(self, source: str, camera_id: str, event_id: int | None = ...) -> BrowseMediaSource: ...

def remove_html_tags(text: str) -> str: ...
def async_parse_identifier(item: MediaSourceItem) -> tuple[str, str, int | None]: ...
