...
async def async_get_service(hass: HomeAssistant, config: ConfigType, discovery_info: DiscoveryInfoType | None = ...) -> NFAndroidTVNotificationService | None: ...
...
class NFAndroidTVNotificationService(BaseNotificationService):
    ...
    def load_file(self, url: str | None = ..., local_path: str | None = ..., username: str | None = ..., password: str | None = ..., auth: str | None = ...) -> BufferedReader | bytes | None: ...
