...
class LegacyNotifyPlatform(Protocol):
    async def async_get_service(self, hass: HomeAssistant, config: ConfigType, discovery_info: Union[DiscoveryInfoType, None] = ...) -> Union[BaseNotificationService, None]: ...
    def get_service(self, hass: HomeAssistant, config: ConfigType, discovery_info: Union[DiscoveryInfoType, None] = ...) -> Union[BaseNotificationService, None]: ...
