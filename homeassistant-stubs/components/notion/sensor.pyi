from .const import SENSOR_MOLD as SENSOR_MOLD, SENSOR_TEMPERATURE as SENSOR_TEMPERATURE
...
async def async_setup_entry(hass: HomeAssistant, entry: NotionConfigEntry, async_add_entities: AddConfigEntryEntitiesCallback) -> None: ...
