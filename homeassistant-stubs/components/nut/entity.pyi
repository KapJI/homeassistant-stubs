...
from .coordinator import NutCoordinator as NutCoordinator
...
class NUTBaseEntity(CoordinatorEntity[NutCoordinator]):
    ...
    def __init__(self, coordinator: NutCoordinator, entity_description: EntityDescription, data: PyNUTData, unique_id: str) -> None: ...
