...
from .coordinator import OneDriveConfigEntry as OneDriveConfigEntry, OneDriveForBusinessUpdateCoordinator as OneDriveForBusinessUpdateCoordinator
...
class OneDriveDriveStateSensor(CoordinatorEntity[OneDriveForBusinessUpdateCoordinator], SensorEntity):
    entity_description: OneDriveForBusinessSensorEntityDescription
    _attr_has_entity_name: bool
    _attr_translation_key: Incomplete
    _attr_unique_id: Incomplete
    _attr_device_info: Incomplete
    def __init__(self, coordinator: OneDriveForBusinessUpdateCoordinator, description: OneDriveForBusinessSensorEntityDescription) -> None: ...
    @property
