from .const import CONF_WEB_SEARCH as CONF_WEB_SEARCH, LOGGER as LOGGER
...
async def async_migrate_entry(hass: HomeAssistant, entry: OpenRouterConfigEntry) -> bool: ...
