...
from .const import CONF_CHAT_MODEL as CONF_CHAT_MODEL, CONF_CODE_INTERPRETER as CONF_CODE_INTERPRETER, CONF_IMAGE_MODEL as CONF_IMAGE_MODEL, CONF_MAX_TOKENS as CONF_MAX_TOKENS, CONF_PRO_MODE as CONF_PRO_MODE, CONF_REASONING_EFFORT as CONF_REASONING_EFFORT, CONF_REASONING_SUMMARY as CONF_REASONING_SUMMARY, CONF_SERVICE_TIER as CONF_SERVICE_TIER, CONF_STORE_RESPONSES as CONF_STORE_RESPONSES, CONF_TEMPERATURE as CONF_TEMPERATURE, CONF_TOP_P as CONF_TOP_P, CONF_VERBOSITY as CONF_VERBOSITY, CONF_WEB_SEARCH as CONF_WEB_SEARCH, CONF_WEB_SEARCH_CITY as CONF_WEB_SEARCH_CITY, CONF_WEB_SEARCH_CONTEXT_SIZE as CONF_WEB_SEARCH_CONTEXT_SIZE, CONF_WEB_SEARCH_COUNTRY as CONF_WEB_SEARCH_COUNTRY, CONF_WEB_SEARCH_INLINE_CITATIONS as CONF_WEB_SEARCH_INLINE_CITATIONS, CONF_WEB_SEARCH_REGION as CONF_WEB_SEARCH_REGION, CONF_WEB_SEARCH_TIMEZONE as CONF_WEB_SEARCH_TIMEZONE, CONF_WEB_SEARCH_USER_LOCATION as CONF_WEB_SEARCH_USER_LOCATION, DOMAIN as DOMAIN, LOGGER as LOGGER, RECOMMENDED_CHAT_MODEL as RECOMMENDED_CHAT_MODEL, RECOMMENDED_IMAGE_MODEL as RECOMMENDED_IMAGE_MODEL, RECOMMENDED_MAX_TOKENS as RECOMMENDED_MAX_TOKENS, RECOMMENDED_PRO_MODE as RECOMMENDED_PRO_MODE, RECOMMENDED_REASONING_EFFORT as RECOMMENDED_REASONING_EFFORT, RECOMMENDED_REASONING_SUMMARY as RECOMMENDED_REASONING_SUMMARY, RECOMMENDED_SERVICE_TIER as RECOMMENDED_SERVICE_TIER, RECOMMENDED_STORE_RESPONSES as RECOMMENDED_STORE_RESPONSES, RECOMMENDED_STT_MODEL as RECOMMENDED_STT_MODEL, RECOMMENDED_TEMPERATURE as RECOMMENDED_TEMPERATURE, RECOMMENDED_TOP_P as RECOMMENDED_TOP_P, RECOMMENDED_VERBOSITY as RECOMMENDED_VERBOSITY, RECOMMENDED_WEB_SEARCH_CONTEXT_SIZE as RECOMMENDED_WEB_SEARCH_CONTEXT_SIZE, RECOMMENDED_WEB_SEARCH_INLINE_CITATIONS as RECOMMENDED_WEB_SEARCH_INLINE_CITATIONS, UNSUPPORTED_EXTENDED_CACHE_RETENTION_MODELS as UNSUPPORTED_EXTENDED_CACHE_RETENTION_MODELS
...
class OpenAIBaseLLMEntity(Entity):
    ...
    async def _async_handle_chat_log(self, chat_log: conversation.ChatLog, structure_name: str | None = None, structure: vol.Schema | None = None, force_image: bool = False, max_iterations: int = ...) -> None: ...
