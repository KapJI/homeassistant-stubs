...
class OverkizConfigFlow(config_entry_oauth2_flow.AbstractOAuth2FlowHandler, domain=DOMAIN):
    ...
    def _async_finish_validated_entry(self, user_input: dict[str, Any], title: str) -> ConfigFlowResult: ...
    @override
    ...
    async def _process_discovery(self, gateway_id: str, *, updates: dict[str, Any] | None = None) -> ConfigFlowResult: ...
    def _init_flow_from_entry(self, entry_data: Mapping[str, Any], gateway_id: str) -> None: ...
