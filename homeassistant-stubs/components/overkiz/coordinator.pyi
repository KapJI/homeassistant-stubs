...
class OverkizDataUpdateCoordinator(DataUpdateCoordinator[dict[str, Device]]):
    ...
    def __init__(self, hass: HomeAssistant, logger: logging.Logger, *, name: str, client: OverkizClient, devices: list[Device], places: Place | None, update_interval: timedelta | None = ..., config_entry_id: str) -> None: ...
