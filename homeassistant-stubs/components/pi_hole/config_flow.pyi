from .const import CONF_STATISTICS_ONLY as CONF_STATISTICS_ONLY, DEFAULT_LOCATION as DEFAULT_LOCATION, DEFAULT_NAME as DEFAULT_NAME, DEFAULT_SSL as DEFAULT_SSL, DEFAULT_VERIFY_SSL as DEFAULT_VERIFY_SSL, DOMAIN as DOMAIN
...
class PiHoleFlowHandler(config_entries.ConfigFlow):
    ...
    async def _async_try_connect_legacy(self, host: str, location: str, tls: bool, verify_tls: bool) -> None: ...
