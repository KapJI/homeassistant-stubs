...
class PiHoleUpdateEntityDescription(UpdateEntityDescription):
    ...
    def __init__(self, key, device_class, entity_category, entity_registry_enabled_default, entity_registry_visible_default, force_update, icon, name, unit_of_measurement, installed_version, latest_version, release_base_url, title) -> None: ...
