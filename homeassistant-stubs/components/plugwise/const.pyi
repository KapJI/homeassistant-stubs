...
type NumberType = Literal['boiler_temperature', 'dhw_temperature', 'temperature_offset']
type SelectType = Literal['dhw_mode', 'select_dhw_mode', 'select_gateway_mode', 'select_regulation_mode', 'select_schedule', 'select_zone_profile']
