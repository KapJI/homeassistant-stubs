...
from tesla_powerwall import OperationMode as OperationMode, Powerwall
...
async def _login_and_fetch_base_info(power_wall: Powerwall, host: str, password: str | None, use_auth_cookie: bool, fallback_din: str | None = None) -> PowerwallBaseInfo: ...
async def _call_base_info(power_wall: Powerwall, host: str, fallback_din: str | None = None) -> PowerwallBaseInfo: ...
...
async def _fetch_powerwall_data(power_wall: Powerwall, restricted: bool = False) -> PowerwallData: ...
@callback
