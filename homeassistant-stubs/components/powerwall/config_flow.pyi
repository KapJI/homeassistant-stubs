...
async def _login_and_fetch_site_info(power_wall: Powerwall, password: str) -> tuple[str | None, str | None]: ...
async def _powerwall_is_reachable(ip_address: str, password: str) -> bool: ...
async def validate_input(hass: HomeAssistant, data: dict[str, str]) -> dict[str, str | None]: ...
...
class PowerwallConfigFlow(ConfigFlow, domain=DOMAIN):
    ...
    async def _async_try_connect(self, user_input: dict[str, Any]) -> tuple[dict[str, str] | None, dict[str, str | None] | None, dict[str, str]]: ...
