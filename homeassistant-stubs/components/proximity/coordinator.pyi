...
from homeassistant.components.zone import ENTITY_ID_HOME as ENTITY_ID_HOME, ZoneEntityStateAttribute as ZoneEntityStateAttribute
from homeassistant.config_entries import ConfigEntry as ConfigEntry
from homeassistant.const import ATTR_NAME as ATTR_NAME, CONF_UNIT_OF_MEASUREMENT as CONF_UNIT_OF_MEASUREMENT, CONF_ZONE as CONF_ZONE, EntityStateAttribute as EntityStateAttribute, STATE_HOME as STATE_HOME
...
class ProximityDataUpdateCoordinator(DataUpdateCoordinator[ProximityData]):
    ...
    def _calc_distance_to_zone(self, zone: State, tracked_entity_state: State, latitude: float | None, longitude: float | None) -> int | None: ...
    def _calc_direction_of_travel(self, zone: State, tracked_entity_state: State, old_latitude: float | None, old_longitude: float | None, new_latitude: float | None, new_longitude: float | None) -> str | None: ...
    @override
