...
class RainMachineSelectDescription(SelectEntityDescription, RainMachineEntityDescription, RainMachineEntityDescriptionMixinDataKey):
    ...
    def __mypy-replace(*, data_key, api_category, key, device_class, entity_category, entity_registry_enabled_default, entity_registry_visible_default, force_update, icon, has_entity_name, name, translation_key, unit_of_measurement, options) -> None: ...
...
class FreezeProtectionSelectOption:
    ...
    def __mypy-replace(*, api_value, imperial_label, metric_label) -> None: ...
...
class FreezeProtectionTemperatureMixin:
    ...
    def __mypy-replace(*, extended_options) -> None: ...
...
class FreezeProtectionSelectDescription(RainMachineSelectDescription, FreezeProtectionTemperatureMixin):
    ...
    def __mypy-replace(*, extended_options, data_key, api_category, key, device_class, entity_category, entity_registry_enabled_default, entity_registry_visible_default, force_update, icon, has_entity_name, name, translation_key, unit_of_measurement, options) -> None: ...
