...
async def async_setup_entry(hass: HomeAssistant, entry: RecollectWasteConfigEntry, async_add_entities: AddConfigEntryEntitiesCallback) -> None: ...
...
class ReCollectWasteSensor(ReCollectWasteEntity, SensorEntity):
    ...
    def __init__(self, coordinator: ReCollectWasteDataUpdateCoordinator, entry: RecollectWasteConfigEntry, description: SensorEntityDescription) -> None: ...
