...
from .tasks import AdjustStatisticsTask as AdjustStatisticsTask, ClearStatisticsTask as ClearStatisticsTask, CommitTask as CommitTask, DatabaseLockTask as DatabaseLockTask, EventTask as EventTask, ExternalStatisticsTask as ExternalStatisticsTask, KeepAliveTask as KeepAliveTask, PerodicCleanupTask as PerodicCleanupTask, PurgeTask as PurgeTask, RecorderTask as RecorderTask, StatisticsTask as StatisticsTask, StopTask as StopTask, SynchronizeTask as SynchronizeTask, UpdateStatisticsMetadataTask as UpdateStatisticsMetadataTask, WaitTask as WaitTask
...
class Recorder(threading.Thread):
    ...
    def async_external_statistics(self, metadata: StatisticMetaData, stats: Iterable[StatisticData]) -> None: ...
