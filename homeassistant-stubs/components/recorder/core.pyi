...
class Recorder(threading.Thread):
    ...
    @callback
    def async_update_statistics_metadata(self, statistic_id: str, *, new_statistic_id: str | UndefinedType = ..., new_unit_class: str | UndefinedType | None = ..., new_unit_of_measurement: str | UndefinedType | None = ..., on_done: Callable[[], None] | None = None) -> None: ...
    @callback
