...
from .const import DB_WORKER_PREFIX as DB_WORKER_PREFIX, DOMAIN as DOMAIN, KEEPALIVE_TIME as KEEPALIVE_TIME, MAX_QUEUE_BACKLOG as MAX_QUEUE_BACKLOG, MYSQLDB_URL_PREFIX as MYSQLDB_URL_PREFIX, SQLITE_URL_PREFIX as SQLITE_URL_PREFIX, SupportedDialect as SupportedDialect
...
class Recorder(threading.Thread):
    ...
    def async_import_statistics(self, metadata: StatisticMetaData, stats: Iterable[StatisticData]) -> None: ...
