from .const import ALL_DOMAIN_EXCLUDE_ATTRS as ALL_DOMAIN_EXCLUDE_ATTRS
...
class StateAttributes(Base):
    ...
    @staticmethod
    def shared_attrs_bytes_from_event(event: Event, exclude_attrs_by_domain: dict[str, set[str]]) -> bytes: ...
    @staticmethod
