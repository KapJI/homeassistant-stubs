...
from .models import LazyState as LazyState, RecorderRuns as RecorderRuns, StateAttributes as StateAttributes, States as States, process_datetime_to_timestamp as process_datetime_to_timestamp, process_timestamp as process_timestamp, process_timestamp_to_utc_isoformat as process_timestamp_to_utc_isoformat, row_to_compressed_state as row_to_compressed_state
from .util import execute_stmt as execute_stmt, session_scope as session_scope
...
from sqlalchemy.sql.selectable import Select as Select, Subquery as Subquery
...
def stmt_and_join_attributes(schema_version: int, no_attributes: bool, include_last_changed: bool = ...) -> tuple[Select, bool]: ...
...
def _significant_states_stmt(schema_version: int, start_time: datetime, end_time: Union[datetime, None], entity_ids: Union[list[str], None], filters: Union[Filters, None], significant_changes_only: bool, no_attributes: bool) -> Select: ...
...
def _state_changed_during_period_stmt(schema_version: int, start_time: datetime, end_time: Union[datetime, None], entity_id: Union[str, None], no_attributes: bool, descending: bool, limit: Union[int, None]) -> Select: ...
...
def _get_last_state_changes_stmt(schema_version: int, number_of_states: int, entity_id: Union[str, None]) -> Select: ...
...
def _get_states_for_entites_stmt(schema_version: int, run_start: datetime, utc_point_in_time: datetime, entity_ids: list[str], no_attributes: bool) -> Select: ...
def _generate_most_recent_states_by_date(run_start: datetime, utc_point_in_time: datetime) -> Subquery: ...
def _get_states_for_all_stmt(schema_version: int, run_start: datetime, utc_point_in_time: datetime, filters: Union[Filters, None], no_attributes: bool) -> Select: ...
...
def _get_single_entity_states_stmt(schema_version: int, utc_point_in_time: datetime, entity_id: str, no_attributes: bool = ...) -> Select: ...
