...
def non_live_data_migration_needed(instance: Recorder, session_maker: Callable[[], Session], schema_version: int) -> bool: ...
...
NON_LIVE_DATA_MIGRATORS: Incomplete
LIVE_DATA_MIGRATORS: Incomplete
