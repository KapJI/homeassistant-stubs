...
from .tasks import PostSchemaMigrationTask as PostSchemaMigrationTask
...
def post_schema_migration(session: Session, old_version: int, new_version: int) -> None: ...
def _wipe_old_string_time_columns(session: Session) -> None: ...
def _migrate_columns_to_timestamp(hass: HomeAssistant, session: Session, engine: Engine) -> None: ...
