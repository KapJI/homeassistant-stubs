...
def _select_state_and_attributes_ids_to_purge(session: Session, purge_before: datetime, event_ids: list[int]) -> tuple[set[int], set[int]]: ...
def _select_unused_attributes_ids(session: Session, attributes_ids: set[int]) -> set[int]: ...
