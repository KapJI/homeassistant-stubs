...
from .const import DATA_INSTANCE as DATA_INSTANCE, DOMAIN as DOMAIN
...
def get_metadata_with_session(hass: HomeAssistant, session: scoped_session, *, statistic_ids: Union[Iterable[str], None] = ..., statistic_type: Union[Literal[mean], Literal[sum], None] = ..., statistic_source: Union[str, None] = ...) -> dict[str, tuple[int, StatisticMetaData]]: ...
def get_metadata(hass: HomeAssistant, *, statistic_ids: Union[Iterable[str], None] = ..., statistic_type: Union[Literal[mean], Literal[sum], None] = ..., statistic_source: Union[str, None] = ...) -> dict[str, tuple[int, StatisticMetaData]]: ...
...
def statistics_during_period(hass: HomeAssistant, start_time: datetime, end_time: Union[datetime, None] = ..., statistic_ids: Union[list[str], None] = ..., period: Literal['5minute', day, hour, month] = ...) -> dict[str, list[dict[str, Any]]]: ...
