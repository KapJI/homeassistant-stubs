...
def _statistics_during_period_stmt(start_time: datetime, end_time: Union[datetime, None], metadata_ids: Union[list[int], None], table: type[Union[Statistics, StatisticsShortTerm]]) -> StatementLambdaElement: ...
