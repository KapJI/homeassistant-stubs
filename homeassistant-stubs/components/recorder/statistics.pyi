...
def _statistics_during_period_stmt(start_time: datetime, end_time: Union[datetime, None], statistic_ids: Union[list[str], None], metadata_ids: Union[list[int], None], table: type[Union[Statistics, StatisticsShortTerm]]) -> StatementLambdaElement: ...
...
def _get_last_statistics_stmt(metadata_id: int, number_of_stats: int, table: type[Union[Statistics, StatisticsShortTerm]]) -> StatementLambdaElement: ...
