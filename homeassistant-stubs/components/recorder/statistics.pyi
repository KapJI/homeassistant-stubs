...
from .util import execute as execute, execute_stmt as execute_stmt, retryable_database_job as retryable_database_job, session_scope as session_scope
...
def _compile_hourly_statistics_summary_mean_stmt(start_time: datetime, end_time: datetime) -> Select: ...
...
def _generate_get_metadata_stmt(statistic_ids: Union[list[str], tuple[str], None] = ..., statistic_type: Union[Literal['mean'], Literal['sum'], None] = ..., statistic_source: Union[str, None] = ...) -> Select: ...
...
def _statistics_during_period_stmt(start_time: datetime, end_time: Union[datetime, None], metadata_ids: Union[list[int], None]) -> Select: ...
def _statistics_during_period_stmt_short_term(start_time: datetime, end_time: Union[datetime, None], metadata_ids: Union[list[int], None]) -> Select: ...
...
def _get_last_statistics_stmt(metadata_id: int, number_of_stats: int) -> Select: ...
def _get_last_statistics_short_term_stmt(metadata_id: int, number_of_stats: int) -> Select: ...
...
def _latest_short_term_statistics_stmt(metadata_ids: list[int]) -> Select: ...
