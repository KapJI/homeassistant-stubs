...
def statistics_during_period(hass: HomeAssistant, start_time: datetime, end_time: Union[datetime, None] = ..., statistic_ids: Union[list[str], None] = ..., period: Literal['5minute', 'day', 'hour', 'month'] = ..., start_time_as_datetime: bool = ..., units: Union[dict[str, str], None] = ...) -> dict[str, list[dict[str, Any]]]: ...
...
def _validate_units(statistics_unit: Union[str, None], state_unit: Union[str, None]) -> None: ...
...
def adjust_statistics(instance: Recorder, statistic_id: str, start_time: datetime, sum_adjustment: float, display_unit: str) -> bool: ...
