...
def get_last_statistics(hass, number_of_stats, statistic_id: Any | None = ...): ...
def _sorted_statistics_to_dict(hass, stats, statistic_ids, meta_data): ...
