...
class ChangeStatisticsUnitTask(RecorderTask):
    ...
    def __mypy-replace(*, statistic_id, new_unit_of_measurement, old_unit_of_measurement) -> None: ...

class ClearStatisticsTask(RecorderTask):
    statistic_ids: list[str]
    def run(self, instance: Recorder) -> None: ...
    def __init__(self, statistic_ids) -> None: ...
    def __mypy-replace(*, statistic_ids) -> None: ...
...
class UpdateStatisticsMetadataTask(RecorderTask):
    ...
    def __mypy-replace(*, statistic_id, new_statistic_id, new_unit_of_measurement) -> None: ...
...
class UpdateStatesMetadataTask(RecorderTask):
    ...
    def __mypy-replace(*, entity_id, new_entity_id) -> None: ...
...
class PurgeTask(RecorderTask):
    ...
    def __mypy-replace(*, purge_before, repack, apply_filter) -> None: ...
...
class PurgeEntitiesTask(RecorderTask):
    ...
    def __mypy-replace(*, entity_filter, purge_before) -> None: ...
...
class StatisticsTask(RecorderTask):
    ...
    def __mypy-replace(*, start, fire_events) -> None: ...
...
class ImportStatisticsTask(RecorderTask):
    ...
    def __mypy-replace(*, metadata, statistics, table) -> None: ...
...
class AdjustStatisticsTask(RecorderTask):
    ...
    def __mypy-replace(*, statistic_id, start_time, sum_adjustment, adjustment_unit) -> None: ...
...
class DatabaseLockTask(RecorderTask):
    ...
    def __mypy-replace(*, database_locked, database_unlock, queue_overflow) -> None: ...
...
class AddRecorderPlatformTask(RecorderTask):
    ...
    def __mypy-replace(*, domain, platform) -> None: ...
...
class PostSchemaMigrationTask(RecorderTask):
    ...
    def __mypy-replace(*, old_version, new_version) -> None: ...
...
class RefreshEventTypesTask(RecorderTask):
    ...
    def __mypy-replace(*, event_types) -> None: ...
