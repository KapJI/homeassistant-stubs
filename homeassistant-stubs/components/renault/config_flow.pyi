...
class RenaultFlowHandler(config_entries.ConfigFlow, domain=DOMAIN):
    ...
    async def async_step_kamereon(self, user_input: dict[str, Any] | None = None) -> FlowResult: ...
    async def async_step_reauth(self, entry_data: Mapping[str, Any]) -> FlowResult: ...
    async def async_step_reauth_confirm(self, user_input: dict[str, Any] | None = None) -> FlowResult: ...
    def _show_reauth_confirm_form(self, errors: dict[str, Any] | None = None) -> FlowResult: ...
