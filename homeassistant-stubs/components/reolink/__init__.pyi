...
async def register_callbacks(host: ReolinkHost, device_coordinator: ReolinkDeviceCoordinator, hass: HomeAssistant) -> None: ...
...
async def async_remove_config_entry_device(hass: HomeAssistant, config_entry: ReolinkConfigEntry, device: dr.AnyDeviceEntry) -> bool: ...
