...
class IssueEntry:
    ...
    def __init__(self, active, breaks_in_ha_version, created, dismissed_version, domain, is_fixable, issue_id, learn_more_url, severity, translation_key, translation_placeholders) -> None: ...
...
class IssueRegistry:
    ...
    def async_get_or_create(self, domain: str, issue_id: str, *, breaks_in_ha_version: Union[str, None] = ..., is_fixable: bool, learn_more_url: Union[str, None] = ..., severity: IssueSeverity, translation_key: str, translation_placeholders: Union[dict[str, str], None] = ...) -> IssueEntry: ...
