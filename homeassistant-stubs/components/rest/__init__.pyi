...
def _rest_coordinator(hass: HomeAssistant, rest: RestData, resource_template: Union[template.Template, None], update_interval: timedelta) -> DataUpdateCoordinator[None]: ...
