...
from homeassistant.helpers.template_entity import TEMPLATE_ENTITY_BASE_SCHEMA as TEMPLATE_ENTITY_BASE_SCHEMA, TemplateEntity as TemplateEntity
...
class RestSwitch(TemplateEntity, SwitchEntity):
    ...
    def __init__(self, hass: HomeAssistant, config: ConfigType, unique_id: Union[str, None]) -> None: ...
    _attr_is_on: bool
