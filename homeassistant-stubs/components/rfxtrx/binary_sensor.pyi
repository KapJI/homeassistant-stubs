...
class RfxtrxBinarySensor(RfxtrxEntity, BinarySensorEntity):
    ...
    _cmd_on: Incomplete
    _cmd_off: Incomplete
    def __init__(self, device: rfxtrxmod.RFXtrxDevice, device_id: DeviceTuple, entity_description: BinarySensorEntityDescription, off_delay: float | None = ..., data_bits: int | None = ..., cmd_on: int | None = ..., cmd_off: int | None = ..., event: rfxtrxmod.RFXtrxEvent | None = ...) -> None: ...
