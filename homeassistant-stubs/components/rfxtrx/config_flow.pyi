...
def none_or_int(value: Union[str, None], base: int) -> Union[int, None]: ...
...
class OptionsFlow(config_entries.OptionsFlow):
    ...
    async def async_step_init(self, user_input: Union[dict[str, Any], None] = ...) -> data_entry_flow.FlowResult: ...
    async def async_step_prompt_options(self, user_input: Union[dict[str, Any], None] = ...) -> data_entry_flow.FlowResult: ...
    async def async_step_set_device_options(self, user_input: Union[dict[str, Any], None] = ...) -> data_entry_flow.FlowResult: ...
    ...
    def _get_device_event_code(self, entry_id: str) -> Union[str, None]: ...
    def _get_device_data(self, entry_id: str) -> DeviceData: ...
    def update_config_data(self, global_options: Union[dict[str, Any], None] = ..., devices: Union[dict[str, Any], None] = ...) -> None: ...

class ConfigFlow(config_entries.ConfigFlow):
    VERSION: int
    async def async_step_user(self, user_input: Union[dict[str, Any], None] = ...) -> data_entry_flow.FlowResult: ...
    async def async_step_setup_network(self, user_input: Union[dict[str, Any], None] = ...) -> data_entry_flow.FlowResult: ...
    async def async_step_setup_serial(self, user_input: Union[dict[str, Any], None] = ...) -> data_entry_flow.FlowResult: ...
    async def async_step_setup_serial_manual_path(self, user_input: Union[dict[str, Any], None] = ...) -> data_entry_flow.FlowResult: ...
    async def async_validate_rfx(self, host: Union[str, None] = ..., port: Union[int, None] = ..., device: Union[str, None] = ...) -> dict[str, Any]: ...
    @staticmethod
    def async_get_options_flow(config_entry: ConfigEntry) -> OptionsFlow: ...

def _test_transport(host: Union[str, None], port: Union[int, None], device: Union[str, None]) -> bool: ...
