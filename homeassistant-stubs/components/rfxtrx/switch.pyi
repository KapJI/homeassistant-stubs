...
class RfxtrxSwitch(RfxtrxCommandEntity, SwitchEntity):
    ...
    _cmd_on: Incomplete
    _cmd_off: Incomplete
    def __init__(self, device: rfxtrxmod.RFXtrxDevice, device_id: DeviceTuple, data_bits: Union[int, None] = ..., cmd_on: Union[int, None] = ..., cmd_off: Union[int, None] = ..., event: Union[rfxtrxmod.RFXtrxEvent, None] = ...) -> None: ...
