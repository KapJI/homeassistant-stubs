...
def build_setup_functions(hass: HomeAssistant, entry: RoborockConfigEntry, devices: list[RoborockDevice], user_data: UserData) -> list[Coroutine[Any, Any, RoborockDataUpdateCoordinator | RoborockDataUpdateCoordinatorA01 | None]]: ...
async def setup_coordinator(coordinator: RoborockDataUpdateCoordinator | RoborockDataUpdateCoordinatorA01) -> RoborockDataUpdateCoordinator | RoborockDataUpdateCoordinatorA01 | None: ...
