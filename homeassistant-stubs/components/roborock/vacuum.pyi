...
class RoborockVacuum(RoborockCoordinatedEntityV1, StateVacuumEntity):
    ...
    async def async_set_vacuum_zoned_cleaning(self, x1: int, y1: int, x2: int, y2: int, repeats: int) -> None: ...
    @override
