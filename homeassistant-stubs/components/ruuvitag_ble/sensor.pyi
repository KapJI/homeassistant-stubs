from . import RuuvitagBLEConfigEntry as RuuvitagBLEConfigEntry
...
async def async_setup_entry(hass: HomeAssistant, entry: RuuvitagBLEConfigEntry, async_add_entities: AddConfigEntryEntitiesCallback) -> None: ...
