...
class SamsungTVConfigFlow(config_entries.ConfigFlow):
    ...
    async def async_step_pairing(self, user_input: Union[dict[str, Any], None] = ...) -> data_entry_flow.FlowResult: ...
    async def async_step_encrypted_pairing(self, user_input: Union[dict[str, Any], None] = ...) -> data_entry_flow.FlowResult: ...
    ...
    async def async_step_reauth_confirm_encrypted(self, user_input: Union[dict[str, Any], None] = ...) -> data_entry_flow.FlowResult: ...
