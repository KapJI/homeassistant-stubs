from .const import CONF_ADDITIONAL as CONF_ADDITIONAL, CONF_AUTH as CONF_AUTH, CONF_ENCODING as CONF_ENCODING, CONF_INDEX as CONF_INDEX, CONF_SELECT as CONF_SELECT, DEFAULT_SCAN_INTERVAL as DEFAULT_SCAN_INTERVAL, DOMAIN as DOMAIN, PLATFORMS as PLATFORMS
...
async def async_remove_config_entry_device(hass: HomeAssistant, entry: ConfigEntry, device: dr.AnyDeviceEntry) -> bool: ...
