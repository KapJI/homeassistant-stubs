...
@contextmanager
def trace_script(hass: HomeAssistant, item_id: str, config: dict[str, Any] | None, blueprint_inputs: dict[str, Any] | None, context: Context, trace_config: dict[str, Any]) -> Generator[ScriptTrace]: ...
