...
class SensiboSelectDescriptionMixin:
    ...
    def __mypy-replace(*, data_key, value_fn, options_fn, transformation) -> None: ...
...
class SensiboSelectEntityDescription(SelectEntityDescription, SensiboSelectDescriptionMixin):
    ...
    def __mypy-replace(*, data_key, value_fn, options_fn, transformation, key, device_class, entity_category, entity_registry_enabled_default, entity_registry_visible_default, force_update, icon, has_entity_name, name, translation_key, unit_of_measurement, options) -> None: ...
