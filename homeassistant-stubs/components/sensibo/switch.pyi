...
class DeviceBaseEntityDescriptionMixin:
    ...
    command_off: str
    remote_key: str
    def __init__(self, value_fn, extra_fn, command_on, command_off, remote_key) -> None: ...

class SensiboDeviceSwitchEntityDescription(SwitchEntityDescription, DeviceBaseEntityDescriptionMixin):
    def __init__(self, value_fn, extra_fn, command_on, command_off, remote_key, key, device_class, entity_category, entity_registry_enabled_default, entity_registry_visible_default, force_update, icon, has_entity_name, name, unit_of_measurement) -> None: ...
...
def build_params(command: str, device_data: SensiboDevice) -> Union[dict[str, Any], None]: ...
