...
class DeviceBaseEntityDescriptionMixin:
    ...
    def __mypy-replace(*, value_fn, extra_fn, command_on, command_off, data_key) -> None: ...
...
class SensiboDeviceSwitchEntityDescription(SwitchEntityDescription, DeviceBaseEntityDescriptionMixin):
    ...
    def __mypy-replace(*, value_fn, extra_fn, command_on, command_off, data_key, key, device_class, entity_category, entity_registry_enabled_default, entity_registry_visible_default, force_update, icon, has_entity_name, name, translation_key, unit_of_measurement) -> None: ...
