...
class DeviceBaseEntityDescriptionMixin:
    ...
    def __mypy-replace(*, value_version, value_available) -> None: ...
...
class SensiboDeviceUpdateEntityDescription(UpdateEntityDescription, DeviceBaseEntityDescriptionMixin):
    ...
    def __mypy-replace(*, value_version, value_available, key, device_class, entity_category, entity_registry_enabled_default, entity_registry_visible_default, force_update, icon, has_entity_name, name, translation_key, unit_of_measurement) -> None: ...
