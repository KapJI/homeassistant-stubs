...
class SFRBoxFlowHandler(ConfigFlow):
    ...
    _reauth_entry: Union[ConfigEntry, None]
    async def async_step_user(self, user_input: Union[dict[str, str], None] = ...) -> FlowResult: ...
    async def async_step_choose_auth(self, user_input: Union[dict[str, str], None] = ...) -> FlowResult: ...
    async def async_step_auth(self, user_input: Union[dict[str, str], None] = ...) -> FlowResult: ...
    async def async_step_skip_auth(self, user_input: Union[dict[str, str], None] = ...) -> FlowResult: ...
