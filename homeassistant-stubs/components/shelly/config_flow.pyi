...
async def validate_input(hass: HomeAssistant, host: str, port: int, info: dict[str, Any], data: dict[str, Any], verify_ssl: bool = False) -> dict[str, Any]: ...
...
class ShellyConfigFlow(ConfigFlow, domain=DOMAIN):
    ...
    async def _async_connect_and_get_info(self, host: str, port: int, verify_ssl: bool = False) -> ConfigFlowResult | None: ...
    @override
    ...
    @asynccontextmanager
    async def _async_provision_context(self, mac: str) -> AsyncGenerator[ProvisioningState]: ...
    ...
    async def _async_get_info(self, host: str, port: int, verify_ssl: bool) -> dict[str, Any]: ...
    @callback
    @override
