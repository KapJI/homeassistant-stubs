...
DOMAIN: Final[str]
LOGGER: Logger
PROVISIONING_TIMEOUT: Final[int]
CONF_SSID: Final[str]
...
BLU_TRV_TEMPERATURE_SETTINGS: Final[Incomplete]
...
SHELLY_WALL_DISPLAY_MODEL_PREFIX: str
...
OPEN_WIFI_AP_ISSUE_ID: str
RTSP_DISABLED_ISSUE_ID: str
COIOT_UNCONFIGURED_ISSUE_ID: str
...
ROLE_GENERIC: str
RPC_ERROR_CODE_REMOTE_DISABLED: int
TRV_CHANNEL: int
ATTR_KEY: str
ATTR_VALUE: str
