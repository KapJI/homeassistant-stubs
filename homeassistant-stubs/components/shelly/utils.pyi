...
def get_rpc_device_info(hass: HomeAssistant, config_entry_id: str, device: RpcDevice, mac: str, configuration_url: str, model: str, model_name: str | None = None, key: str | None = None, emeter_phase: str | None = None, suggested_area: str | None = None) -> DeviceInfo: ...
def get_blu_trv_device_info(hass: HomeAssistant, config_entry_id: str, config: dict[str, Any], ble_addr: str, parent_mac: str, fw_ver: str | None) -> DeviceInfo: ...
def is_block_single_device(device: BlockDevice, block: Block | None = None) -> bool: ...
def get_block_device_info(hass: HomeAssistant, config_entry_id: str, device: BlockDevice, mac: str, configuration_url: str, model: str, model_name: str | None = None, block: Block | None = None, suggested_area: str | None = None) -> DeviceInfo: ...
@callback
...
@callback
def async_migrate_rpc_sensor_description_unique_ids(entity_entry: er.RegistryEntry) -> dict[str, Any] | None: ...
@callback
...
async def async_manage_coiot_issues_task(hass: HomeAssistant, entry: ConfigEntry) -> None: ...
