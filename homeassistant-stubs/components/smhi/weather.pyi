...
from homeassistant.helpers import aiohttp_client as aiohttp_client, sun as sun
...
class SmhiWeather(WeatherEntity):
    ...
    def __init__(self, latitude: str, longitude: str, session: aiohttp.ClientSession) -> None: ...
    @property
