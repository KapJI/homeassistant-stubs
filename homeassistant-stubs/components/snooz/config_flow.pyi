...
class SnoozConfigFlow(ConfigFlow):
    ...
    async def async_step_wait_for_pairing_mode(self, user_input: Union[dict[str, Any], None] = ...) -> FlowResult: ...
    async def async_step_pairing_complete(self, user_input: Union[dict[str, Any], None] = ...) -> FlowResult: ...
    async def async_step_pairing_timeout(self, user_input: Union[dict[str, Any], None] = ...) -> FlowResult: ...
