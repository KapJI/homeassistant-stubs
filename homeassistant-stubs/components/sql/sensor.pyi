...
from homeassistant.const import CONF_DEVICE_CLASS as CONF_DEVICE_CLASS, CONF_NAME as CONF_NAME, CONF_UNIQUE_ID as CONF_UNIQUE_ID, CONF_UNIT_OF_MEASUREMENT as CONF_UNIT_OF_MEASUREMENT, CONF_VALUE_TEMPLATE as CONF_VALUE_TEMPLATE, EVENT_HOMEASSISTANT_STOP as EVENT_HOMEASSISTANT_STOP
...
async def async_setup_sensor(hass: HomeAssistant, name: str, query_str: str, column_name: str, unit: str | None, value_template: Template | None, unique_id: str | None, db_url: str, yaml: bool, device_class: SensorDeviceClass | None, state_class: SensorStateClass | None, async_add_entities: AddEntitiesCallback) -> None: ...
...
class SQLSensor(SensorEntity):
    ...
    def __init__(self, name: str, sessmaker: scoped_session, query: str, column: str, unit: str | None, value_template: Template | None, unique_id: str | None, yaml: bool, device_class: SensorDeviceClass | None, state_class: SensorStateClass | None, use_database_executor: bool) -> None: ...
