...
from homeassistant.helpers.device_registry import AnyDeviceEntry as AnyDeviceEntry, CONNECTION_NETWORK_MAC as CONNECTION_NETWORK_MAC, DeviceEntryType as DeviceEntryType
...
async def async_remove_config_entry_device(hass: HomeAssistant, config_entry: SqueezeboxConfigEntry, device_entry: AnyDeviceEntry) -> bool: ...
