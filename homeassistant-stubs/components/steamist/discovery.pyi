...
async def async_discover_devices(hass: HomeAssistant, timeout: int, address: Union[str, None] = ...) -> list[Device30303]: ...
def async_find_discovery_by_ip(discoveries: list[Device30303], host: str) -> Union[Device30303, None]: ...
async def async_discover_device(hass: HomeAssistant, host: str) -> Union[Device30303, None]: ...
def async_get_discovery(hass: HomeAssistant, host: str) -> Union[Device30303, None]: ...
