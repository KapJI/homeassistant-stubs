...
async def coordinator_for_device(hass: HomeAssistant, entry: SwitchbotCloudConfigEntry, api: SwitchBotAPI, device: Device | Remote, coordinators_by_id: dict[str, SwitchBotCoordinator], manageable_by_webhook: bool = False) -> SwitchBotCoordinator: ...
