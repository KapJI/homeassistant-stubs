...
class SynologyDSMFlowHandler(ConfigFlow, domain=DOMAIN):
    ...
    def _show_form(self, step_id: str, user_input: dict[str, Any] | None = ..., errors: dict[str, str] | None = ...) -> FlowResult: ...
    ...
    async def async_step_2sa(self, user_input: dict[str, Any], errors: dict[str, str] | None = ...) -> FlowResult: ...
