...
from homeassistant.const import CONF_RESOURCES as CONF_RESOURCES, CONF_SCAN_INTERVAL as CONF_SCAN_INTERVAL, CONF_TYPE as CONF_TYPE, DATA_GIBIBYTES as DATA_GIBIBYTES, DATA_MEBIBYTES as DATA_MEBIBYTES, DATA_RATE_MEGABYTES_PER_SECOND as DATA_RATE_MEGABYTES_PER_SECOND, DEVICE_CLASS_TIMESTAMP as DEVICE_CLASS_TIMESTAMP, EVENT_HOMEASSISTANT_STOP as EVENT_HOMEASSISTANT_STOP, PERCENTAGE as PERCENTAGE, STATE_OFF as STATE_OFF, STATE_ON as STATE_ON, TEMP_CELSIUS as TEMP_CELSIUS
...
async def async_setup_sensor_registry_updates(hass: HomeAssistant, sensor_registry: dict[str, SensorData], scan_interval: datetime.timedelta) -> None: ...
...
class SystemMonitorSensor(SensorEntity):
    ...
    def __init__(self, sensor_registry: dict[str, SensorData], sensor_type: str, argument: str=...) -> None: ...
    @property
    def name(self) -> str: ...
    @property
