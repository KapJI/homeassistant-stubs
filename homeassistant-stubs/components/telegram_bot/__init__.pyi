...
async def _call_service(service: ServiceCall, notify_service: TelegramNotificationService, chat_id: int) -> dict[str, JsonValueType] | None: ...
...
def _build_targets(service: ServiceCall) -> list[tuple[TelegramBotConfigEntry, int, str]]: ...
