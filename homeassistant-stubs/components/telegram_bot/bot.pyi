import abc
import io
from .const import ATTR_ARGS as ATTR_ARGS, ATTR_AUTHENTICATION as ATTR_AUTHENTICATION, ATTR_CAPTION as ATTR_CAPTION, ATTR_CHAT_ID as ATTR_CHAT_ID, ATTR_CHAT_INSTANCE as ATTR_CHAT_INSTANCE, ATTR_DATA as ATTR_DATA, ATTR_DISABLE_NOTIF as ATTR_DISABLE_NOTIF, ATTR_DISABLE_WEB_PREV as ATTR_DISABLE_WEB_PREV, ATTR_FILE as ATTR_FILE, ATTR_FILE_ID as ATTR_FILE_ID, ATTR_FILE_MIME_TYPE as ATTR_FILE_MIME_TYPE, ATTR_FILE_NAME as ATTR_FILE_NAME, ATTR_FILE_PATH as ATTR_FILE_PATH, ATTR_FILE_SIZE as ATTR_FILE_SIZE, ATTR_FROM_FIRST as ATTR_FROM_FIRST, ATTR_FROM_LAST as ATTR_FROM_LAST, ATTR_INLINE_MESSAGE_ID as ATTR_INLINE_MESSAGE_ID, ATTR_KEYBOARD as ATTR_KEYBOARD, ATTR_KEYBOARD_INLINE as ATTR_KEYBOARD_INLINE, ATTR_MEDIA as ATTR_MEDIA, ATTR_MEDIA_TYPE as ATTR_MEDIA_TYPE, ATTR_MESSAGE as ATTR_MESSAGE, ATTR_MESSAGE_ID as ATTR_MESSAGE_ID, ATTR_MESSAGE_TAG as ATTR_MESSAGE_TAG, ATTR_MESSAGE_THREAD_ID as ATTR_MESSAGE_THREAD_ID, ATTR_MSG as ATTR_MSG, ATTR_MSGID as ATTR_MSGID, ATTR_ONE_TIME_KEYBOARD as ATTR_ONE_TIME_KEYBOARD, ATTR_OPEN_PERIOD as ATTR_OPEN_PERIOD, ATTR_PARSER as ATTR_PARSER, ATTR_PASSWORD as ATTR_PASSWORD, ATTR_PROTECT_CONTENT as ATTR_PROTECT_CONTENT, ATTR_REPLYMARKUP as ATTR_REPLYMARKUP, ATTR_REPLY_TO_MSGID as ATTR_REPLY_TO_MSGID, ATTR_RESIZE_KEYBOARD as ATTR_RESIZE_KEYBOARD, ATTR_STICKER_ID as ATTR_STICKER_ID, ATTR_TEXT as ATTR_TEXT, ATTR_TIMEOUT as ATTR_TIMEOUT, ATTR_TITLE as ATTR_TITLE, ATTR_URL as ATTR_URL, ATTR_USERNAME as ATTR_USERNAME, ATTR_USER_ID as ATTR_USER_ID, ATTR_VERIFY_SSL as ATTR_VERIFY_SSL, CONF_API_ENDPOINT as CONF_API_ENDPOINT, CONF_CHAT_ID as CONF_CHAT_ID, CONF_PROXY_URL as CONF_PROXY_URL, DEFAULT_TIMEOUT_SECONDS as DEFAULT_TIMEOUT_SECONDS, DOMAIN as DOMAIN, EVENT_TELEGRAM_ATTACHMENT as EVENT_TELEGRAM_ATTACHMENT, EVENT_TELEGRAM_CALLBACK as EVENT_TELEGRAM_CALLBACK, EVENT_TELEGRAM_COMMAND as EVENT_TELEGRAM_COMMAND, EVENT_TELEGRAM_SENT as EVENT_TELEGRAM_SENT, EVENT_TELEGRAM_TEXT as EVENT_TELEGRAM_TEXT, PARSER_HTML as PARSER_HTML, PARSER_MD as PARSER_MD, PARSER_MD2 as PARSER_MD2, PARSER_PLAIN_TEXT as PARSER_PLAIN_TEXT, SERVICE_EDIT_CAPTION as SERVICE_EDIT_CAPTION, SERVICE_EDIT_MESSAGE as SERVICE_EDIT_MESSAGE, SERVICE_SEND_DOCUMENT as SERVICE_SEND_DOCUMENT, SERVICE_SEND_PHOTO as SERVICE_SEND_PHOTO, SERVICE_SEND_STICKER as SERVICE_SEND_STICKER, SERVICE_SEND_VIDEO as SERVICE_SEND_VIDEO, SERVICE_SEND_VOICE as SERVICE_SEND_VOICE
from .helpers import signal as signal
from _typeshed import Incomplete
from abc import abstractmethod
from collections.abc import Awaitable, Callable as Callable, Sequence
from homeassistant.config_entries import ConfigEntry as ConfigEntry
from homeassistant.const import ATTR_COMMAND as ATTR_COMMAND, ATTR_DATE as ATTR_DATE, CONF_API_KEY as CONF_API_KEY, HTTP_BASIC_AUTHENTICATION as HTTP_BASIC_AUTHENTICATION, HTTP_BEARER_AUTHENTICATION as HTTP_BEARER_AUTHENTICATION, HTTP_DIGEST_AUTHENTICATION as HTTP_DIGEST_AUTHENTICATION
...
class TelegramNotificationService:
    ...
    def __init__(self, hass: HomeAssistant, app: BaseTelegramBot | None, bot: Bot, config: TelegramBotConfigEntry, parser: str) -> None: ...
    ...
    async def _send_msg_formatted(self, func_send: Callable[..., Awaitable[Message | tuple[Message, ...]]], message_tag: str | None, *args_msg: Any, context: Context | None = None, **kwargs_msg: Any) -> dict[str, JsonValueType]: ...
    async def _send_msg(self, func_send: Callable[..., Awaitable[Any]], message_tag: str | None, *args_msg: Any, context: Context | None = None, **kwargs_msg: Any) -> Any: ...
    async def send_message(self, message: str, chat_id: int, context: Context | None = None, **kwargs: dict[str, Any]) -> dict[str, JsonValueType]: ...
    async def send_media_group(self, chat_id: int, context: Context | None = None, **kwargs: Any) -> dict[str, JsonValueType]: ...
    async def delete_message(self, chat_id: int, context: Context | None = None, **kwargs: dict[str, Any]) -> bool: ...
    async def edit_message_media(self, media_type: str, chat_id: int, context: Context | None = None, **kwargs: Any) -> Any: ...
    async def edit_message(self, type_edit: str, chat_id: int, context: Context | None = None, **kwargs: dict[str, Any]) -> Any: ...
    ...
    async def send_chat_action(self, chat_id: int, chat_action: str = '', context: Context | None = None, **kwargs: Any) -> dict[str, JsonValueType]: ...
    async def send_file(self, file_type: str, context: Context | None = None, **kwargs: Any) -> dict[str, JsonValueType]: ...
    async def send_sticker(self, context: Context | None = None, **kwargs: Any) -> dict[str, JsonValueType]: ...
    async def send_location(self, latitude: Any, longitude: Any, context: Context | None = None, **kwargs: dict[str, Any]) -> dict[str, JsonValueType]: ...
...
async def load_data(hass: HomeAssistant, url: str | None, filepath: str | None, username: str, password: str, authentication: str | None, verify_ssl: bool, num_retries: int = 5) -> io.BytesIO: ...
