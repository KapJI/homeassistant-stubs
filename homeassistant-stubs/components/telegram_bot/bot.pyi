...
from telegram import Bot, CallbackQuery as CallbackQuery, InputPollOption as InputPollOption, Message as Message, Update as Update, User as User
...
class TelegramNotificationService:
    ...
    async def leave_chat(self, chat_id: Any = None, context: Context | None = None, **kwargs: dict[str, Any]) -> Any: ...
    async def set_message_reaction(self, chat_id: int, reaction: str, is_big: bool = False, context: Context | None = None, **kwargs: dict[str, Any]) -> None: ...
