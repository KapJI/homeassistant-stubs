from . import TiltBLEConfigEntry as TiltBLEConfigEntry
...
async def async_setup_entry(hass: HomeAssistant, entry: TiltBLEConfigEntry, async_add_entities: AddConfigEntryEntitiesCallback) -> None: ...
