...
class TPLinkSmartLightStrip(TPLinkSmartBulb):
    ...
    async def async_turn_on(self, **kwargs: Any) -> None: ...
    async def async_set_random_effect(self, brightness: int, duration: int, transition: int, segments: list[int], fadeoff: int, init_states: tuple[int, int, int], random_seed: int, backgrounds: Sequence[tuple[int, int, int]] | None = ..., hue_range: tuple[int, int] | None = ..., saturation_range: tuple[int, int] | None = ..., brightness_range: tuple[int, int] | None = ..., transition_range: tuple[int, int] | None = ...) -> None: ...
