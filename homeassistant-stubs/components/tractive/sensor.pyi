...
from .const import ATTR_DAILY_GOAL as ATTR_DAILY_GOAL, ATTR_MINUTES_ACTIVE as ATTR_MINUTES_ACTIVE, ATTR_MINUTES_DAY_SLEEP as ATTR_MINUTES_DAY_SLEEP, ATTR_MINUTES_NIGHT_SLEEP as ATTR_MINUTES_NIGHT_SLEEP, ATTR_MINUTES_REST as ATTR_MINUTES_REST, ATTR_TRACKER_STATE as ATTR_TRACKER_STATE, TRACKER_HARDWARE_STATUS_UPDATED as TRACKER_HARDWARE_STATUS_UPDATED, TRACKER_HEALTH_OVERVIEW_UPDATED as TRACKER_HEALTH_OVERVIEW_UPDATED
...
class TractiveSensor(TractiveEntity, SensorEntity):
    ...
    def __init__(self, hass: HomeAssistant, entry: TractiveConfigEntry, client: TractiveClient, item: Trackables, description: TractiveSensorEntityDescription) -> None: ...
