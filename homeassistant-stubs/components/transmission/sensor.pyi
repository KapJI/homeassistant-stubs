...
class TransmissionSensor(CoordinatorEntity[TransmissionDataUpdateCoordinator], SensorEntity):
    ...
    def __init__(self, coordinator: TransmissionDataUpdateCoordinator, entity_description: SensorEntityDescription) -> None: ...
...
def _torrents_info(torrents: list[Torrent], order: str, limit: int, statuses: list[str] | None = None) -> dict[str, Any]: ...
