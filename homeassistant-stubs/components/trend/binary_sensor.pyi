...
class SensorTrend(BinarySensorEntity, RestoreEntity):
    ...
    def __init__(self, *, name: str, entity_id: str, attribute: str | None, invert: bool, sample_duration: int, min_gradient: float, min_samples: int, max_samples: int, unique_id: str | None = None, device_class: BinarySensorDeviceClass | None = None, sensor_entity_id: str | None = None, device: AnyDeviceEntry | None = None) -> None: ...
    @property
    @override
