...
@callback
def async_device_temperatures_value_fn(temperature_name: str, hub: UnifiHub, device: Device) -> float | None: ...
@callback
def async_device_temperatures_available_fn(temperature_name: str, hub: UnifiHub, obj_id: str) -> bool: ...
@callback
