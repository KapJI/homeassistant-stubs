...
async def async_object_oriented_network_config_control_fn(hub: UnifiHub, obj_id: str, target: bool) -> None: ...
@callback
def async_object_oriented_network_config_supported_fn(hub: UnifiHub, obj_id: str) -> bool: ...
@callback
