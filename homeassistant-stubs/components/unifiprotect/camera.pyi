...
def get_camera_channels(data: ProtectData, ufp_device: Union[UFPCamera, None] = ...) -> Generator[tuple[UFPCamera, CameraChannel, bool], None, None]: ...
def _async_camera_entities(data: ProtectData, ufp_device: Union[UFPCamera, None] = ...) -> list[ProtectDeviceEntity]: ...
