...
DISCOVERY_API_KEY_SCHEMA: Incomplete
REAUTH_SCHEMA: Incomplete
API_KEY_DOCUMENTATION_URL: str
REAUTH_API_KEY_SCHEMA: Incomplete
...
class ProtectFlowHandler(ConfigFlow, domain=DOMAIN):
    ...
    async def async_step_discovery_api_key(self, user_input: dict[str, Any] | None = None) -> ConfigFlowResult: ...
    async def async_step_discovery_full(self, user_input: dict[str, Any] | None = None) -> ConfigFlowResult: ...
    @staticmethod
    @callback
    @override
    ...
    async def _async_validate_public_api_key(self, user_input: dict[str, Any]) -> tuple[ProtectApiClient | None, dict[str, str]]: ...
    async def _async_get_public_nvr_identity(self, user_input: dict[str, Any]) -> tuple[str | None, str, dict[str, str]]: ...
    async def async_step_api_key(self, user_input: dict[str, Any] | None = None) -> ConfigFlowResult: ...
    async def async_step_reauth(self, entry_data: Mapping[str, Any]) -> ConfigFlowResult: ...
    async def async_step_reauth_api_key(self, user_input: dict[str, Any] | None = None) -> ConfigFlowResult: ...
    async def async_step_reauth_confirm(self, user_input: dict[str, Any] | None = None) -> ConfigFlowResult: ...
    async def async_step_reconfigure(self, user_input: dict[str, Any] | None = None) -> ConfigFlowResult: ...
    async def async_step_reconfigure_api_key(self, user_input: dict[str, Any] | None = None) -> ConfigFlowResult: ...
    async def async_step_reconfigure_full(self, user_input: dict[str, Any] | None = None) -> ConfigFlowResult: ...
    @override
