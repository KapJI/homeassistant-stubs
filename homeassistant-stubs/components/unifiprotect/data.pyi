...
class ProtectData:
    ...
    last_public_update_success: bool
    last_events_update_success: bool
    api: Incomplete
    ...
    @callback
    def _async_reenumerate_camera_on_public_change(self, new_obj: PublicDeviceModel, message: WSSubscriptionMessage) -> None: ...
    @callback
    def _async_process_public_event(self, event: ProtectEvent, change: EventChange) -> None: ...
    @callback
    ...
    @callback
    def async_subscribe_public_event(self, device_id: str, event_type: EventType, update_callback: Callable[[ProtectEvent], None]) -> CALLBACK_TYPE: ...
    @callback
    def _async_unsubscribe_public_event(self, key: tuple[str, EventType], update_callback: Callable[[ProtectEvent], None]) -> None: ...
    @callback
    def async_subscribe_public(self, mac: str, update_callback: Callable[[PublicDeviceModel | None], None]) -> CALLBACK_TYPE: ...
    @callback
    def _async_unsubscribe_public(self, mac: str, update_callback: Callable[[PublicDeviceModel | None], None]) -> None: ...
    @callback
    def async_get_public_device(self, device: ProtectDeviceType | PublicDeviceModel) -> PublicDeviceModel | None: ...
    @callback
    def _async_signal_device_update(self, device: ProtectDeviceType) -> None: ...
    @callback
    def _async_signal_public_update(self, mac: str, obj: PublicDeviceModel | None) -> None: ...
