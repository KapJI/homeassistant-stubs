...
from uiprotect.data import Camera, EventType, ModelType, NVR, PTZPatrol as PTZPatrol, ProtectAdoptableDeviceModel, PublicDeviceModel, Relay, Siren, WSSubscriptionMessage as WSSubscriptionMessage
...
class ProtectData:
    ...
    @callback
    def async_subscribe_public_event(self, mac: str, event_type: EventType, update_callback: Callable[[ProtectEvent], None]) -> CALLBACK_TYPE: ...
    @callback
    ...
    @callback
    def async_get_public_device(self, device: ProtectDeviceType) -> PublicDeviceModel | None: ...
    @callback
