...
def _async_device_entities(data: ProtectData, klass: type[ProtectDeviceEntity], model_type: ModelType, descs: Sequence[ProtectRequiredKeysMixin], unadopted_descs: Sequence[ProtectRequiredKeysMixin], ufp_device: Union[ProtectAdoptableDeviceModel, None] = ...) -> list[ProtectDeviceEntity]: ...
def async_all_device_entities(data: ProtectData, klass: type[ProtectDeviceEntity], camera_descs: Union[Sequence[ProtectRequiredKeysMixin], None] = ..., light_descs: Union[Sequence[ProtectRequiredKeysMixin], None] = ..., sense_descs: Union[Sequence[ProtectRequiredKeysMixin], None] = ..., viewer_descs: Union[Sequence[ProtectRequiredKeysMixin], None] = ..., lock_descs: Union[Sequence[ProtectRequiredKeysMixin], None] = ..., chime_descs: Union[Sequence[ProtectRequiredKeysMixin], None] = ..., all_descs: Union[Sequence[ProtectRequiredKeysMixin], None] = ..., unadopted_descs: Union[Sequence[ProtectRequiredKeysMixin], None] = ..., ufp_device: Union[ProtectAdoptableDeviceModel, None] = ...) -> list[ProtectDeviceEntity]: ...
