...
def get_ufp_event(event_type: SimpleEventType) -> Union[EventType, None]: ...
async def async_get_media_source(hass: HomeAssistant) -> MediaSource: ...
def _get_month_start_end(start: datetime) -> tuple[datetime, datetime]: ...
def _bad_identifier(identifier: str, err: Union[Exception, None] = ...) -> BrowseMediaSource: ...
def _bad_identifier_media(identifier: str, err: Union[Exception, None] = ...) -> PlayMedia: ...
def _format_duration(duration: timedelta) -> str: ...

class ProtectMediaSource(MediaSource):
    name: str
    _registry: Union[er.EntityRegistry, None]
    hass: Incomplete
    ...
    async def _resolve_event(self, data: ProtectData, event_id: str, thumbnail_only: bool = ...) -> BrowseMediaSource: ...
    def async_get_registry(self) -> er.EntityRegistry: ...
    def _breadcrumb(self, data: ProtectData, base_title: str, camera: Union[Camera, None] = ..., event_type: Union[SimpleEventType, None] = ..., count: Union[int, None] = ...) -> str: ...
    async def _build_event(self, data: ProtectData, event: Union[dict[str, Any], Event], thumbnail_only: bool = ...) -> BrowseMediaSource: ...
    async def _build_events(self, data: ProtectData, start: datetime, end: datetime, camera_id: Union[str, None] = ..., event_type: Union[EventType, None] = ..., reserve: bool = ...) -> list[BrowseMediaSource]: ...
    ...
    async def _get_camera_thumbnail_url(self, camera: Camera) -> Union[str, None]: ...
