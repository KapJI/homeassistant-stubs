...
@callback
def _async_repair_if_used(hass: HomeAssistant, entity: er.RegistryEntry, issue_id: str, translation_key: str, placeholders: dict[str, str] | None = None, breaks_in: str | None = None) -> None: ...
@callback
def async_remove_package_binary_sensor(hass: HomeAssistant, entry: UFPConfigEntry) -> None: ...

SENSE_SETTING_MIRROR_BREAKS_IN: str
_SENSE_SETTING_REPLACEMENTS: dict[tuple[str, str], tuple[Platform, str]]

@callback
def async_deprecate_sense_setting_mirrors(hass: HomeAssistant, entry: UFPConfigEntry, bootstrap: Bootstrap) -> None: ...
@callback
