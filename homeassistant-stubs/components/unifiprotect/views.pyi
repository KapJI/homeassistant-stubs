...
def async_generate_thumbnail_url(event_id: str, nvr_id: str, width: Union[int, None] = ..., height: Union[int, None] = ...) -> str: ...
...
class ProtectProxyView(HomeAssistantView):
    ...
    def _get_data_or_404(self, nvr_id: str) -> Union[ProtectData, web.Response]: ...
