...
class _BaseVacuum(Entity):
    ...
    @property
    def fan_speed(self) -> Union[str, None]: ...
    @property
    ...
    def send_command(self, command: str, params: Union[dict, list, None] = ..., **kwargs: Any) -> None: ...
    async def async_send_command(self, command: str, params: Union[dict, list, None] = ..., **kwargs: Any) -> None: ...
