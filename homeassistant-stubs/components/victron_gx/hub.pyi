...
type NewMetricCallback = Callable[[VictronVenusDevice, VictronVenusMetric, dr.DeviceInfo, str], None]
...
class Hub:
    ...
    def _ensure_device_registered(self, device: VictronVenusDevice, installation_id: str) -> str: ...
    @staticmethod
    def _map_device_info(device: VictronVenusDevice, installation_id: str) -> dr.DeviceInfo: ...
