...
def catch_vlc_errors[_VlcDeviceT: VlcDevice, **_P](*, log: bool = False) -> Callable[[Callable[Concatenate[_VlcDeviceT, _P], Awaitable[None]]], Callable[Concatenate[_VlcDeviceT, _P], Coroutine[Any, Any, None]]]: ...
