...
class WolSwitch(SwitchEntity):
    ...
    def __init__(self, hass: HomeAssistant, name: str, host: Union[str, None], mac_address: str, off_action: Union[list[Any], None], broadcast_address: Union[str, None], broadcast_port: Union[int, None]) -> None: ...
    @property
    def is_on(self) -> bool: ...
