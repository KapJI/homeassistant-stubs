...
def handle_subscribe_bootstrap_integrations(hass: Any, connection: Any, msg: Any) -> None: ...
...
async def handle_integration_setup_info(hass: Any, connection: Any, msg: Any) -> None: ...
