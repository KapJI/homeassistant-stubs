...
class AttributeSensorDescription(SensorEntityDescription):
    ...
    def __init__(self, key, device_class, entity_category, entity_registry_enabled_default, force_update, icon, name, unit_of_measurement, last_reset, native_unit_of_measurement, state_class, state_conversion, unique_id_suffix) -> None: ...

ATTRIBUTE_SENSORS: Any
