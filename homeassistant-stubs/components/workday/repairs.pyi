...
class CountryFixFlow(RepairsFlow):
    ...
    async def async_step_country(self, user_input: dict[str, Any] | None = None) -> RepairsFlowResult: ...
    async def async_step_province(self, user_input: dict[str, Any] | None = None) -> RepairsFlowResult: ...
...
class HolidayFixFlow(RepairsFlow):
    ...
    async def async_step_init(self, user_input: dict[str, str] | None = None) -> RepairsFlowResult: ...
    async def async_step_fix_remove_holiday(self, user_input: dict[str, Any] | None = None) -> RepairsFlowResult: ...
