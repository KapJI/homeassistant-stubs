from .models import HaAsyncZeroconf as HaAsyncZeroconf, HaServiceBrowser as HaServiceBrowser, HaZeroconf as HaZeroconf
...
from zeroconf import ServiceInfo, ServiceStateChange, Zeroconf as Zeroconf
...
class ZeroconfDiscovery:
    ...
    flow_dispatcher: Any = ...
    service_browser: Any = ...
    def __init__(self, hass: HomeAssistant, zeroconf: Zeroconf, zeroconf_types: dict[str, list[dict[str, str]]], homekit_models: dict[str, str]) -> None: ...
    async def async_setup(self) -> None: ...
    async def async_stop(self) -> None: ...
    def async_start(self) -> None: ...
    def service_update(self, zeroconf: Zeroconf, service_type: str, name: str, state_change: ServiceStateChange) -> None: ...
