...
class ZeroconfDiscovery:
    ...
    def __init__(self, hass: HomeAssistant, zeroconf: HaZeroconf, zeroconf_types: dict[str, list[dict[str, Union[str, dict[str, str]]]]], homekit_models: dict[str, HomeKitDiscoveredIntegration], ipv6: bool) -> None: ...
...
def async_get_homekit_discovery_domain(homekit_models: dict[str, HomeKitDiscoveredIntegration], props: dict[str, Any]) -> Union[HomeKitDiscoveredIntegration, None]: ...
