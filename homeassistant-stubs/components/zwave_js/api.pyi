...
from homeassistant.config_entries import ConfigEntry as ConfigEntry, ENTRY_STATE_LOADED as ENTRY_STATE_LOADED
...
async def websocket_subscribe_logs(hass: HomeAssistant, connection: ActiveConnection, msg: dict, entry: ConfigEntry, client: Client) -> None: ...
