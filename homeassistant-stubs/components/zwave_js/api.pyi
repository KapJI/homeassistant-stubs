...
async def websocket_get_firmware_update_progress(hass: HomeAssistant, connection: ActiveConnection, msg: dict, node: Node) -> None: ...
...
async def websocket_get_any_firmware_update_progress(hass: HomeAssistant, connection: ActiveConnection, msg: dict, entry: ConfigEntry, client: Client, driver: Driver) -> None: ...
