...
from .const import ADDON_SLUG as ADDON_SLUG, CONF_ADDON_DEVICE as CONF_ADDON_DEVICE, CONF_ADDON_NETWORK_KEY as CONF_ADDON_NETWORK_KEY, CONF_ADDON_S0_LEGACY_KEY as CONF_ADDON_S0_LEGACY_KEY, CONF_ADDON_SOCKET as CONF_ADDON_SOCKET, CONF_INTEGRATION_CREATED_ADDON as CONF_INTEGRATION_CREATED_ADDON, CONF_SOCKET_PATH as CONF_SOCKET_PATH, CONF_USB_PATH as CONF_USB_PATH, CONF_USE_ADDON as CONF_USE_ADDON, DOMAIN as DOMAIN
from .helpers import CannotConnect as CannotConnect, async_get_version_info as async_get_version_info, format_home_id_for_display as format_home_id_for_display
from .models import ZwaveJSConfigEntry as ZwaveJSConfigEntry
from _typeshed import Incomplete
from collections.abc import Callable as Callable, Mapping
from dataclasses import dataclass
from homeassistant.components import usb as usb
from homeassistant.components.hassio import AddonError as AddonError, AddonInfo as AddonInfo, AddonState as AddonState
from homeassistant.config_entries import ConfigEntry as ConfigEntry, ConfigEntryState as ConfigEntryState, ConfigFlow as ConfigFlow, ConfigFlowResult as ConfigFlowResult, SOURCE_ESPHOME as SOURCE_ESPHOME, SOURCE_IGNORE as SOURCE_IGNORE, SOURCE_USB as SOURCE_USB, SOURCE_ZEROCONF as SOURCE_ZEROCONF
...
class SecurityKeys:
    ...
    @classmethod
    def from_config(cls, config: Mapping[str, Any], defaults: SecurityKeys | None = None) -> Self: ...
...
_ADDON_OWNER_CONTEXT: str
ABORT_SAFE_STEPS: Incomplete
...
class AddonFlowManager:
    ...
    async def async_start_addon_and_wait(self, ws_address: str | None) -> tuple[str, VersionInfo]: ...
...
class ZWaveJSConfigFlow(ConfigFlow, domain=DOMAIN):
    ...
    _rf_region: str | None
    _entry_unloaded_by_flow: bool
    _unique_id_is_placeholder: bool
    ...
    async def _async_restore_addon_config_and_reload(self, original_config: dict[str, Any]) -> None: ...
