...
from homeassistant.data_entry_flow import AbortFlow as AbortFlow, FlowResultDict as FlowResultDict
...
class ConfigFlow(config_entries.ConfigFlow):
    ...
    async def async_step_manual(self, user_input: Union[dict[str, Any], None]=...) -> FlowResultDict: ...
    async def async_step_hassio(self, discovery_info: dict[str, Any]) -> FlowResultDict: ...
    async def async_step_hassio_confirm(self, user_input: Union[dict[str, Any], None]=...) -> FlowResultDict: ...
    def _async_create_entry_from_vars(self) -> FlowResultDict: ...
    async def async_step_on_supervisor(self, user_input: Union[dict[str, Any], None]=...) -> FlowResultDict: ...
    async def async_step_install_addon(self, user_input: Union[dict[str, Any], None]=...) -> FlowResultDict: ...
    async def async_step_install_failed(self, user_input: Union[dict[str, Any], None]=...) -> FlowResultDict: ...
    async def async_step_configure_addon(self, user_input: Union[dict[str, Any], None]=...) -> FlowResultDict: ...
    async def async_step_start_addon(self, user_input: Union[dict[str, Any], None]=...) -> FlowResultDict: ...
    async def async_step_start_failed(self, user_input: Union[dict[str, Any], None]=...) -> FlowResultDict: ...
    async def _async_start_addon(self) -> None: ...
    async def async_step_finish_addon_setup(self, user_input: Union[dict[str, Any], None]=...) -> FlowResultDict: ...
