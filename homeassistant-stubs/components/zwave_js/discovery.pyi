...
class ZwaveDiscoveryInfo:
    ...
    def __init__(self, node: Any, primary_value: Any, assumed_state: Any, platform: Any, platform_hint: Any) -> None: ...
...
class ZWaveDiscoverySchema:
    ...
    allow_multi: bool = ...
    assumed_state: bool = ...
    def __init__(self, platform: Any, primary_value: Any, hint: Any, manufacturer_id: Any, product_id: Any, product_type: Any, firmware_version: Any, device_class_basic: Any, device_class_generic: Any, device_class_specific: Any, required_values: Any, absent_values: Any, allow_multi: Any, assumed_state: Any) -> None: ...
