...
def async_get_nodes_from_targets(hass: HomeAssistant, val: dict[str, Any], ent_reg: Union[er.EntityRegistry, None] = ..., dev_reg: Union[dr.DeviceRegistry, None] = ...) -> set[ZwaveNode]: ...
