...
from .const import ATTR_COMMAND_CLASS as ATTR_COMMAND_CLASS, ATTR_ENDPOINT as ATTR_ENDPOINT, ATTR_PROPERTY as ATTR_PROPERTY, ATTR_PROPERTY_KEY as ATTR_PROPERTY_KEY, DOMAIN as DOMAIN, LIB_LOGGER as LIB_LOGGER, LOGGER as LOGGER, NOTIFICATION_ACCESS_CONTROL_PROPERTY as NOTIFICATION_ACCESS_CONTROL_PROPERTY, OPENING_STATE_PROPERTY_KEY as OPENING_STATE_PROPERTY_KEY
...
def get_opening_state_notification_value(node: ZwaveNode, endpoint: int | None = None) -> ZwaveValue | None: ...
...
@callback
def async_get_config_entry_from_node(hass: HomeAssistant, node: ZwaveNode) -> ZwaveJSConfigEntry: ...
