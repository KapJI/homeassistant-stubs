...
def async_update_data_collection_preference(hass: HomeAssistant, entry: ConfigEntry, preference: bool) -> None: ...
...
def async_get_nodes_from_targets(hass: HomeAssistant, val: dict[str, Any], ent_reg: er.EntityRegistry | None = ..., dev_reg: dr.DeviceRegistry | None = ..., logger: logging.Logger = ...) -> set[ZwaveNode]: ...
