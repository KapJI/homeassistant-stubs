...
class ZWaveLock(ZWaveBaseEntity, LockEntity):
    ...
    async def async_set_lock_configuration(self, operation_type: OperationType, lock_timeout: int | None = ..., auto_relock_time: int | None = ..., hold_and_release_time: int | None = ..., twist_assist: bool | None = ..., block_to_block: bool | None = ...) -> None: ...
