...
from zwave_js_server.model.access_control import SetUserOptions, UserCredentialCapability as UserCredentialCapability
...
async def _validate_credential_data(node: Node, credential_type: UserCredentialType, credential_data: str) -> UserCredentialCapability: ...
async def _async_find_available_user_slot(node: Node) -> int: ...
async def _async_find_available_credential_slot(node: Node, credential_type: UserCredentialType, type_cap: UserCredentialCapability) -> int: ...
async def _async_resolve_credential_slot(node: Node, user_id: int, credential_type: UserCredentialType, type_cap: UserCredentialCapability, credential_slot: int | None) -> int: ...
...
async def async_set_user(node: Node, user_id: int | None = None, user_name: str | None = None, user_type: UserCredentialUserType | None = None, credential_rule: UserCredentialRule | None = None, active: bool | None = None, credential_slot: int | None = None, credential_type: UserCredentialType | None = None, credential_data: str | None = None) -> SetUserReturn: ...
async def _async_create_user(node: Node, options: SetUserOptions, credential_slot: int | None, credential_type: UserCredentialType | None, credential_data: str | None) -> SetUserReturn: ...
