...
def get_valid_responses_from_results(zwave_objects: Sequence[ZwaveNode | Endpoint], results: Sequence[Any]) -> Generator[tuple[ZwaveNode | Endpoint, Any], None, None]: ...
def raise_exceptions_from_results(zwave_objects: Sequence[ZwaveNode | Endpoint], results: Sequence[Any]) -> None: ...
