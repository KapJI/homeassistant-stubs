...
from homeassistant.util.yaml import SECRET_YAML as SECRET_YAML, load_yaml as load_yaml
...
def async_log_exception(ex: Exception, domain: str, config: Dict, hass: HomeAssistant, link: Optional[str]=...) -> None: ...
...
async def async_process_component_config(hass: HomeAssistant, config: ConfigType, integration: Integration) -> Optional[ConfigType]: ...
...
def async_notify_setup_error(hass: HomeAssistant, component: str, display_link: Optional[str]=...) -> None: ...
