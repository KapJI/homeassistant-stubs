...
class ConfigEntry:
    ...
    _on_unload: Any = ...
    def __init__(self, version: int, domain: str, title: str, data: Mapping[str, Any], source: str, system_options: dict, options: Union[Mapping[str, Any], None]=..., unique_id: Union[str, None]=..., entry_id: Union[str, None]=..., state: ConfigEntryState=..., disabled_by: Union[str, None]=...) -> None: ...
...
class SystemOptions:
    ...
    def update(self, *, disable_new_entities: Union[bool, UndefinedType]=..., disable_polling: Union[bool, UndefinedType]=...) -> None: ...
    def as_dict(self) -> dict[str, Any]: ...
    def __init__(self, disable_new_entities: Any, disable_polling: Any) -> None: ...
