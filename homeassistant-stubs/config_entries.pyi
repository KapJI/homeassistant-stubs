...
from .helpers.service_info.bluetooth import BluetoothServiceInfo as BluetoothServiceInfo
...
class ConfigFlow(data_entry_flow.FlowHandler):
    ...
    def _abort_if_unique_id_configured(self, updates: Union[dict[str, Any], None] = ..., reload_on_update: bool = ...) -> None: ...
    ...
    async def async_step_bluetooth(self, discovery_info: BluetoothServiceInfo) -> data_entry_flow.FlowResult: ...
