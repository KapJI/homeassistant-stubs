...
from .helpers.typing import ConfigType as ConfigType, DiscoveryInfoType as DiscoveryInfoType, NoEventData as NoEventData, UNDEFINED as UNDEFINED, UndefinedType as UndefinedType
...
class ConfigEntry[_DataT = Any]:
    ...
    @callback
    def _async_set_state(self, hass: HomeAssistant, state: ConfigEntryState, reason: str | None, error_reason_translation_key: str | None = None, error_reason_translation_placeholders: dict[str, str] | None = None, error_reason_translation_domain: str | None = None) -> None: ...
    ...
    @callback
    def async_start_reauth_if_available(self, hass: HomeAssistant, context: ConfigFlowContext | None = None, data: dict[str, Any] | None = None) -> None: ...
...
class ConfigEntriesFlowManager(data_entry_flow.FlowManager[ConfigFlowContext, ConfigFlowResult]):
    ...
    @override
    async def _async_configure(self, flow_id: str, user_input: dict | None = None) -> ConfigFlowResult: ...
    ...
    def _async_validate_next_flow(self, result: ConfigFlowResult) -> None: ...
    @override
...
class ConfigEntries:
    ...
    @callback
    def async_update_subentry(self, entry: ConfigEntry, subentry: ConfigSubentry, *, data: Mapping[str, Any] | UndefinedType = ..., title: str | UndefinedType = ..., unique_id: str | UndefinedType | None = ...) -> bool: ...
...
class ConfigFlow(ConfigEntryBaseFlow):
    ...
    @callback
    @override
    def async_abort(self, *, reason: str, description_placeholders: Mapping[str, str] | None = None, translation_domain: str | None = None, next_flow: tuple[FlowType, str] | None = None) -> ConfigFlowResult: ...
    ...
    @callback
    def __async_update(self, entry: ConfigEntry, *, unique_id: str | UndefinedType | None, title: str | UndefinedType, data: Mapping[str, Any] | UndefinedType, data_updates: Mapping[str, Any] | UndefinedType, options: Mapping[str, Any] | UndefinedType) -> bool: ...
    @callback
    def async_update_and_abort(self, entry: ConfigEntry, *, unique_id: str | UndefinedType | None = ..., title: str | UndefinedType = ..., data: Mapping[str, Any] | UndefinedType = ..., data_updates: Mapping[str, Any] | UndefinedType = ..., options: Mapping[str, Any] | UndefinedType = ..., reason: str | UndefinedType = ...) -> ConfigFlowResult: ...
    @callback
    def async_update_reload_and_abort(self, entry: ConfigEntry, *, unique_id: str | UndefinedType | None = ..., title: str | UndefinedType = ..., data: Mapping[str, Any] | UndefinedType = ..., data_updates: Mapping[str, Any] | UndefinedType = ..., options: Mapping[str, Any] | UndefinedType = ..., reason: str | UndefinedType = ..., reload_even_if_entry_is_unchanged: bool = True) -> ConfigFlowResult: ...
    @callback
    @override
...
class ConfigSubentryFlow(data_entry_flow.FlowHandler[SubentryFlowContext, SubentryFlowResult, tuple[str, str]]):
    ...
    @callback
    def _async_update(self, entry: ConfigEntry, subentry: ConfigSubentry, *, unique_id: str | UndefinedType | None = ..., title: str | UndefinedType = ..., data: Mapping[str, Any] | UndefinedType = ..., data_updates: Mapping[str, Any] | UndefinedType = ...) -> bool: ...
    @callback
    def async_update_and_abort(self, entry: ConfigEntry, subentry: ConfigSubentry, *, unique_id: str | UndefinedType | None = ..., title: str | UndefinedType = ..., data: Mapping[str, Any] | UndefinedType = ..., data_updates: Mapping[str, Any] | UndefinedType = ...) -> SubentryFlowResult: ...
    @callback
    def async_update_reload_and_abort(self, entry: ConfigEntry, subentry: ConfigSubentry, *, unique_id: str | UndefinedType | None = ..., title: str | UndefinedType = ..., data: Mapping[str, Any] | UndefinedType = ..., data_updates: Mapping[str, Any] | UndefinedType = ..., reload_even_if_entry_is_unchanged: bool = True) -> SubentryFlowResult: ...
    @property
