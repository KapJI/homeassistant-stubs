...
class ConfigEntry:
    ...
    def __init__(self, version: int, domain: str, title: str, data: dict, source: str, connection_class: str, system_options: dict, options: Optional[dict]=..., unique_id: Optional[str]=..., entry_id: Optional[str]=..., state: str=..., disabled_by: Optional[str]=...) -> None: ...
    async def async_setup(self, hass: HomeAssistant, *, integration: Optional[loader.Integration]=..., tries: int=...) -> None: ...
    async def async_unload(self, hass: HomeAssistant, *, integration: Optional[loader.Integration]=...) -> bool: ...
...
class ConfigEntriesFlowManager(data_entry_flow.FlowManager):
    ...
    async def async_create_flow(self, handler_key: Any, *, context: Optional[Dict]=..., data: Any=...) -> ConfigFlow: ...
...
class ConfigEntries:
    ...
    def async_entries(self, domain: Optional[str]=...) -> List[ConfigEntry]: ...
    ...
    async def async_set_disabled_by(self, entry_id: str, disabled_by: Optional[str]) -> bool: ...
...
class ConfigFlow(data_entry_flow.FlowHandler):
    def __init_subclass__(cls: Any, domain: Optional[str]=..., **kwargs: Any) -> None: ...
    CONNECTION_CLASS: Any = ...
    @property
    def unique_id(self) -> Optional[str]: ...
    @staticmethod
    def async_get_options_flow(config_entry: ConfigEntry) -> OptionsFlow: ...
    async def async_set_unique_id(self, unique_id: Optional[str]=..., *, raise_on_progress: bool=...) -> Optional[ConfigEntry]: ...
...
class OptionsFlowManager(data_entry_flow.FlowManager):
    async def async_create_flow(self, handler_key: Any, *, context: Optional[Dict[str, Any]]=..., data: Optional[Dict[str, Any]]=...) -> OptionsFlow: ...
    async def async_finish_flow(self, flow: data_entry_flow.FlowHandler, result: Dict[str, Any]) -> Dict[str, Any]: ...
