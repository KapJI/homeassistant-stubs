...
REQUIRED_NEXT_PYTHON_DATE: Final[str]
...
EVENT_TIMER_OUT_OF_SYNC: Final[str]
EVENT_TIME_CHANGED: Final[str]
...
ELECTRICAL_CURRENT_AMPERE: Final[str]
ELECTRICAL_VOLT_AMPERE: Final[str]
DEGREE: Final[str]
...
URL_API_DISCOVERY_INFO: Final[str]
