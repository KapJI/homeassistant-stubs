...
from .util.async_ import run_callback_threadsafe as run_callback_threadsafe, shutdown_run_callback_threadsafe as shutdown_run_callback_threadsafe
...
class State:
    ...
    @classmethod
    def from_dict(cls, json_dict: dict[str, Any]) -> Union[Self, None]: ...
...
class Config:
    ...
    def _update(self, *, source: ConfigSource, latitude: Union[float, None] = ..., longitude: Union[float, None] = ..., elevation: Union[int, None] = ..., unit_system: Union[str, None] = ..., location_name: Union[str, None] = ..., time_zone: Union[str, None] = ..., external_url: Union[str, dict[Any, Any], None] = ..., internal_url: Union[str, dict[Any, Any], None] = ..., currency: Union[str, None] = ..., country: Union[str, dict[Any, Any], None] = ..., language: Union[str, None] = ...) -> None: ...
