...
from typing import Any, Final, Generic, NotRequired, Self, TypeVar, TypedDict, overload, override
...
_MAX_QUEUED_EVENT_DISPATCHES: Final[int]
...
class EventBus:
    ...
    _hass: Incomplete
    _event_queue: deque[tuple[EventType[Any] | str, Any, EventOrigin, Context | None, float]]
    _dispatching: bool
    _queued_event_count: int
    ...
    @callback
    def _async_dispatch(self, event_type: EventType[_DataT] | str, event_data: _DataT | None, origin: EventOrigin, context: Context | None, time_fired: float | None) -> None: ...
...
class Service:
    ...
    def __init__(self, func: Callable[[ServiceCall], Coroutine[Any, Any, ServiceResponse | EntityServiceResponse] | ServiceResponse | EntityServiceResponse | None], schema: VolSchemaType | None, domain: str, service: str, context: Context | None = None, supports_response: SupportsResponse = ..., job_type: HassJobType | None = None, description_placeholders: Mapping[str, str] | None = None) -> None: ...
...
class ServiceRegistry:
    ...
    @callback
    def async_register(self, domain: str, service: str, service_func: Callable[[ServiceCall], Coroutine[Any, Any, ServiceResponse | EntityServiceResponse] | ServiceResponse | EntityServiceResponse | None], schema: VolSchemaType | None = None, supports_response: SupportsResponse = ..., job_type: HassJobType | None = None, *, description_placeholders: Mapping[str, str] | None = None) -> None: ...
    @callback
    def _async_register(self, domain: str, service: str, service_func: Callable[[ServiceCall], Coroutine[Any, Any, ServiceResponse | EntityServiceResponse] | ServiceResponse | EntityServiceResponse | None], schema: VolSchemaType | None = None, supports_response: SupportsResponse = ..., job_type: HassJobType | None = None, description_placeholders: Mapping[str, str] | None = None) -> None: ...
