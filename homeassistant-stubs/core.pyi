...
class State:
    ...
    _as_dict: Incomplete
    def __init__(self, entity_id: str, state: str, attributes: Mapping[str, Any] | None = ..., last_changed: datetime.datetime | None = ..., last_updated: datetime.datetime | None = ..., context: Context | None = ..., validate_entity_id: bool | None = ..., state_info: StateInfo | None = ...) -> None: ...
    @property
    def name(self) -> str: ...
...
class StateMachine:
    ...
    def async_set(self, entity_id: str, new_state: str, attributes: Mapping[str, Any] | None = ..., force_update: bool = ..., context: Context | None = ..., state_info: StateInfo | None = ...) -> None: ...
...
class Service:
    ...
    def __init__(self, func: Callable[[ServiceCall], Coroutine[Any, Any, ServiceResponse | EntityServiceResponse] | ServiceResponse | EntityServiceResponse | None], schema: vol.Schema | None, domain: str, service: str, context: Context | None = ..., supports_response: SupportsResponse = ...) -> None: ...
...
class ServiceRegistry:
    ...
    def register(self, domain: str, service: str, service_func: Callable[[ServiceCall], Coroutine[Any, Any, ServiceResponse] | ServiceResponse | None], schema: vol.Schema | None = ...) -> None: ...
    def async_register(self, domain: str, service: str, service_func: Callable[[ServiceCall], Coroutine[Any, Any, ServiceResponse | EntityServiceResponse] | ServiceResponse | EntityServiceResponse | None], schema: vol.Schema | None = ..., supports_response: SupportsResponse = ...) -> None: ...
