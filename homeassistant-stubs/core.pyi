...
class Context:
    ...
    id: str
    origin_event: Union[Event, None]
    def as_dict(self) -> dict[str, Union[str, None]]: ...
    def __init__(self, user_id, parent_id, id, origin_event) -> None: ...
...
class EventBus:
    ...
    def async_listen(self, event_type: str, listener: Callable[[Event], Union[None, Awaitable[None]]], event_filter: Union[Callable[[Event], bool], None] = ..., run_immediately: bool = ...) -> CALLBACK_TYPE: ...
