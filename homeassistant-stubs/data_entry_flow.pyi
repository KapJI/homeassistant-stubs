...
class AbortFlow(FlowError):
    ...
    def __init__(self, reason: str, description_placeholders: Mapping[str, str] | None = None, *, translation_domain: str | None = None) -> None: ...
...
class FlowManager(abc.ABC, Generic[_FlowContextT, _FlowResultT, _HandlerT], metaclass=abc.ABCMeta):
    ...
    def _abort_flow_result(self, flow: FlowHandler[_FlowContextT, _FlowResultT, _HandlerT], err: AbortFlow) -> _FlowResultT: ...
...
class FlowHandler(Generic[_FlowContextT, _FlowResultT, _HandlerT]):
    ...
    @callback
    def async_abort(self, *, reason: str, description_placeholders: Mapping[str, str] | None = None, translation_domain: str | None = None) -> _FlowResultT: ...
    @callback
