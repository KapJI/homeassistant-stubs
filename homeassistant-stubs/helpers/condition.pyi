...
from typing import Any, ClassVar, Final, Literal, Never, Protocol, TypedDict, Unpack, final, overload, override
...
class ConditionChecker(abc.ABC, metaclass=abc.ABCMeta):
    _set_up: bool
    _unloaded: bool
    _hass: Incomplete
    def __init__(self, hass: HomeAssistant) -> None: ...
    def __call__(self, hass: HomeAssistant, variables: TemplateVarsType = None) -> bool | None: ...
    ...
    @final
    def async_check(self, *, variables: TemplateVarsType = None, **kwargs: Never) -> bool | None: ...
    @abc.abstractmethod
...
async def async_from_config(hass: HomeAssistant, config: ConfigType) -> ConditionChecker: ...
async def async_and_from_config(hass: HomeAssistant, config: ConfigType) -> ConditionChecker: ...
...
async def async_validate_condition_config(hass: HomeAssistant, config: ConfigType | str) -> ConfigType: ...
async def async_validate_conditions_config(hass: HomeAssistant, conditions: list[ConfigType]) -> list[ConfigType | Template]: ...
async def async_conditions_from_config(hass: HomeAssistant, condition_configs: list[ConfigType], logger: logging.Logger, name: str) -> ConditionsChecker: ...
...
class ConditionsChecker:
    ...
    _name: Incomplete
    _unloaded: bool
    def __init__(self, conditions: list[ConditionChecker], logger: logging.Logger, name: str) -> None: ...
    def __call__(self, variables: TemplateVarsType = None) -> bool: ...
    def __del__(self) -> None: ...
    def async_unload(self) -> None: ...
    def async_check(self, *, variables: TemplateVarsType = None, **kwargs: Never) -> bool: ...
