...
def state(hass: HomeAssistant, entity: Union[None, str, State], req_state: Any, for_period: Union[timedelta, None] = ..., attribute: Union[str, None] = ..., variables: TemplateVarsType = ...) -> bool: ...
