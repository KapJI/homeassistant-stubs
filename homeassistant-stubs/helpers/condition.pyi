...
async def async_from_config(hass: HomeAssistant, config: Union[ConfigType, Template]) -> ConditionCheckerType: ...
...
async def async_validate_conditions_config(hass: HomeAssistant, conditions: list[Union[ConfigType, Template]]) -> list[Union[ConfigType, Template]]: ...
