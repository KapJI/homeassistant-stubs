...
class AbstractOAuth2FlowHandler(config_entries.ConfigFlow, metaclass=ABCMeta):
    ...
    @property
    def extra_authorize_data(self) -> dict: ...
    async def async_step_pick_implementation(self, user_input: Union[dict, None]=...) -> FlowResultDict: ...
    async def async_step_auth(self, user_input: Union[dict[str, Any], None]=...) -> FlowResultDict: ...
    async def async_step_creation(self, user_input: Union[dict[str, Any], None]=...) -> FlowResultDict: ...
