...
class AbstractOAuth2FlowHandler(config_entries.ConfigFlow, metaclass=ABCMeta):
    ...
    @property
    def extra_authorize_data(self) -> dict: ...
    async def async_step_pick_implementation(self, user_input: Optional[dict]=...) -> dict: ...
    async def async_step_auth(self, user_input: Optional[Dict[str, Any]]=...) -> Dict[str, Any]: ...
    async def async_step_creation(self, user_input: Optional[Dict[str, Any]]=...) -> Dict[str, Any]: ...
    ...
    async_step_dhcp: Any = ...
    @classmethod
    def async_register_implementation(cls: Any, hass: HomeAssistant, local_impl: LocalOAuth2Implementation) -> None: ...
...
def async_add_implementation_provider(hass: HomeAssistant, provider_domain: str, async_provide_implementation: Callable[[HomeAssistant, str], Awaitable[Optional[AbstractOAuth2Implementation]]]) -> None: ...
