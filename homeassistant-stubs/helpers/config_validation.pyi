...
from typing import Any, Callable, Dict, Hashable, List, Optional, Pattern, Type, TypeVar, Union
...
def deprecated(key: str, replacement_key: Optional[str]=..., default: Optional[Any]=...) -> Callable[[Dict], Dict]: ...
