...
@overload
def ensure_list(value: Union[list[_T], _T]) -> list[_T]: ...
...
def schema_with_slug_keys(value_schema: Union[_T, Callable], *, slug_validator: Callable[[Any], str] = ...) -> Callable: ...
...
class multi_select:
    options: Incomplete
    def __init__(self, options: Union[dict, list]) -> None: ...
