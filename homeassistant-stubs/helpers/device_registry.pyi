...
class DeviceEntry:
    ...
    def __init__(self, aliases, area_id, config_entries, configuration_url, connections, disabled_by, entry_type, hw_version, id, identifiers, manufacturer, model, name_by_user, name, suggested_area, sw_version, via_device_id, is_new) -> None: ...
