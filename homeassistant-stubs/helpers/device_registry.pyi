...
class DeviceRegistry:
    ...
    def async_update_device(self, device_id: str, *, area_id: Union[str, None, UndefinedType] = ..., manufacturer: Union[str, None, UndefinedType] = ..., model: Union[str, None, UndefinedType] = ..., name: Union[str, None, UndefinedType] = ..., name_by_user: Union[str, None, UndefinedType] = ..., new_identifiers: Union[set[tuple[str, str]], UndefinedType] = ..., sw_version: Union[str, None, UndefinedType] = ..., via_device_id: Union[str, None, UndefinedType] = ..., add_config_entry_id: Union[str, UndefinedType] = ..., remove_config_entry_id: Union[str, UndefinedType] = ..., disabled_by: Union[str, None, UndefinedType] = ..., suggested_area: Union[str, None, UndefinedType] = ...) -> Union[DeviceEntry, None]: ...
