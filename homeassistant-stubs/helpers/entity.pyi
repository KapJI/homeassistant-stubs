...
def get_device_class_or_undefined(hass: HomeAssistant, entity_id: str) -> str | UndefinedType | None: ...
...
class Entity(cached_properties=CACHED_PROPERTIES_WITH_ATTR_, metaclass=ABCCachedProperties):
    ...
    def __async_calculate_state(self) -> tuple[str, dict[str, Any], str | None, Mapping[str, Any] | None, str | None, int | None]: ...
    @callback
