...
def generate_entity_id(entity_id_format: str, name: Optional[str], current_ids: Optional[List[str]]=..., hass: Optional[HomeAssistant]=...) -> str: ...
def async_generate_entity_id(entity_id_format: str, name: Optional[str], current_ids: Optional[Iterable[str]]=..., hass: Optional[HomeAssistant]=...) -> str: ...

class Entity(ABC):
    entity_id: str = ...
    hass: Optional[HomeAssistant] = ...
    platform: Optional[EntityPlatform] = ...
