...
class EntityComponent:
    ...
    def get_entity(self, entity_id: str) -> Union[_EntityT, None]: ...
    ...
    def async_register_entity_service(self, name: str, schema: Union[dict[Union[str, vol.Marker], Any], vol.Schema], func: Union[str, Callable[..., Any]], required_features: Union[list[int], None] = ...) -> None: ...
