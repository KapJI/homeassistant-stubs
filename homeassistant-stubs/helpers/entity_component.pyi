...
class EntityComponent:
    ...
    def async_register_entity_service(self, name: str, schema: Union[Dict[str, Any], vol.Schema], func: Union[str, Callable[..., Any]], required_features: Optional[List[int]]=...) -> None: ...
    async def async_setup_platform(self, platform_type: str, platform_config: ConfigType, discovery_info: Optional[DiscoveryInfoType]=...) -> None: ...
    async def async_remove_entity(self, entity_id: str) -> None: ...
    async def async_prepare_reload(self, *, skip_reset: bool=...) -> Optional[ConfigType]: ...
