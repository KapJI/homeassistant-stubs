...
class EntityComponent[_EntityT: entity.Entity = entity.Entity]:
    ...
    @callback
    def async_register_entity_service(self, name: str, schema: VolDictType | VolSchemaType | None, func: str | Callable[..., Any], required_features: list[int] | None = None, supports_response: SupportsResponse = ..., *, admin_only: bool = False, description_placeholders: Mapping[str, str] | None = None) -> None: ...
    @callback
