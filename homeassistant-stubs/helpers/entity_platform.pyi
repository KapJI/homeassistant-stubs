...
from homeassistant.core import CALLBACK_TYPE as CALLBACK_TYPE, CoreState as CoreState, EntityServiceResponse as EntityServiceResponse, HomeAssistant as HomeAssistant, ServiceCall as ServiceCall, SupportsResponse as SupportsResponse, callback as callback, split_entity_id as split_entity_id, valid_entity_id as valid_entity_id
...
class EntityPlatform:
    ...
    def async_register_entity_service(self, name: str, schema: dict[str | vol.Marker, Any] | vol.Schema, func: str | Callable[..., Any], required_features: Iterable[int] | None = ..., supports_response: SupportsResponse = ...) -> None: ...
