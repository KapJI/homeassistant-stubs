...
@callback
def _async_get_full_entity_name(hass: HomeAssistant, *, device_id: str | None, fallback: str, has_entity_name: bool, name: str | None, original_name: str | None, original_name_unprefixed: str | None | UndefinedType = ..., overridden_name: str | None = None, unprefix_name: bool = False, use_legacy_naming: bool = False) -> str: ...
@callback
...
class EntityRegistry(BaseRegistry):
    ...
    def _async_generate_entity_id(self, *, current_entity_id: str | None, device_id: str | None, domain: str, has_entity_name: bool, name: str | None, object_id_base: str | None, platform: str, reserved_entity_ids: set[str] | None = None, suggested_object_id: str | None, unique_id: str) -> str: ...
    @callback
