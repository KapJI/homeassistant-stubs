...
class EntityRegistry:
    ...
    def async_get_or_create(self, domain: str, platform: str, unique_id: str, *, suggested_object_id: Union[str, None] = ..., known_object_ids: Union[Iterable[str], None] = ..., disabled_by: Union[str, None] = ..., config_entry: Union[ConfigEntry, None] = ..., device_id: Union[str, None] = ..., area_id: Union[str, None] = ..., capabilities: Union[Mapping[str, Any], None] = ..., supported_features: Union[int, None] = ..., device_class: Union[str, None] = ..., unit_of_measurement: Union[str, None] = ..., original_name: Union[str, None] = ..., original_icon: Union[str, None] = ..., entity_category: Union[str, None] = ...) -> RegistryEntry: ...
    def async_remove(self, entity_id: str) -> None: ...
    def async_device_modified(self, event: Event) -> None: ...
    def async_update_entity(self, entity_id: str, *, name: Union[str, None, UndefinedType] = ..., icon: Union[str, None, UndefinedType] = ..., config_entry_id: Union[str, None, UndefinedType] = ..., area_id: Union[str, None, UndefinedType] = ..., new_entity_id: Union[str, UndefinedType] = ..., new_unique_id: Union[str, UndefinedType] = ..., disabled_by: Union[str, None, UndefinedType] = ...) -> RegistryEntry: ...
    def _async_update_entity(self, entity_id: str, *, name: Union[str, None, UndefinedType] = ..., icon: Union[str, None, UndefinedType] = ..., config_entry_id: Union[str, None, UndefinedType] = ..., new_entity_id: Union[str, UndefinedType] = ..., device_id: Union[str, None, UndefinedType] = ..., area_id: Union[str, None, UndefinedType] = ..., new_unique_id: Union[str, UndefinedType] = ..., disabled_by: Union[str, None, UndefinedType] = ..., capabilities: Union[Mapping[str, Any], None, UndefinedType] = ..., supported_features: Union[int, UndefinedType] = ..., device_class: Union[str, None, UndefinedType] = ..., unit_of_measurement: Union[str, None, UndefinedType] = ..., original_name: Union[str, None, UndefinedType] = ..., original_icon: Union[str, None, UndefinedType] = ..., entity_category: Union[str, None, UndefinedType] = ...) -> RegistryEntry: ...
