...
class RegistryEntry:
    ...
    def __init__(self, entity_id, unique_id, platform, name, icon, device_id, area_id, config_entry_id, disabled_by, capabilities, supported_features, device_class, unit_of_measurement, original_name, original_icon, entity_category, domain) -> None: ...
...
class EntityRegistry:
    ...
    def async_get_or_create(self, domain: str, platform: str, unique_id: str, *, known_object_ids: Union[Iterable[str], None] = ..., suggested_object_id: Union[str, None] = ..., disabled_by: Union[str, None] = ..., area_id: Union[str, None] = ..., capabilities: Union[Mapping[str, Any], None] = ..., config_entry: Union[ConfigEntry, None] = ..., device_class: Union[str, None] = ..., device_id: Union[str, None] = ..., entity_category: Union[str, None] = ..., original_icon: Union[str, None] = ..., original_name: Union[str, None] = ..., supported_features: Union[int, None] = ..., unit_of_measurement: Union[str, None] = ...) -> RegistryEntry: ...
    def async_remove(self, entity_id: str) -> None: ...
    def async_device_modified(self, event: Event) -> None: ...
    def async_update_entity(self, entity_id: str, *, area_id: Union[str, None, UndefinedType] = ..., config_entry_id: Union[str, None, UndefinedType] = ..., device_class: Union[str, None, UndefinedType] = ..., disabled_by: Union[str, None, UndefinedType] = ..., entity_category: Union[str, None, UndefinedType] = ..., icon: Union[str, None, UndefinedType] = ..., name: Union[str, None, UndefinedType] = ..., new_entity_id: Union[str, UndefinedType] = ..., new_unique_id: Union[str, UndefinedType] = ..., original_icon: Union[str, None, UndefinedType] = ..., original_name: Union[str, None, UndefinedType] = ..., unit_of_measurement: Union[str, None, UndefinedType] = ...) -> RegistryEntry: ...
    def _async_update_entity(self, entity_id: str, *, area_id: Union[str, None, UndefinedType] = ..., capabilities: Union[Mapping[str, Any], None, UndefinedType] = ..., config_entry_id: Union[str, None, UndefinedType] = ..., device_class: Union[str, None, UndefinedType] = ..., device_id: Union[str, None, UndefinedType] = ..., disabled_by: Union[str, None, UndefinedType] = ..., entity_category: Union[str, None, UndefinedType] = ..., icon: Union[str, None, UndefinedType] = ..., name: Union[str, None, UndefinedType] = ..., new_entity_id: Union[str, UndefinedType] = ..., new_unique_id: Union[str, UndefinedType] = ..., original_icon: Union[str, None, UndefinedType] = ..., original_name: Union[str, None, UndefinedType] = ..., supported_features: Union[int, UndefinedType] = ..., unit_of_measurement: Union[str, None, UndefinedType] = ...) -> RegistryEntry: ...
