...
from collections.abc import Callable as Callable, Hashable, KeysView, Mapping, Sequence
from dataclasses import dataclass
from datetime import datetime
from enum import Enum, StrEnum
from homeassistant.config_entries import ConfigEntry as ConfigEntry
from homeassistant.const import EVENT_HOMEASSISTANT_START as EVENT_HOMEASSISTANT_START, EVENT_HOMEASSISTANT_STOP as EVENT_HOMEASSISTANT_STOP, EntityCategory as EntityCategory, EntityStateAttribute as EntityStateAttribute, MAX_LENGTH_STATE_DOMAIN as MAX_LENGTH_STATE_DOMAIN, MAX_LENGTH_STATE_ENTITY_ID as MAX_LENGTH_STATE_ENTITY_ID, Platform as Platform, STATE_UNAVAILABLE as STATE_UNAVAILABLE
...
class EntityRegistrySettings:
    entity_id_parts: tuple[EntityNamePart, ...] | None = ...
...
@callback
def _async_get_full_entity_name(hass: HomeAssistant, *, area_id: str | None, device_id: str | None, fallback: str, has_entity_name: bool, name: str | None, original_name: str | None, original_name_unprefixed: str | UndefinedType | None = ..., overridden_name: str | None = None, parts: Sequence[EntityNamePart], unprefix_name: bool = False, use_legacy_naming: bool = False) -> str: ...
@callback
def async_get_full_entity_name(hass: HomeAssistant, entry: RegistryEntry, original_name: str | UndefinedType | None = ...) -> str: ...
@callback
...
class DeletedRegistryEntry:
    ...
    @under_cached_property
    def as_storage_fragment(self) -> json_fragment: ...
    def __init__(self, entity_id, unique_id, platform, aliases, area_id, categories, config_entry_id, config_subentry_id, created_at, device_class, disabled_by, domain, hidden_by, icon, id, labels, modified_at, name, options, orphaned_timestamp, compat_aliases, cache) -> None: ...
    def __lt__(self, other): ...
    def __le__(self, other): ...
    def __gt__(self, other): ...
    def __ge__(self, other): ...
...
class EntityRegistryStore(storage.Store[dict[str, Any]]):
    @override
    async def _async_migrate_func(self, old_major_version: int, old_minor_version: int, old_data: dict[str, Any]) -> dict: ...
...
class EntityRegistryItems(BaseRegistryItems[RegistryEntry]):
    ...
    _config_entry_id_enabled_count: dict[str, int]
...
class EntityRegistry(BaseRegistry):
    ...
    @callback
    def async_get_available_entity_id(self, domain: str, suggested_object_id: str, *, current_entity_id: str | None = None, reserved_entity_ids: set[str] | None = None) -> str: ...
    def _async_generate_entity_id(self, *, area_id: str | None = None, current_entity_id: str | None, device_id: str | None, domain: str, has_entity_name: bool, name: str | None, object_id_base: str | None, platform: str, reserved_entity_ids: set[str] | None = None, suggested_object_id: str | None, unique_id: str) -> str: ...
    @callback
    def async_regenerate_entity_id(self, entry: RegistryEntry, *, reserved_entity_ids: set[str] | None = None) -> str: ...
    @callback
    def async_get_or_create(self, domain: str, platform: str, unique_id: str, *, object_id_base: str | UndefinedType | None = ..., suggested_object_id: str | UndefinedType | None = ..., disabled_by: RegistryEntryDisabler | None = None, hidden_by: RegistryEntryHider | None = None, get_initial_options: Callable[[], EntityOptionsType | None] | None = None, capabilities: Mapping[str, Any] | UndefinedType | None = ..., config_entry: ConfigEntry | UndefinedType | None = ..., config_subentry_id: str | UndefinedType | None = ..., device_id: str | UndefinedType | None = ..., entity_category: EntityCategory | UndefinedType | None = ..., has_entity_name: bool | UndefinedType = ..., original_device_class: str | UndefinedType | None = ..., original_icon: str | UndefinedType | None = ..., original_name: str | UndefinedType | None = ..., supported_features: int | UndefinedType | None = ..., translation_key: str | UndefinedType | None = ..., unit_of_measurement: str | UndefinedType | None = ...) -> RegistryEntry: ...
    @callback
    def async_remove(self, entity_id: str) -> None: ...
    @callback
    def async_device_modified(self, event: Event[EventDeviceRegistryUpdatedData]) -> None: ...
    @callback
    def _ignore_composite_device_id(self, platform: str, device_id: str | UndefinedType | None) -> str | UndefinedType | None: ...
    @callback
    def _async_update_entity(self, entity_id: str, *, aliases: list[AliasEntry] | UndefinedType = ..., area_id: str | UndefinedType | None = ..., categories: dict[str, str] | UndefinedType = ..., capabilities: Mapping[str, Any] | UndefinedType | None = ..., config_entry_id: str | UndefinedType | None = ..., config_subentry_id: str | UndefinedType | None = ..., device_class: str | UndefinedType | None = ..., device_id: str | UndefinedType | None = ..., disabled_by: RegistryEntryDisabler | UndefinedType | None = ..., entity_category: EntityCategory | UndefinedType | None = ..., hidden_by: RegistryEntryHider | UndefinedType | None = ..., icon: str | UndefinedType | None = ..., has_entity_name: bool | UndefinedType = ..., labels: set[str] | UndefinedType = ..., name: str | UndefinedType | None = ..., new_entity_id: str | UndefinedType = ..., new_unique_id: str | UndefinedType = ..., object_id_base: str | UndefinedType | None = ..., options: EntityOptionsType | UndefinedType = ..., original_device_class: str | UndefinedType | None = ..., original_icon: str | UndefinedType | None = ..., original_name: str | UndefinedType | None = ..., original_name_unprefixed: str | UndefinedType | None = ..., platform: str | UndefinedType | None = ..., suggested_object_id: str | UndefinedType | None = ..., supported_features: int | UndefinedType = ..., translation_key: str | UndefinedType | None = ..., unit_of_measurement: str | UndefinedType | None = ...) -> RegistryEntry: ...
    @callback
    def async_update_entity(self, entity_id: str, *, aliases: list[AliasEntry] | UndefinedType = ..., area_id: str | UndefinedType | None = ..., categories: dict[str, str] | UndefinedType = ..., capabilities: Mapping[str, Any] | UndefinedType | None = ..., config_entry_id: str | UndefinedType | None = ..., config_subentry_id: str | UndefinedType | None = ..., device_class: str | UndefinedType | None = ..., device_id: str | UndefinedType | None = ..., disabled_by: RegistryEntryDisabler | UndefinedType | None = ..., entity_category: EntityCategory | UndefinedType | None = ..., hidden_by: RegistryEntryHider | UndefinedType | None = ..., icon: str | UndefinedType | None = ..., has_entity_name: bool | UndefinedType = ..., labels: set[str] | UndefinedType = ..., name: str | UndefinedType | None = ..., new_entity_id: str | UndefinedType = ..., new_unique_id: str | UndefinedType = ..., original_device_class: str | UndefinedType | None = ..., original_icon: str | UndefinedType | None = ..., original_name: str | UndefinedType | None = ..., supported_features: int | UndefinedType = ..., translation_key: str | UndefinedType | None = ..., unit_of_measurement: str | UndefinedType | None = ...) -> RegistryEntry: ...
    @callback
    def async_update_entity_platform(self, entity_id: str, new_platform: str, *, new_config_entry_id: str | UndefinedType = ..., new_config_subentry_id: str | UndefinedType = ..., new_unique_id: str | UndefinedType = ..., new_device_id: str | UndefinedType | None = ...) -> RegistryEntry: ...
    @callback
    def async_update_entity_options(self, entity_id: str, domain: str, options: Mapping[str, Any] | None) -> RegistryEntry: ...
    @callback
    def async_update_settings(self, *, entity_id_parts: list[EntityNamePart] | UndefinedType | None = ...) -> EntityRegistrySettings: ...
    @override
...
@callback
def async_get_effective_area_id(hass: HomeAssistant, entry: RegistryEntry) -> str | None: ...
@callback
