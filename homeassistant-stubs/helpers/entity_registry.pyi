...
@callback
def _async_get_full_entity_name(hass: HomeAssistant, *, area_id: str | None | UndefinedType = ..., device_id: str | None, fallback: str, has_entity_name: bool, name: str | None, original_name: str | None, original_name_unprefixed: str | None | UndefinedType = ..., overridden_name: str | None = None, unprefix_name: bool = False, use_legacy_naming: bool = False) -> str: ...
@callback
