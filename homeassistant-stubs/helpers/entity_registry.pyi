...
@callback
def _async_get_full_entity_name(hass: HomeAssistant, *, device_id: str | None, fallback: str, has_entity_name: bool, name: str | None, original_name: str | None, overridden_name: str | None = None) -> str: ...
...
class EntityRegistry(BaseRegistry):
    ...
    @callback
    def async_generate_full_name(self, entry: RegistryEntry, original_name: str | None | UndefinedType = ...) -> str: ...
    @callback
