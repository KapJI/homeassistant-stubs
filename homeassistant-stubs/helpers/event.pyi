...
def _remove_listener(hass: HomeAssistant, listeners_key: str, keys: Iterable[str], job: HassJob[[Event[_TypedDictT]], Any], callbacks: dict[str, list[HassJob[[Event[_TypedDictT]], Any]]]) -> None: ...
...
class _TrackTimeInterval:
    ...
    def async_cancel(self) -> None: ...
    def __init__(self, hass, seconds, job_name, action, cancel_on_shutdown, _track_job, _run_job, _cancel_callback) -> None: ...
...
def process_state_match(parameter: None | str | Iterable[str], invert: bool = False) -> Callable[[str | None], bool]: ...
