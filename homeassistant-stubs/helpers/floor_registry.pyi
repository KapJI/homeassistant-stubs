...
class FloorRegistry(BaseRegistry[FloorRegistryStoreData]):
    ...
    @callback
    def async_update(self, floor_id: str, *, aliases: set[str] | UndefinedType = ..., icon: str | UndefinedType | None = ..., level: int | UndefinedType = ..., name: str | UndefinedType = ...) -> FloorEntry: ...
    @callback
