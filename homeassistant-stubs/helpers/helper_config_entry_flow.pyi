...
class HelperFlowFormStep:
    schema: Union[vol.Schema, Callable[[Union[HelperConfigFlowHandler, HelperOptionsFlowHandler], dict[str, Any]], Union[vol.Schema, None]], None]
    validate_user_input: Callable[[dict[str, Any]], dict[str, Any]]
    next_step: Callable[[dict[str, Any]], Union[str, None]]
    update_form_schema: Callable[[Union[HelperConfigFlowHandler, HelperOptionsFlowHandler], vol.Schema, dict[str, Any]], vol.Schema]
...
class HelperCommonFlowHandler:
    ...
    _handler: Any
    _options: Any
    def __init__(self, handler: Union[HelperConfigFlowHandler, HelperOptionsFlowHandler], flow: dict[str, Union[HelperFlowFormStep, HelperFlowMenuStep]], config_entry: Union[config_entries.ConfigEntry, None]) -> None: ...
    async def async_step(self, step_id: str, user_input: Union[dict[str, Any], None] = ...) -> FlowResult: ...
    def _get_schema(self, form_step: HelperFlowFormStep, options: dict[str, Any]) -> Union[vol.Schema, None]: ...
    async def _async_form_step(self, step_id: str, user_input: Union[dict[str, Any], None] = ...) -> FlowResult: ...
    def _show_next_step(self, next_step_id: str, error: Union[HelperFlowError, None] = ..., user_input: Union[dict[str, Any], None] = ...) -> FlowResult: ...
    async def _async_menu_step(self, step_id: str, user_input: Union[dict[str, Any], None] = ...) -> FlowResult: ...

class HelperConfigFlowHandler(config_entries.ConfigFlow, metaclass=abc.ABCMeta):
    config_flow: dict[str, Union[HelperFlowFormStep, HelperFlowMenuStep]]
    options_flow: Union[dict[str, Union[HelperFlowFormStep, HelperFlowMenuStep]], None]
    VERSION: int
...
def entity_selector_without_own_entities(handler: HelperOptionsFlowHandler, entity_selector_config: dict[str, Any]) -> vol.Schema: ...
