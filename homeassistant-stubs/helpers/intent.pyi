...
class NoStatesMatchedError(IntentError):
    ...
    def __init__(self, name: str | None = None, area: str | None = None, floor: str | None = None, domains: set[str] | None = None, device_classes: set[str] | None = None) -> None: ...
...
def _find_floor(id_or_name: str, floors: floor_registry.FloorRegistry) -> floor_registry.FloorEntry | None: ...
def _filter_by_areas(states_and_entities: list[tuple[State, entity_registry.RegistryEntry | None]], areas: Iterable[area_registry.AreaEntry], devices: device_registry.DeviceRegistry) -> Iterable[tuple[State, entity_registry.RegistryEntry | None]]: ...
