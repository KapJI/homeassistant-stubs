...
from . import area_registry as area_registry, entity_registry as entity_registry
...
def async_match_states(hass: HomeAssistant, name: Union[str, None] = ..., area_name: Union[str, None] = ..., area: Union[area_registry.AreaEntry, None] = ..., domains: Union[Collection[str], None] = ..., device_classes: Union[Collection[str], None] = ..., states: Union[Iterable[State], None] = ..., entities: Union[entity_registry.EntityRegistry, None] = ..., areas: Union[area_registry.AreaRegistry, None] = ...) -> Iterable[State]: ...
