...
from . import area_registry as ar, device_registry as dr, entity_registry as er, floor_registry as fr
...
def _filter_by_name(hass: HomeAssistant, name: str, candidates: Iterable[MatchTargetsCandidate]) -> Iterable[MatchTargetsCandidate]: ...
...
def _add_areas(areas: ar.AreaRegistry, devices: dr.DeviceRegistry, candidates: Iterable[MatchTargetsCandidate]) -> None: ...
...
class ServiceIntentHandler(DynamicServiceIntentHandler):
    domain: Incomplete
    service: Incomplete
    def __init__(self, intent_type: str, domain: str, service: str, *, required_slots: _IntentSlotsType | None = None, optional_slots: _IntentSlotsType | None = None, required_domains: set[str] | None = None, required_features: int | None = None, required_states: set[str] | None = None, description: str | None = None, platforms: set[str] | None = None, device_classes: set[type[StrEnum]] | None = None) -> None: ...
    def get_domain_and_service(self, intent_obj: Intent, state: State) -> tuple[str, str]: ...
...
@callback
def async_get_entity_aliases(hass: HomeAssistant, entity_entry: er.RegistryEntry | None, *, state: State, allow_empty: bool = True) -> list[str]: ...
