...
class LabelRegistry(BaseRegistry[LabelRegistryStoreData]):
    ...
    @callback
    def async_update(self, label_id: str, *, color: str | UndefinedType | None = ..., description: str | UndefinedType | None = ..., icon: str | UndefinedType | None = ..., name: str | UndefinedType = ...) -> LabelEntry: ...
    @override
...
@callback
def async_get_missing_label_ids(hass: HomeAssistant, label_ids: Iterable[str]) -> set[str]: ...
