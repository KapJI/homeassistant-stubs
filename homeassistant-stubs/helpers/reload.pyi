...
from homeassistant.const import Platform as Platform, SERVICE_RELOAD as SERVICE_RELOAD
...
async def async_reload_integration_platforms(hass: HomeAssistant, integration_domain: str, platform_domains: Iterable[Platform]) -> None: ...
async def _resetup_platform(hass: HomeAssistant, integration_domain: str, platform_domain: Platform, unprocessed_config: ConfigType) -> None: ...
async def _async_setup_platform(hass: HomeAssistant, integration_domain: str, platform_domain: Platform, platform_configs: list[dict[str, Any]]) -> None: ...
...
@callback
def async_get_platform_without_config_entry(hass: HomeAssistant, integration_name: str, integration_platform_name: Platform) -> EntityPlatform | None: ...
async def async_setup_reload_service(hass: HomeAssistant, domain: str, platforms: Iterable[Platform]) -> None: ...
def setup_reload_service(hass: HomeAssistant, domain: str, platforms: Iterable[Platform]) -> None: ...
