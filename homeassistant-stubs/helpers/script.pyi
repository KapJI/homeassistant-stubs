...
class _ScriptRun:
    ...
    def _handle_exception(self, trace_element: TraceElement, exception: Exception, continue_on_error: bool, log_exceptions: bool) -> None: ...
    def _log_exception(self, exception: Exception) -> None: ...
    async def _async_run_long_action[_T](self, long_task: asyncio.Task[_T]) -> _T | None: ...
    ...
    def _test_conditions(self, conditions: list[ConditionChecker], name: str, condition_path: str | None = None) -> bool | None: ...
    async def _async_step_choose(self) -> None: ...
    async def _async_step_condition(self) -> None: ...
    async def _async_step_if(self) -> None: ...
    async def _async_do_step_repeat(self) -> None: ...
...
class Script:
    ...
    _condition_cache: dict[frozenset[tuple[str, str]], ConditionChecker]
