...
async def _resolve_entity_service_call_entities(hass: HomeAssistant, registered_entities: Mapping[str, Entity] | Callable[[], Mapping[str, Entity]], call: ServiceCall, required_features: Iterable[int] | None = None, entity_device_classes: Iterable[str | None] | None = None) -> list[Entity] | None: ...
...
async def entity_service_call(hass: HomeAssistant, registered_entities: Mapping[str, Entity] | Callable[[], Mapping[str, Entity]], func: str | HassJob, call: ServiceCall, required_features: Iterable[int] | None = None, *, entity_device_classes: Iterable[str | None] | None = None) -> EntityServiceResponse | None: ...
...
@callback
def async_register_entity_service(hass: HomeAssistant, domain: str, name: str, *, description_placeholders: Mapping[str, str] | None = None, entity_device_classes: Iterable[str | None] | None = None, entities: Mapping[str, Entity], func: str | Callable[..., Any], job_type: HassJobType | None, required_features: Iterable[int] | None = None, schema: VolDictType | VolSchemaType | None, supports_response: SupportsResponse = ...) -> None: ...
@callback
