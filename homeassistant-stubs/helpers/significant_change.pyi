...
CheckTypeFunc = Callable[[HomeAssistant, str, dict | MappingProxyType, str, dict | MappingProxyType], bool | None]
ExtraCheckTypeFunc = Callable[[HomeAssistant, str, dict | MappingProxyType, Any, str, dict | MappingProxyType, Any], bool | None]
