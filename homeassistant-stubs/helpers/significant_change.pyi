...
async def create_checker(hass: HomeAssistant, _domain: str, extra_significant_check: Optional[ExtraCheckTypeFunc]=...) -> SignificantlyChangedChecker: ...
def either_one_none(val1: Optional[Any], val2: Optional[Any]) -> bool: ...
def check_numeric_changed(val1: Optional[Union[int, float]], val2: Optional[Union[int, float]], change: Union[int, float]) -> bool: ...

class SignificantlyChangedChecker:
    hass: Any = ...
    last_approved_entities: Any = ...
    extra_significant_check: Any = ...
    def __init__(self, hass: HomeAssistant, extra_significant_check: Optional[ExtraCheckTypeFunc]=...) -> None: ...
    def async_is_significant_change(self, new_state: State, *, extra_arg: Optional[Any]=...) -> bool: ...
