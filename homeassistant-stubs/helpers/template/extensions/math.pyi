...
class MathExtension(BaseTemplateExtension):
    ...
    @staticmethod
    def add(value: Any, amount: Any, default: Any = ...) -> Any: ...
    @staticmethod
    def multiply(value: Any, amount: Any, default: Any = ...) -> Any: ...
    @staticmethod
    def forgiving_round(value: Any, precision: int = 0, method: str = 'common', default: Any = ...) -> Any: ...
    @staticmethod
