...
def make_entity_numerical_state_changed_trigger(domain_specs: Mapping[str, DomainSpec], valid_unit: str | None | UndefinedType = ...) -> type[EntityNumericalStateChangedTriggerBase]: ...
def make_entity_numerical_state_crossed_threshold_trigger(domain_specs: Mapping[str, DomainSpec], valid_unit: str | None | UndefinedType = ...) -> type[EntityNumericalStateCrossedThresholdTriggerBase]: ...
