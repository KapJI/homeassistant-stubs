...
from homeassistant.const import ATTR_ENTITY_ID as ATTR_ENTITY_ID, CONF_ALIAS as CONF_ALIAS, CONF_AT as CONF_AT, CONF_DEVICE_ID as CONF_DEVICE_ID, CONF_ENABLED as CONF_ENABLED, CONF_ENTITY_ID as CONF_ENTITY_ID, CONF_EVENT_DATA as CONF_EVENT_DATA, CONF_FOR as CONF_FOR, CONF_ID as CONF_ID, CONF_OPTIONS as CONF_OPTIONS, CONF_PLATFORM as CONF_PLATFORM, CONF_SELECTOR as CONF_SELECTOR, CONF_TARGET as CONF_TARGET, CONF_VARIABLES as CONF_VARIABLES, CONF_ZONE as CONF_ZONE, EntityStateAttribute as EntityStateAttribute, STATE_UNAVAILABLE as STATE_UNAVAILABLE, STATE_UNKNOWN as STATE_UNKNOWN
...
def make_entity_numerical_state_changed_trigger(domain_specs: Mapping[str, DomainSpec], valid_unit: str | UndefinedType | None = ..., *, primary_entities_only: bool = True) -> type[EntityNumericalStateChangedTriggerBase]: ...
def make_entity_numerical_state_crossed_threshold_trigger(domain_specs: Mapping[str, DomainSpec], valid_unit: str | UndefinedType | None = ..., *, primary_entities_only: bool = True) -> type[EntityNumericalStateCrossedThresholdTriggerBase]: ...
