...
from homeassistant.util.yaml import clear_secret_cache as clear_secret_cache
...
async def async_setup_hass(runtime_config: RuntimeConfig) -> Optional[core.HomeAssistant]: ...
def open_hass_ui(hass: core.HomeAssistant) -> None: ...
async def async_from_config_dict(config: ConfigType, hass: core.HomeAssistant) -> Optional[core.HomeAssistant]: ...
def async_enable_logging(hass: core.HomeAssistant, verbose: bool=..., log_rotate_days: Optional[int]=..., log_file: Optional[str]=..., log_no_color: bool=...) -> None: ...
