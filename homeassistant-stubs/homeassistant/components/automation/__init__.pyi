from .config import PLATFORM_SCHEMA as PLATFORM_SCHEMA, async_validate_config_item as async_validate_config_item
from .const import CONF_ACTION as CONF_ACTION, CONF_INITIAL_STATE as CONF_INITIAL_STATE, CONF_TRIGGER as CONF_TRIGGER, CONF_TRIGGER_VARIABLES as CONF_TRIGGER_VARIABLES, DEFAULT_INITIAL_STATE as DEFAULT_INITIAL_STATE, DOMAIN as DOMAIN, LOGGER as LOGGER
...
from homeassistant.helpers.script import ATTR_CUR as ATTR_CUR, ATTR_MAX as ATTR_MAX, ATTR_MODE as ATTR_MODE, CONF_MAX as CONF_MAX, CONF_MAX_EXCEEDED as CONF_MAX_EXCEEDED, Script as Script
...
class AutomationEntity(ToggleEntity, RestoreEntity):
    action_script: Any = ...
    def __init__(self, automation_id: Any, name: Any, trigger_config: Any, cond_func: Any, action_script: Any, initial_state: Any, variables: Any, trigger_variables: Any) -> None: ...
    @property
    def name(self): ...
    @property
    def unique_id(self): ...
    ...
    async def async_trigger(self, run_variables: Any, context: Optional[Any] = ..., skip_condition: bool = ...) -> None: ...
    async def async_will_remove_from_hass(self) -> None: ...
    async def async_enable(self) -> None: ...
    async def async_disable(self, stop_actions: Any = ...) -> None: ...
    @property
