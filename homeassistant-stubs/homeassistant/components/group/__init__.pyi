...
from homeassistant.core import CoreState as CoreState, callback as callback, split_entity_id as split_entity_id
...
def get_entity_ids(hass: HomeAssistantType, entity_id: str, domain_filter: Optional[str]=...) -> List[str]: ...
