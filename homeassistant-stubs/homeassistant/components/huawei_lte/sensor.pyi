...
from homeassistant.components.sensor import DEVICE_CLASS_BATTERY as DEVICE_CLASS_BATTERY, DEVICE_CLASS_SIGNAL_STRENGTH as DEVICE_CLASS_SIGNAL_STRENGTH
...
from homeassistant.helpers.typing import HomeAssistantType as HomeAssistantType, StateType as StateType
...
class SensorMeta(NamedTuple):
    ...
    formatter: Optional[Callable[[str], Tuple[StateType, Optional[str]]]] = ...
...
class HuaweiLteSensor(HuaweiLteBaseEntity):
    ...
    def __init__(self, router: Any, available: Any, unsub_handlers: Any, key: Any, item: Any, meta: Any, state: Any, unit: Any) -> None: ...
