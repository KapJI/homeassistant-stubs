...
class MediaPlayerEntity(Entity):
    ...
    async def async_get_browse_image(self, media_content_type: str, media_content_id: str, media_image_id: Optional[str]=...) -> Tuple[Optional[str], Optional[str]]: ...
    @property
    ...
    async def async_browse_media(self, media_content_type: Optional[str]=..., media_content_id: Optional[str]=...) -> BrowseMedia: ...
    def get_browse_image_url(self, media_content_type: str, media_content_id: str, media_image_id: Optional[str]=...) -> str: ...
...
class MediaPlayerImageView(HomeAssistantView):
    ...
    async def get(self, request: web.Request, entity_id: str, media_content_type: Optional[str]=..., media_content_id: Optional[str]=...) -> web.Response: ...
...
class BrowseMedia:
    ...
    thumbnail: Any = ...
    def __init__(self, media_class: str, media_content_id: str, media_content_type: str, title: str, can_play: bool, can_expand: bool, *, children: Optional[List[BrowseMedia]]=..., children_media_class: Optional[str]=..., thumbnail: Optional[str]=...) -> None: ...
