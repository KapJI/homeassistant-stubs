...
def create(hass: Any, message: Any, title: Optional[Any] = ..., notification_id: Optional[Any] = ...) -> None: ...
def dismiss(hass: Any, notification_id: Any) -> None: ...
def async_create(hass: HomeAssistant, message: str, title: Optional[str]=..., notification_id: Optional[str]=...) -> None: ...
