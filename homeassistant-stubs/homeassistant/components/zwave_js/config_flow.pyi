...
class ConfigFlow(config_entries.ConfigFlow):
    ...
    async def async_step_manual(self, user_input: Optional[Dict[str, Any]]=...) -> Dict[str, Any]: ...
    async def async_step_hassio(self, discovery_info: Dict[str, Any]) -> Dict[str, Any]: ...
    async def async_step_hassio_confirm(self, user_input: Optional[Dict[str, Any]]=...) -> Dict[str, Any]: ...
    async def async_step_on_supervisor(self, user_input: Optional[Dict[str, Any]]=...) -> Dict[str, Any]: ...
    async def async_step_install_addon(self, user_input: Optional[Dict[str, Any]]=...) -> Dict[str, Any]: ...
    async def async_step_install_failed(self, user_input: Optional[Dict[str, Any]]=...) -> Dict[str, Any]: ...
    async def async_step_configure_addon(self, user_input: Optional[Dict[str, Any]]=...) -> Dict[str, Any]: ...
    async def async_step_start_addon(self, user_input: Optional[Dict[str, Any]]=...) -> Dict[str, Any]: ...
    async def async_step_start_failed(self, user_input: Optional[Dict[str, Any]]=...) -> Dict[str, Any]: ...
    async def async_step_finish_addon_setup(self, user_input: Optional[Dict[str, Any]]=...) -> Dict[str, Any]: ...
