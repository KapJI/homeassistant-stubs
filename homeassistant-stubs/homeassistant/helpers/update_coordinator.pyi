...
class DataUpdateCoordinator:
    ...
    def __init__(self, hass: HomeAssistant, logger: logging.Logger, name: str, *, update_interval: Optional[timedelta]=..., update_method: Optional[Callable[[], Awaitable[T]]]=..., request_refresh_debouncer: Optional[Debouncer]=...) -> None: ...
