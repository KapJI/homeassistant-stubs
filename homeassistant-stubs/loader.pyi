...
class Integration:
    @classmethod
    def resolve_from_root(cls: Any, hass: HomeAssistant, root_module: ModuleType, domain: str) -> Union[Integration, None]: ...
    @classmethod
    def resolve_legacy(cls: Any, hass: HomeAssistant, domain: str) -> Union[Integration, None]: ...
    hass: Any = ...
    pkg_path: Any = ...
    file_path: Any = ...
    manifest: Any = ...
