...
from .loader import Integration as Integration, IntegrationNotFound as IntegrationNotFound, async_get_integration as async_get_integration, async_suggest_report_issue as async_suggest_report_issue
...
async def async_process_requirements(hass: HomeAssistant, name: str, requirements: list[str], is_built_in: bool = True) -> None: ...
...
class RequirementsManager:
    ...
    async def async_process_requirements(self, name: str, requirements: list[str], is_built_in: bool) -> None: ...
