...
from typing import Any, Callable, Iterable, KeysView, Optional, TypeVar, Union
...
def convert(value: Optional[T], to_type: Callable[[T], U], default: Optional[U]=...) -> Optional[U]: ...
...
class Throttle:
    ...
    def __init__(self, min_time: timedelta, limit_no_throttle: Optional[timedelta]=...) -> None: ...
