...
def color_temperature_to_rgbww(temperature: int, brightness: int, min_mireds: int, max_mireds: int) -> tuple[int, int, int, int, int]: ...
def rgbww_to_color_temperature(rgbww: tuple[int, int, int, int, int], min_mireds: int, max_mireds: int) -> tuple[int, int]: ...
def while_levels_to_color_temperature(cold: int, warm: int, min_mireds: int, max_mireds: int) -> tuple[int, int]: ...
