...
class TemperatureConverter(BaseUnitConverter):
    ...
    @classmethod
    def fahrenheit_to_celsius(cls, fahrenheit: float, interval: bool = ...) -> float: ...
    @classmethod
    def kelvin_to_celsius(cls, kelvin: float, interval: bool = ...) -> float: ...
    @classmethod
    def celsius_to_fahrenheit(cls, celsius: float, interval: bool = ...) -> float: ...
    @classmethod
    def celsius_to_kelvin(cls, celsius: float, interval: bool = ...) -> float: ...
    @classmethod
    def get_unit_ratio(cls, from_unit: str, to_unit: str) -> float: ...
