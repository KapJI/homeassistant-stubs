...
class BaseUnitConverter(metaclass=abc.ABCMeta):
    UNIT_CLASS: str
    NORMALIZED_UNIT: str
    VALID_UNITS: set[str]
    @classmethod
...
class TemperatureConverter(BaseUnitConverter):
    ...
    NORMALIZED_UNIT: Incomplete
    VALID_UNITS: Incomplete
    _UNIT_RATIO: Incomplete
    @classmethod
    def convert(cls, value: float, from_unit: str, to_unit: str, *, interval: bool = ...) -> float: ...
    @classmethod
    def _fahrenheit_to_celsius(cls, fahrenheit: float, interval: bool = ...) -> float: ...
    @classmethod
    def _kelvin_to_celsius(cls, kelvin: float, interval: bool = ...) -> float: ...
    @classmethod
    def _celsius_to_fahrenheit(cls, celsius: float, interval: bool = ...) -> float: ...
    @classmethod
    def _celsius_to_kelvin(cls, celsius: float, interval: bool = ...) -> float: ...
    @classmethod
    def get_unit_ratio(cls, from_unit: str, to_unit: str) -> float: ...
