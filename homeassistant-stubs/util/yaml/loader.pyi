...
@overload
def _add_reference(obj: Union[str, NodeStrClass], loader: SafeLineLoader, node: yaml.nodes.Node) -> NodeStrClass: ...
@overload
def _add_reference(obj: _DictT, loader: SafeLineLoader, node: yaml.nodes.Node) -> _DictT: ...
